...
"Wizard (14th)","Wizard (15th)","Wizard (16th)","Master Wizard",
"Archmage","Archwizard","Wizard Lord"},
	/* Priests	 */
...
"Low Bishop","Bishop-1","Bishop-2","Bishop-3","Bishop-4",
"Bishop-5","Bishop-6","Bishop-7",
"Bishop-8","Bishop-9","Inquisitor","Archbishop","Patriarch",
...
race_type race[MAX_RACES] = { /* most stat mods adjusted -CFT */
   ...
   {"Half-Elf",  0,  1,	 1,  2,  0,  2,
      ...
      2,  6,  1, -1, -1,  5,  3,  9,  2, 185, 0x3F,
    },
   {"Elf",	 0,  1,	 0,  2, -1,  2,
      75, 75, 60,  4,100,  6, 54,  4, 80,  6,
      5,  8,  1, -2, -5, 15,  6,  8,  3, 135, 0x1F,
    },
   {"Hobbit", -1,  2,	 1,  3,	 1,  1,
...
{"of a Noble in the Courts of Chaos.  ",                     99, 2, 3,130},
...
char *spell_names[127] = {
  /* Mage Spells */
  "Magic Missile",  "Detect Visible Monsters",  "Blink",  "Light Area",
  "Treasure Detection",
  ...
  "Turn Stone to Mud",  "Create Food",  "Recharge Item I",  "Detect Invisible",
  "Transmogrify",  "Identify",  "Sleep III",  "Fire Bolt",  "Slow Monster",
  "Frost Ball",	 "Recharge Item II", "Teleport Other",	"Haste Self",
  "Fire Ball", "Word of Destruction", "Genocide",

/* Merlin's Ways - Was: R'leyh Text */
  "Door Creation",
  "Stair Creation",
  "Teleport Level",
  "Earthquake",
...
/* Necronomicon - Was: Raal's Tome of Destruction */
  "Acid Bolt",
  "Cloud Kill",
  "Acid Ball",
  "Ice Storm",
...
/* B'harne Fragments - was: Pnakotic Manuscripts - Was: Kelek's Grimoire of Power*/
  "Detect Evil",
  "Detect Enchantment",
  "Recharge Item III",
  "Genocide",
...
/* Pattern Sorcery - Was:B'harne fragments: Resistance of Scarabtarices */
...
/* Pnakotic Manuscripts Was:Revelations of Glaaki- Was: tenser's transformations...*/
  "Heroism",
  "Mystic Shield",
  "Berserker",
  "Essence of Speed",
...
/*  "Find Traps",  "Detect Doors & Stairs",  "Slow Poison",  "Blind Creature",*/
  ...
  "Orb of Draining",  "Cure Serious Wounds",  "Sense Unseen",
