...
store_table =
{
...

	{
		...
		{ TV_POTION, SV_POTION_RESIST_ELECTRICITY },
		{ TV_POTION, SV_POTION_RESIST_ACID },
...
function store_will_buy_hook(store_num, object)
	...
	-- General Store
	if store_num == STORE_GENERAL then
		if tval == TV_FOOD or
		   tval == TV_LITE or
		   tval == TV_FLASK or
		   tval == TV_SPIKE or
	...
	-- Armoury
	elseif store_num == STORE_ARMOR then
		if tval == TV_BOOTS or
		   tval == TV_GLOVES or
		   tval == TV_CROWN or
		   tval == TV_HELM or
		   tval == TV_SHIELD or
		   tval == TV_CLOAK or
		   tval == TV_SOFT_ARMOR or
		   tval == TV_HARD_ARMOR or
	...
	-- Weapon Shop
	elseif store_num == STORE_WEAPON then
		if tval == TV_SHOT or
		   tval == TV_BOLT or
		   tval == TV_ARROW or
		   tval == TV_BOW or
	...
	-- Temple
	elseif store_num == STORE_TEMPLE then
		if tval == TV_PRAYER_BOOK or
		   tval == TV_SCROLL or
		   tval == TV_POTION or
		   tval == TV_HAFTED then
			-- accept
		-- Known blessed blades are accepted too
		elseif (tval == TV_POLEARM or
		        tval == TV_SWORD) and
	...
	-- Alchemist
	elseif store_num == STORE_ALCHEMY then
		if tval == TV_SCROLL or
		   tval == TV_POTION then
			-- accept
		else
			return FALSE
	...
	-- Magic Shop
	elseif store_num == STORE_MAGIC then
		if tval == TV_MAGIC_BOOK or
		   tval == TV_AMULET or
		   tval == TV_RING or
		   tval == TV_STAFF or
		   tval == TV_WAND or
...
-- Add event handlers
add_event_handler("get_store_choice", get_store_choice_hook)
add_event_handler("store_will_buy", store_will_buy_hook)
