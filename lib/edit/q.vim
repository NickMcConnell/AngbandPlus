...
syn region qMonExp matchgroup=qOp start=/MON(/ end=/)/ oneline contains=qNumber,qPct contained
syn region qTrapExp matchgroup=qOp start=/TRAP(/ end=/)/ oneline contains=qNumber,qFeature,qPct contained
...
syn match qMapWall /%\+/ contained
syn match qMapWall /;\+/ contained
syn match qMapRoad /*\+/ contained
syn match qMapRoad /!\+/ contained
syn match qMapGrass /-\+/ contained
syn match qMapSwamp /=\+/ contained
...
syn match qMapShallowWater /_\+/ contained
syn match qMapPerm /X\+/ contained
syn match qMapLoot /[7-9]/ contained
syn match qMapGlass /Y\+/ contained
syn region qMapLine matchgroup=qMapPrefix start=/^M:/ end=/$/ contains=qMapWall,qMapRoad,qMapDoor,qMapTrap,qMapLoot,qMapTree,qMapWater,qMapShallowWater,qMapGrass,qMapSwamp,qMapPerm,qMapGlass
...
hi qMapRoad term=bold ctermfg=Yellow
hi qMapPerm term=bold ctermfg=Brown
...
hi qMapSwamp term=bold ctermfg=Green
hi qMapWater term=bold ctermfg=Blue
hi qMapShallowWater ctermfg=Cyan
hi qMapGlass term=bold ctermfg=Blue
