...
store_buy_list
{
        ...
        ["Temple"] = function (obj)
                ...
                elseif obj.tval == TV_POLEARM and is_blessed(obj) then return TRUE
                elseif obj.tval == TV_SWORD and is_blessed(obj) then return TRUE
                elseif obj.tval == TV_AXE and is_blessed(obj) then return TRUE
                end
        end,
        ["Alchemy shop"] =
        {
