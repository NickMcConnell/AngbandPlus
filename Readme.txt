This is the README for Kangband 2.8.2c (1/98)  Note that this file simply
lists the same information as in the official Angband 2.8.2 README file.
To see a list of changes in this variant, read the files included
in the kangdocs directory included in this distribution.

========================================================================
This is the README file for Angband 2.8.2 (09/01/97)

Angband 2.8.2 is a stable official release (hopefully!) incorporating all
of the improvements added since the last official release (Angband 2.7.8).

See the Official Angband Home Page "http://www.voicenet.com/~benh/Angband/"
...
Contact Ben Harrison ("benh@voicenet.com") to report any bugs or make any
...
Send bug reports, suggestions, etc, to Ben Harrison ("benh@voicenet.com").
