...
int tolua_spell_open (lua_State* tolua_S)
{
 ...
 tolua_constant(tolua_S,NULL,"SUMMON_NONLIFE",SUMMON_NONLIFE);
...
/* tolua_constant(tolua_S,NULL,"GF_XXX3",GF_XXX3);*/
 ...
 tolua_constant(tolua_S,NULL,"GF_LAW",GF_LAW);
...
void tolua_spell_close (lua_State* tolua_S)
{
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"SUMMON_NONLIFE");
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"GF_LAW");
