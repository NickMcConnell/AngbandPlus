...
int tolua_monster_open (lua_State* tolua_S)
{
 ...
 tolua_constant(tolua_S,NULL,"SM_RES_LAW",SM_RES_LAW);
 ...
 tolua_constant(tolua_S,NULL,"RF3_RES_ACID",RF3_RES_ACID);
 tolua_constant(tolua_S,NULL,"RF3_RES_ELEC",RF3_RES_ELEC);
 tolua_constant(tolua_S,NULL,"RF3_RES_FIRE",RF3_RES_FIRE);
 tolua_constant(tolua_S,NULL,"RF3_RES_COLD",RF3_RES_COLD);
 ...
 tolua_constant(tolua_S,NULL,"RF4_BR_LAW",RF4_BR_LAW);
 ...
 tolua_constant(tolua_S,NULL,"RF6_S_ANGEL",RF6_S_NONLIFE);
...
void tolua_monster_close (lua_State* tolua_S)
{
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"RF3_RES_ACID");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"RF3_RES_ELEC");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"RF3_RES_FIRE");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"RF3_RES_COLD");
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"RF4_BR_LAW");
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"RF6_S_NONLIFE");
