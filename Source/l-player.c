...
static int toluaI_get_player_player_type_heavy_wield1(lua_State* tolua_S)
{
  player_type* self = (player_type*)  tolua_getusertype(tolua_S,1,0);
 if (!self) TOLUA_ERR_SELF;
 tolua_pushbool(tolua_S,(int)self->heavy_wield1);
 return 1;
}

static int toluaI_get_player_player_type_heavy_wield2(lua_State* tolua_S)
{
  player_type* self = (player_type*)  tolua_getusertype(tolua_S,1,0);
 if (!self) TOLUA_ERR_SELF;
 tolua_pushbool(tolua_S,(int)self->heavy_wield2);
 return 1;
}

/* set function: heavy_wield of class  player_type */
static int toluaI_set_player_player_type_heavy_wield1(lua_State* tolua_S)
{
  player_type* self = (player_type*)  tolua_getusertype(tolua_S,1,0);
 if (!self) TOLUA_ERR_SELF;
 if (!tolua_istype(tolua_S,2,tolua_tag(tolua_S,"bool"),0))
 TOLUA_ERR_ASSIGN;
  self->heavy_wield1 = ((bool)  tolua_getbool(tolua_S,2,0));
 return 0;
}
static int toluaI_set_player_player_type_heavy_wield2(lua_State* tolua_S)
{
  player_type* self = (player_type*)  tolua_getusertype(tolua_S,1,0);
 if (!self) TOLUA_ERR_SELF;
 if (!tolua_istype(tolua_S,2,tolua_tag(tolua_S,"bool"),0))
 TOLUA_ERR_ASSIGN;
  self->heavy_wield2 = ((bool)  tolua_getbool(tolua_S,2,0));
 return 0;
}
...
/* get function: resist_law of class  player_type */
static int toluaI_get_player_player_type_resist_law(lua_State* tolua_S)
{
  player_type* self = (player_type*)  tolua_getusertype(tolua_S,1,0);
 if (!self) TOLUA_ERR_SELF;
 tolua_pushbool(tolua_S,(int)self->resist_law);
 return 1;
}

/* set function: resist_law of class  player_type */
static int toluaI_set_player_player_type_resist_law(lua_State* tolua_S)
{
  player_type* self = (player_type*)  tolua_getusertype(tolua_S,1,0);
 if (!self) TOLUA_ERR_SELF;
 if (!tolua_istype(tolua_S,2,tolua_tag(tolua_S,"bool"),0))
 TOLUA_ERR_ASSIGN;
  self->resist_law = ((bool)  tolua_getbool(tolua_S,2,0));
 return 0;
}
...
int tolua_player_open (lua_State* tolua_S)
{
 ...
 tolua_tablevar(tolua_S,"player_type","heavy_wield1",toluaI_get_player_player_type_heavy_wield1,toluaI_set_player_player_type_heavy_wield1);
 tolua_tablevar(tolua_S,"player_type","heavy_wield2",toluaI_get_player_player_type_heavy_wield2,toluaI_set_player_player_type_heavy_wield2);
 ...
 tolua_tablevar(tolua_S,"player_type","resist_law",toluaI_get_player_player_type_resist_law,toluaI_set_player_player_type_resist_law);
