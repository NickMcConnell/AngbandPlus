...
# The local 'command' module lets us add new commands

import command

# The local 'attack' module handles us attacking friendly monsters
...
event.add_handler(event.EVENT_COMMAND, command.event_command)
event.add_handler(event.EVENT_ATTACK, attack.event_attack)
event.add_handler(event.EVENT_HURT_MONSTER, attack.event_hurt)
