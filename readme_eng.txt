...
--- UNIX
  ...
  tar -zxvf questband-x.x.x.tar.gz
  cd questband-x.x.x
  ...
  then try
  ./questband -- -n<number of windows>  ## for normal ASCII graphics
  or
  ./questband -g -- -n<# of windows>    ## for 8x8 tile graphics
  ./questband -g -- -b -n<# of windows> ## for Bigtile graphics
  to play.
...
Unzip it, and click questband to play.
...
Unpack it, and click questband to play.
...
Below, only the new features in Questband are explained.
...
Questband offers two different methods of auto-pickup/destroy.
- Powerful method
  Questband offers a very powerful auto-pickup/auto-destroy system
...
questband/ for UNIX, or questband/lib/user/ for other OS.
