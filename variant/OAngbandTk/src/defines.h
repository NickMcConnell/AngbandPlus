...
#define FEEL_UNKNOWN           10
#define FEEL_MAX               11
#else /* not ALLOW_EASY_SENSE */
#define FEEL_MAX               10
#endif /* not ALLOW_EASY_SENSE */
...
#define OPT_pickup_similar			95 /* TNB */
#define OPT_verify_mana				96 /* TNB */
...
#define easy_alter				op_ptr->opt[OPT_easy_alter] /* TNB */
...
#define pickup_similar			op_ptr->opt[OPT_pickup_similar]
#define verify_mana				op_ptr->opt[OPT_verify_mana]
#define remember_recall			op_ptr->opt[OPT_remember_recall]
#define easy_sense				op_ptr->opt[OPT_easy_sense]
#define easy_ring				op_ptr->opt[OPT_easy_ring]
