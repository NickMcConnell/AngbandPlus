 ...
 * Note: easy_floor wasn't an option in OAngband
 */
#define ALLOW_EASY_FLOOR

/*
 * OPTION: Make item sensing easy -- TNB
 */
#define ALLOW_EASY_SENSE
...
/*
 * Option: Tunnelling decreases wall hitpoints -- TNB
 */
#define ALLOW_TUNNEL_PATCH

/*
 * Option: Pure spellcasting monsters won't melee -- TNB
 */
#define ALLOW_SPELLCASTER_PATCH

/*
 * Option: Fractal cave rooms -- TNB
 */
// #define ALLOW_FRACTAL_PATCH
