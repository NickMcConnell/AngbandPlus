...
extern byte spell_desire_RF4[32][10];
extern byte spell_desire_RF5[32][10];
extern byte spell_desire_RF6[32][10];
extern byte spell_desire_RF7[32][10];
...
#if 1 /* TNB */
extern void do_cmd_observe(object_type * o_ptr, int item, bool in_store);
#else /* TNB */
...
extern void object_info(char buf[2048], object_type * o_ptr,
	bool in_store);
...
extern bool prepare_ghost(int r_idx, monster_type * m_ptr,
	bool from_savefile);
...
extern bool summon_specific(int y1, int x1, bool scattered, int lev,
	int type);
...
extern bool fire_meteor(int who, int typ, int y, int x, int dam, int rad,
	bool hurt_player);
extern bool fire_arc(int typ, int dir, int dam, int rad,
	int degrees_of_arc);
...
#define put_str_center(str,row)
#define c_prt(attr,str,row,col)
#define prt(str,row,col)
#define prt_center(str,row)
...
#if 1 /* TNB */
extern char *look_mon_desc(char *buf, int m_idx);
#else /* TNB */
extern cptr look_mon_desc(int m_idx);
#endif /* TNB */
extern void ang_sort_aux(vptr u, vptr v, int p, int q);
extern void ang_sort(vptr u, vptr v, int n);
extern sint motion_dir(int y1, int x1, int y2, int x2);	/* TNB */
...
/* dungeon.c */
extern bool sensed_p(object_type * o_ptr);
