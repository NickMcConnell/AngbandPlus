...
/*
 * Define BORG_BUILD when building borg.dll. -- TNB
 */
#ifdef ALLOW_BORG
# ifdef PLATFORM_WIN
#  ifdef BORG_BUILD
#   define ANG_STORAGE_CLASS __declspec(dllimport)
#  else
#   define ANG_STORAGE_CLASS __declspec(dllexport)
#  endif
# endif
# ifdef PLATFORM_X11
...
#	define ANG_STORAGE_CLASS
#endif
#define ANG_EXTERN extern ANG_STORAGE_CLASS
