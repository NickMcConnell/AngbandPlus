 ...
 */
#ifdef BORG_TK
s32b price_item(const object_type * o_ptr, int greed, bool flip)
#else /* not BORG_TK */
...
void do_cmd_store(void)
{
	...
	sound(SNDGRP_EVENT,
		...
		SND_HOME_ENTER : SND_STORE_ENTER, 0x02); /* ALLOW_SOUND */
	...
	sound(SNDGRP_EVENT,
		(store_num == STORE_HOME) ?
		SND_HOME_LEAVE : SND_STORE_LEAVE, 0x02); /* ALLOW_SOUND */
