...
/*
 * Copyright (c)01997 Ben Harrison, James E. Wilson, Robert A. Koeneke
 *
...
void do_cmd_spike(void)
{
	...
	else
	{
		...
		if (cave_feat[y][x] < FEAT_DOOR_HEAD + 0x08)
		{
			/* cave_feat[y][x] += 0x08; -- TNB */
			cave_set_feat(y, x, cave_feat[y][x] + 0x08); /* TNB */
		}

		/* Add one spike to the door */
		if (cave_feat[y][x] < FEAT_DOOR_TAIL)
		{
			/* cave_feat[y][x] += 0x01; -- TNB */
			cave_set_feat(y, x, cave_feat[y][x] + 0x01); /* TNB */
		}
...
void do_cmd_throw(void)
{
	...
	for (i = 0; i < path_n; ++i)
	{
		...
		/* Only do visuals if the player can "see" the missile */
/*		if (panel_contains(y, x) && player_can_see_bold(y, x)) -- TNB */
		if (player_can_see_bold(y, x))
		{
#if 1 /* TNB */
