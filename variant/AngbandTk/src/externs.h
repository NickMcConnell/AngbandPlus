...
/* tables.c */
ANG_EXTERN const s16b ddd[9];
ANG_EXTERN const s16b ddx[10];
ANG_EXTERN const s16b ddy[10];
ANG_EXTERN const s16b ddx_ddd[9];
ANG_EXTERN const s16b ddy_ddd[9];
extern const char hexsym[16];
extern const byte adj_mag_study[];
ANG_EXTERN const byte adj_mag_mana[];
ANG_EXTERN const byte adj_mag_fail[];
ANG_EXTERN const byte adj_mag_stat[];
extern const byte adj_chr_gold[];
ANG_EXTERN const byte adj_int_dev[];
ANG_EXTERN const byte adj_wis_sav[];
ANG_EXTERN const byte adj_dex_dis[];
ANG_EXTERN const byte adj_int_dis[];
ANG_EXTERN const byte adj_dex_ta[];
ANG_EXTERN const byte adj_str_td[];
ANG_EXTERN const byte adj_dex_th[];
ANG_EXTERN const byte adj_str_th[];
ANG_EXTERN const byte adj_str_wgt[];
ANG_EXTERN const byte adj_str_hold[];
ANG_EXTERN const byte adj_str_dig[];
ANG_EXTERN const byte adj_str_blow[];
ANG_EXTERN const byte adj_dex_blow[];
ANG_EXTERN const byte adj_dex_safe[];
extern const byte adj_con_fix[];
ANG_EXTERN const byte adj_con_mhp[];
ANG_EXTERN const byte blows_table[12][12];
ANG_EXTERN const byte extract_energy[200];
extern const s32b player_exp[PY_MAX_LEVEL];
ANG_EXTERN const player_sex sex_info[MAX_SEXES];
ANG_EXTERN const player_class class_info[MAX_CLASS];
ANG_EXTERN const player_magic magic_info[MAX_CLASS];
ANG_EXTERN const u32b spell_flags[2][9][2];
ANG_EXTERN cptr spell_names[2][PY_MAX_SPELLS];
ANG_EXTERN const byte chest_traps[64];
...
ANG_EXTERN byte(*cave_feat)[DUNGEON_WID];
ANG_EXTERN s16b(*cave_o_idx)[DUNGEON_WID];
ANG_EXTERN s16b(*cave_m_idx)[DUNGEON_WID];
extern byte(*cave_cost)[DUNGEON_WID];
extern byte(*cave_when)[DUNGEON_WID];
ANG_EXTERN maxima *z_info;
ANG_EXTERN object_type *o_list;
ANG_EXTERN monster_type *m_list;
ANG_EXTERN monster_lore *l_list;
ANG_EXTERN quest *q_list;
ANG_EXTERN store_type *store;
ANG_EXTERN object_type *inventory;
...
ANG_EXTERN const player_sex *sp_ptr;
ANG_EXTERN const player_race *rp_ptr;
ANG_EXTERN const player_class *cp_ptr;
ANG_EXTERN const player_magic *mp_ptr;
ANG_EXTERN player_other *op_ptr;
ANG_EXTERN player_type *p_ptr;
extern vault_type *v_info;
extern char *v_name;
extern char *v_text;
ANG_EXTERN feature_type *f_info;
ANG_EXTERN char *f_name;
extern char *f_text;
ANG_EXTERN object_kind *k_info;
ANG_EXTERN char *k_name;
extern char *k_text;
ANG_EXTERN artifact_type *a_info;
ANG_EXTERN char *a_name;
extern char *a_text;
ANG_EXTERN ego_item_type *e_info;
ANG_EXTERN char *e_name;
extern char *e_text;
ANG_EXTERN monster_race *r_info;
ANG_EXTERN char *r_name;
extern char *r_text;
ANG_EXTERN player_race *p_info;
ANG_EXTERN char *p_name;
extern char *p_text;
ANG_EXTERN hist_type *h_info;
ANG_EXTERN char *h_text;
...
ANG_EXTERN cptr ANGBAND_DIR_BONE;
extern cptr ANGBAND_DIR_DATA;
ANG_EXTERN cptr ANGBAND_DIR_EDIT;
...
ANG_EXTERN bool(*ang_sort_comp) (vptr u, vptr v, int a, int b);
ANG_EXTERN void (*ang_sort_swap) (vptr u, vptr v, int a, int b);
...
extern sint project_path(u16b * gp, int range, int y1, int x1, int y2,
	int x2, int flg);
...
extern sint tot_dam_aux(const object_type * o_ptr, int tdam,
...
#ifdef TNB_BACKUP
extern void do_cmd_backup_game(void);
#endif /*  TNB_BACKUP */
extern long total_points(void);
extern void display_scores(int from, int to);
#if 1 /* TNB */
extern void predict_score(high_score * the_score);
#else /* not 1 -- TNB */
...
extern int highscore_write(const high_score * score);
extern int highscore_where(const high_score * score);
extern int highscore_add(const high_score * score);
#endif /* not 1 -- TNB */
...
extern void object_flags(const object_type * o_ptr, u32b * f1, u32b * f2,
	u32b * f3);
extern void object_flags_known(const object_type * o_ptr, u32b * f1,
	u32b * f2, u32b * f3);
...
extern int identify_random_gen(const object_type * o_ptr, cptr * info,
	int len);
...
extern bool object_similar(const object_type * o_ptr,
...
#ifdef TNB_BACKUP
extern bool save_player_backup(void);
#endif /*  TNB_BACKUP */
...
#define c_roff(a,str,l_margin,r_margin)
#define roff(str,l_margin,r_margin)
...
/* dungeon.c */
extern bool sensed_p(const object_type * o_ptr);
extern bool sense_object(object_type * o_ptr);
...
#ifdef TNB_SQUELCH
extern bool object_squelch_p(object_type *o_ptr);
#endif /* TNB_SQUELCH */
