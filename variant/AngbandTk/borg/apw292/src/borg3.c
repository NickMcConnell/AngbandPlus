...
bool borg_spell_okay(int book, int what)
{
    ...
    if (auto_class == CLASS_MAGE) reserve_mana = 6;
 ...
 */
#ifdef BORG_TK
#define ang_sort_comp_hook ang_sort_comp_hook_static
#endif /* BORG_TK */
 ...
 */
#ifdef BORG_TK
#define ang_sort_swap_hook ang_sort_swap_hook_static
#endif /* BORG_TK */
...
void borg_init_3(void)
{
    ...
    C_MAKE(auto_sv_plural_text, z_info->k_max, cptr);
    ...
    C_MAKE(auto_sv_art_text, z_info->a_max, cptr);
...
cptr borg_prt_item(int item)
{
            ...
            if (item < z_info->k_max + z_info->k_max)
                return auto_sv_plural_text[item - z_info->k_max];
            if (item < z_info->k_max + z_info->k_max + z_info->a_max)
                return auto_sv_art_text[item - z_info->k_max - z_info->k_max];
