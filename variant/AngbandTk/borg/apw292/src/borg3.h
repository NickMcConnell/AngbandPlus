...
{
#ifdef BORG_TK
    char desc[O_NAME_MAX];  /* Actual Description */
#else /* BORG_TK */
...
extern auto_item *safe_items;       /* Safety "inventory" */
extern auto_item *safe_home;        /* Safety "home" */

extern auto_shop *safe_shops;       /* Safety "shops" */
...
/* look for a *id*'d item */
extern bool borg_object_star_id_aux(auto_item *borg_item, object_type *real_item);
