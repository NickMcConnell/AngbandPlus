...
static void purchase_analyze(s32b price, s32b value, s32b guess)
{
	...
	if ((value <= 0) && (price > value))
	{
		...
		/* Sound */
/*		sound(SOUND_STORE1); ALLOW_SOUND */
	}
	...
	else if ((value < guess) && (price > value))
	{
		...
		/* Sound */
/*		sound(SOUND_STORE2); ALLOW_SOUND */
	}
	...
	else if ((value > guess) && (value < (4 * guess)) && (price < value))
	{
		...
		/* Sound */
/*		sound(SOUND_STORE3); ALLOW_SOUND */
	}
	...
	else if ((value > guess) && (price < value))
	{
		...
		/* Sound */
/*		sound(SOUND_STORE4); ALLOW_SOUND */
	}
}
	...
	*price = 0;
	...
	for (flag = FALSE; !flag;)
	{
		while (1)
		{
			...
			{
				char o_name[80];
				bool plain = plain_descriptions;
				plain_descriptions = TRUE;
				object_desc(o_name, o_ptr, TRUE, 3);
				plain_descriptions = plain;
...
#ifndef ALLOW_EASY_SENSE /* TNB */

	/*
	 * Removing the inscription screws up the object_value()
	 * calculation for cursed sensed items with the "?" inscription.
	 * store_carry() removes the inscription anyhow. -- TNB
	 */
...
void do_cmd_store(void)
{
	...
	sound(SNDGRP_EVENT, (cur_store_num == STORE_HOME) ?
