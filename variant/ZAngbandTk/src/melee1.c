...
/*						sound(SOUND_CRUSH); ALLOW_SOUND */
				...
				case RBM_CHARGE:
				{
					act = "charges you.";
					touched = TRUE;
/*						sound(SOUND_BUY); ALLOW_SOUND *//* Note! This is "charges", not "charges at". */
					break;
				}
...
/*					sound(SOUND_SHOW); ALLOW_SOUND */
			...
			if (act)
			{
				 ...
				 * the monster dies for other reasons and we don't know the
				 * cause of death in monster_death(). */
				else if (method != RBM_EXPLODE)
#else /* TNB */
				else
#endif /* TNB */
				{
