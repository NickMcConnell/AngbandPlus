...
/*	sound(SOUND_TPOTHER); ALLOW_SOUND */
...
void teleport_player(int dis)
{
	...
	/* Sound */
	sound(SNDGRP_EVENT, SND_SPELL_TELEPORT, 0x02); /* ALLOW_SOUND */
/*	sound(SOUND_TELEPORT); ALLOW_SOUND */
...
bool alchemy(void)
{
	...
	inkey_options = "auto_destroy"; /* TNB */
...
bool ident_spell(void)
{
	...
	else if (artifact_p(o_ptr) || o_ptr->art_name)
		...
		switch (realm)
		{
			...
			case 4: /* Death */
				switch (spell)
				{
					...
					case 11:
#if 1 /* TNB */
						sprintf(p, " dam %d-%d", plev + 1, plev + plev * MAX(1, plev / 10));
