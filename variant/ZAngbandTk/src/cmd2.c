...
void do_cmd_go_up(void)
{
	...
	else if (c_ptr->feat == FEAT_LESS)
	{
		...
		else
		{
			if (confirm_stairs)
			{
				inkey_options = "confirm_stairs"; /* TNB */
...
static void chest_trap(int y, int x, s16b o_idx)
{
	...
	if (trap & (CHEST_EXPLODE))
	{
		...
		o_ptr->pval = 0;
/*		sound(SOUND_EXPLODE); ALLOW_SOUND */
...
static bool do_cmd_open_aux(int y, int x)
{
	...
	else if (c_ptr->feat >= FEAT_DOOR_HEAD + 0x01)
	{
		...
		if (rand_int(100) < j)
		{
			...
			/* Sound */
			sound(SNDGRP_EVENT, SND_OPEN, 0x02); /* ALLOW_SOUND */
//*         sound(SOUND_OPENDOOR); ALLOW_SOUND */
...
static bool do_cmd_close_aux(int y, int x)
{
	...
	else
	{
		...
		/* Sound */
		sound(SNDGRP_EVENT, SND_CLOSE, 0x02); /* ALLOW_SOUND */
/*		sound(SOUND_SHUTDOOR); ALLOW_SOUND */
	}
...
/*	sound(SOUND_DIG); ALLOW_SOUND */
	...
	else if (c_ptr->feat == FEAT_TREES)	/* -KMW- */
	{
		...
		/* Chop Down */
		if ((tunnel_points < 0) && twall(y, x, FEAT_GRASS))
		{
		...
		(c_ptr->feat <= FEAT_WALL_SOLID))
	{
		...
		/* Tunnel */
		if ((tunnel_points < 0) && twall(y, x, FEAT_FLOOR))
		{
...
void do_cmd_fire_aux(int item, object_type * j_ptr)
{
	...
	/* Sound */
	sound(SNDGRP_EVENT, SND_ATTACK_BOW, 0);	/* ALLOW_SOUND */
/*	sound(SOUND_SHOOT); ALLOW_SOUND */
