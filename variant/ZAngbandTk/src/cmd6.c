...
static void do_cmd_eat_food_aux(int item)
{
	...
	/* Sound */
	sound(SNDGRP_EVENT, SND_USE_FOOD, 0); /* ALLOW_SOUND */
/*	sound(SOUND_EAT); ALLOW_SOUND */
...
static void do_cmd_quaff_potion_aux(int item)
{
	...
	/* Sound */
	sound(SNDGRP_EVENT, SND_USE_POTION, 0);	/* ALLOW_SOUND */
/*	sound(SOUND_QUAFF); ALLOW_SOUND */
...
/*	sound(SOUND_SCROLL); ALLOW_SOUND */
...
/*		sound(SOUND_FAIL); ALLOW_SOUND */
	...
	/* Sound */
/*	sound(SOUND_ZAP); ALLOW_SOUND */
	sound(SNDGRP_EVENT, SND_USE_STAFF, 0); /* ALLOW_SOUND */
/*	sound(SOUND_ZAP); ALLOW_SOUND */
...
/*		sound(SOUND_FAIL); ALLOW_SOUND */
	...
	/* Sound */
/*	sound(SOUND_ZAP); ALLOW_SOUND */
	sound(SNDGRP_EVENT, SND_USE_ROD, 0); /* ALLOW_SOUND */
