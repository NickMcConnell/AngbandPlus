...
void do_cmd_destroy(void)
{
	...
	inkey_options = "verify_destroy verify_destroy_junk";
	if (!get_item(&item, q, s, (USE_INVEN | USE_FLOOR)))
		return;
...
bool research_mon(void)
{
	...
	/* Access the monster race and lore */
	r_ptr = &r_info[r_idx];
	l_ptr = &l_list[r_idx];

	/*
	 * The rest of this should mimic the cheat_know block
	 * in angtk_roff().
	 */
