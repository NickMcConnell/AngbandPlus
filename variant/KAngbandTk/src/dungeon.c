...
/*
 * Return TRUE if the given object was ever sensed.
 *
 ...
 */
bool sensed_p(const object_type * o_ptr)
{
	/* Not sensed */
	...
	/* No actual feeling was generated */
	if (o_ptr->discount == INSCRIP_UNKNOWN)
		return FALSE;
...
static void process_world(void)
{
	...
	int regen_amount;
	bool cave_no_regen = FALSE;	/* From ZAngband -- TNB */
		...
		!p_ptr->immune_fire && !p_ptr->levitate)
	{
		...
		{
			/* Take damage */
			sound(SNDGRP_EVENT, SND_BURNED_BY_LAVA, 0x01); /* ALLOW_SOUND */
		...
		(!p_ptr->levitate))
	{
		...
		{
			/* Take damage */
			sound(SNDGRP_EVENT, SND_DROWN_IN_WATER, 0x01); /* ALLOW_SOUND */
...
#if 1 /* From ZAngband -- TNB */

	/* Lava/Deep Water prevent regeneration */
	if (cave_no_regen)
		regen_amount = 0;
