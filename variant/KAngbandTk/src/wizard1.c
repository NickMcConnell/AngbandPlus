...
static const grouper group_item[] = {
	...
	{TV_ILLUSION_BOOK, "Books (Illusionist)"}, /* -KMW- */
	{TV_NATURE_BOOK, "Books (Druid)"}, /* -KMW- */
...
static const flag_desc misc_flags3_desc[] = {
	...
	{TR3_VAMPIRIC, "Drains Life from others"},
	{TR3_CHAOTIC, "Spreads chaos"},
	{TR3_LEVITATION, "Floats you above the floor"}
};
 ...
 */
static void analyze_pval(const object_type * o_ptr,
 ...
 */
static void analyze_sustains(const object_type * o_ptr,
	cptr * sustain_list)
{
...
static void print_header(void)
{
	...
	sprintf(buf, "Artifact Spoilers for %s Version %s", VERSION_NAME,
		VERSION_STRING);
