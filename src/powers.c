        ...
        switch(power)
	{
                        ...
                        if (amber_power == 2)
			{
                                ...
                                if (power_chance(&x_ptr_foo))
                                {
                                        ...
                                        object_type *o1_ptr = &inventory[0], *o2_ptr = &inventory[1];
                                        int ok = 0;
                                        ...
                                        {
                                                if (chest >= 0) o1_ptr = &inventory[chest];
                                        ...
                                        if (ok && get_item(&item, q2, s2, flag))
                                        {
                                                ...
                                                if (item >= 0) o2_ptr = &inventory[item];
			...
			{
                                x_ptr_foo.level = 1;
                                x_ptr_foo.cost = p_ptr->tp_aux1;
                                x_ptr_foo.stat = A_STR;
                                x_ptr_foo.diff = 6;
                                if (power_chance_tank(&x_ptr_foo))
                                {
                                        if (!get_aim_dir(&dir)) break;
