...
static PyObject *Player_getattr(PlayerObject *self, char *name)
{
	...
	LOOK_FIELD("pspeed", pspeed);
        LOOK_FIELD("class_extra1", class_extra1);
        LOOK_FIELD("class_extra2", class_extra2);
        LOOK_FIELD("class_extra3", class_extra3);
        LOOK_FIELD("class_extra4", class_extra4);
        LOOK_FIELD("class_extra5", class_extra5);
        LOOK_FIELD("class_extra6", class_extra6);
        LOOK_FIELD("class_extra7", class_extra7);
        LOOK_FIELD("race_extra1", race_extra1);
        LOOK_FIELD("race_extra2", race_extra2);
        LOOK_FIELD("race_extra3", race_extra3);
        LOOK_FIELD("race_extra4", race_extra4);
        LOOK_FIELD("race_extra5", race_extra5);
        LOOK_FIELD("race_extra6", race_extra6);
        LOOK_FIELD("race_extra7", race_extra7);
...
"#psex#prace#pclass#maximize#preserve#age#ht#wt#sc\
...
#skill_fos#skill_thn#skill_thb#skill_tht#skill_dig\
#num_blow#num_fire#pspeed#";
 ...
 * Return the py
 */
static PyObject *player_py(PyObject *self, PyObject *args)
{
	/* Parse arguments */
        if (!PyArg_ParseTuple(args, ""))
		return NULL;
	...
	/* Return nothing */
        return Py_BuildValue("i", py);
}

/*
 * Return the px
 */
static PyObject *player_px(PyObject *self, PyObject *args)
{
	/* Parse arguments */
        if (!PyArg_ParseTuple(args, ""))
		return NULL;
...
void initplayer()
{
	...
	add_constant(d, "SEX_MALE", SEX_MALE);
        add_constant(d, "SEX_NEUTER", SEX_NEUTER);
	...
	add_constant(d, "RACE_HIGH_ELF", RACE_HIGH_ELF);
        add_constant(d, "RACE_BARBARIAN", RACE_BARBARIAN);
        add_constant(d, "RACE_HALF_OGRE", RACE_HALF_OGRE);
        add_constant(d, "RACE_HALF_GIANT", RACE_HALF_GIANT);
        add_constant(d, "RACE_KOBOLD", RACE_KOBOLD);
        add_constant(d, "RACE_NIBELUNG", RACE_NIBELUNG);
        add_constant(d, "RACE_DARK_ELF", RACE_DARK_ELF);
        add_constant(d, "RACE_VAMPIRE", RACE_VAMPIRE);
        add_constant(d, "RACE_SPECTRE", RACE_SPECTRE);
        add_constant(d, "RACE_ENT", RACE_ENT);
        add_constant(d, "RACE_RKNIGHT", RACE_RKNIGHT);
        add_constant(d, "RACE_DRAGONRIDER", RACE_DRAGONRIDER);
        add_constant(d, "RACE_MOLD", RACE_MOLD);
	...
	add_constant(d, "CLASS_PALADIN", CLASS_PALADIN);
        add_constant(d, "CLASS_WARRIOR_MAGE", CLASS_WARRIOR_MAGE);
        add_constant(d, "CLASS_CHAOS_WARRIOR", CLASS_CHAOS_WARRIOR);
        add_constant(d, "CLASS_MONK", CLASS_MONK);
        add_constant(d, "CLASS_MINDCRAFTER", CLASS_MINDCRAFTER);
        add_constant(d, "CLASS_HIGH_MAGE", CLASS_HIGH_MAGE);
        add_constant(d, "CLASS_MIMIC", CLASS_MIMIC);
        add_constant(d, "CLASS_BEASTMASTER", CLASS_BEASTMASTER);
        add_constant(d, "CLASS_ALCHEMIST", CLASS_ALCHEMIST);
        add_constant(d, "CLASS_SYMBIANT", CLASS_SYMBIANT);
        add_constant(d, "CLASS_HARPER", CLASS_HARPER);
        add_constant(d, "CLASS_POWERMAGE", CLASS_POWERMAGE);
        add_constant(d, "CLASS_RUNECRAFTER", CLASS_RUNECRAFTER);
        add_constant(d, "CLASS_WIZARD", CLASS_WIZARD);
        add_constant(d, "CLASS_PRIOR", CLASS_PRIOR);
        add_constant(d, "CLASS_POSSESSOR", CLASS_POSSESSOR);
        add_constant(d, "CLASS_SORCERER", CLASS_SORCERER);
