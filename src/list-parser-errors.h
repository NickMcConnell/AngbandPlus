...
PARSE_ERROR(INVALID_PLAYER_FLAG,	"invalid player flag")
...
PARSE_ERROR(INVALID_WEIGHT,			"invalid weight")
...
PARSE_ERROR(UNRECOGNISED_FAULT,		"unrecognized fault")
PARSE_ERROR(UNRECOGNISED_MATERIAL,	"unrecognized material")
...
PARSE_ERROR(VAULT_BAD_CHAR,			"vault has unrecognized character")
