...
#define DUN_LAVA         10   /* 1/x chance of having a lava level */
...
#define INVEN_QUIVER 21 /* The quiver is only a phantom member of the equip.
	     list.  Actually it is the last slot of the inventory list,
	     sometimes pretending to be part of the equipment list.  If the
	     item in this slot is a valid missle weapon ammo and the item
	     has the TR_IN_QUIVER bit of flags2 set, then the quiver is
	     considered in use. -JLS */
...
#define LAVA_FLOOR      5
#define CORR_FLOOR	6
#define BLOCKED_FLOOR	7 /* a corridor space with cl/st/se door or rubble */
#define MAX_CAVE_FLOOR	7

#define MAX_OPEN_SPACE  6
#define MIN_CLOSED_SPACE 7
...
/* TEMPORARY GRAPHICS THINGY until graphics programmed -DGK */
#define CH_a 'a'
#define CH_b 'b'
#define CH_c 'c'
#define CH_d 'd'
...
#define CH_k 'k'
#define CH_l 'l'
#define CH_m 'm' /* +Shambling Mound, Memory Moss. And hairy molds */
#define CH_n 'n'
#define CH_o 'o'
#define CH_p 'p'
#define CH_q 'q'
...
#define CH_Y 'Y'
#define CH_Z 'Z'
#define CH_dmn '&'   /* demons */
#define CH_msh ','   /* mushrooms, mushroom patches */
#define CH_csh '$'   /* cash, creeping coins */
#define CH_gem '*'   /* gems, artifact lights */
#define CH_flr '.'   /* floor */
#define CH_wal '#'   /* wall */
#define CH_you '@'   /* You.  Da player */
#define CH_ptn '!'   /* potions, flasks, ale/wine */
#define CH_scr '?'   /* scrolls */
#define CH_crn ']'   /* crowns */
#define CH_glv ']'   /* gloves */
#define CH_hlm ']'   /* helms */
#define CH_bts ']'   /* boots */
#define CH_fod ','   /* generic food */
#define CH_dag '|'   /* daggers, main gauches, spikes */
#define CH_s2h '|'   /* two-handed swords */
#define CH_scm '|'   /* curved swords */
#define CH_swd '|'   /* medium swords (long, broad, rapier) */
#define CH_ssd '|'   /* short swords */
#define CH_fll '\\'  /* flails */
#define CH_whp '\\'  /* whips */
#define CH_hmr '\\'  /* hammers, maces */
#define CH_stf '_'   /* quarterstaffs, magicstaffs */
#define CH_spr '/'   /* spears, lances */
#define CH_axe '/'   /* axes */
#define CH_scy '/'   /* scythes */
#define CH_bow '}'   /* bows */
#define CH_xbw '}'   /* crossbows */
#define CH_arr '{'   /* arrows and bolts */
#define CH_rok '{'   /* sling ammo, loose rocks */
#define CH_lnt '~'   /* lantern */
#define CH_trc '~'   /* torch */
#define CH_pck '~'   /* picks */
#define CH_shv '~'   /* shovels */
#define CH_clk '('   /* cloaks, robes */
#define CH_sar '('   /* soft (leather) armors */
#define CH_har '['   /* hard (metal, nonchain) armors */
#define CH_chn '['   /* chain armors */
#define CH_drg '['   /* dragon scale mail */
#define CH_shd ')'   /* shields */
#define CH_rng '='   /* rings */
#define CH_aml '"'   /* amulets */
#define CH_wnd '-'   /* wands */
#define CH_rod '-'   /* rods */
#define CH_bok '?'   /* magic/prayer books */
#define CH_cht '~'   /* chests */
#define CH_spk '~'   /* spikes */
#define CH_trp '^'   /* generic trap */
#define CH_pit ' '   /* open pit */
#define CH_trd '^'   /* trap door */
#define CH_run '^'   /* rune */
#define CH_rub ':'   /* rubble */
#define CH_opd '\''  /* open door */
#define CH_cld '+'   /* closed door */
#define CH_ups '<'   /* up stairs */
#define CH_dns '>'   /* down stairs */
#define CH_st1 '1'   /* General Store */
#define CH_st2 '2'   /* Armoury */
#define CH_st3 '3'   /* Weaponsmith */
#define CH_st4 '4'   /* Temple */
#define CH_st5 '5'   /* Alchemist */
#define CH_st6 '6'   /* Magic */
#define CH_st7 '7'   /* Black Market */
#define CH_st8 '8'   /* Home */