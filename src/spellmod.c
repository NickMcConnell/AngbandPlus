...
void initspell(void)
{
	...
	add_constant(d, "PM_RANDOM", PM_RANDOM);
	add_constant(d, "PM_GLOVE", PM_GLOVE);
	add_constant(d, "PM_EDGED", PM_EDGED);
	add_constant(d, "PM_POWERFUL", PM_POWERFUL);
	add_constant(d, "PM_XXX1", PM_XXX1);
	add_constant(d, "PM_XXX2", PM_XXX2);
	add_constant(d, "PM_XXX3", PM_XXX3);
	add_constant(d, "PM_XXX4", PM_XXX4);
	add_constant(d, "PM_XXX5", PM_XXX5);
	add_constant(d, "PM_XXX6", PM_XXX6);
	add_constant(d, "PM_XXX7", PM_XXX7);
	add_constant(d, "PM_XXX8", PM_XXX8);
	add_constant(d, "PM_XXX9", PM_XXX9);
	add_constant(d, "PM_XXX10", PM_XXX10);
	add_constant(d, "PM_XXX11", PM_XXX11);
	add_constant(d, "PM_XXX12", PM_XXX12);
	add_constant(d, "GF_ARROW", GF_ARROW);
	add_constant(d, "GF_MISSILE", GF_MISSILE);
	add_constant(d, "GF_MANA", GF_MANA);
	add_constant(d, "GF_HOLY_ORB", GF_HOLY_ORB);
	...
	add_constant(d, "GF_SHARD", GF_SHARD);
	...
	add_constant(d, "GF_XXX1", GF_XXX1);
	add_constant(d, "GF_XXX2", GF_XXX2);
	add_constant(d, "GF_XXX3", GF_XXX3);
	add_constant(d, "GF_XXX4", GF_XXX4);
	add_constant(d, "GF_XXX5", GF_XXX5);
	add_constant(d, "GF_XXX6", GF_XXX6);
	add_constant(d, "GF_XXX7", GF_XXX7);
	add_constant(d, "GF_XXX8", GF_XXX8);
