...
/*
 * Set "p_ptr->radiant", notice observable changes
 */
bool set_radiant(int v)
{
	bool notice = FALSE;
	...
	if (v)
	{
		if (!p_ptr->radiant)
		{
			msg_print("A radiant aura surrounds your body!");
			notice = TRUE;
		}
	}
	...
	else
	{
		if (p_ptr->radiant)
		{
			msg_print("Your radiant aura vanishes.");
			notice = TRUE;
		}
	}
...
/*
 * Set "p_ptr->regen", notice observable changes
 */
bool set_regen(int v)
{
	bool notice = FALSE;
	...
	if (v)
	{
		if (!p_ptr->regen)
		{
			msg_print("Your cells regenerate more quickly.");
			notice = TRUE;
		}
	}
	...
	else
	{
		if (p_ptr->regen)
		{
			msg_print("Your cells regenerate more slowly.");
			notice = TRUE;
		}
	}
...
bool set_oppose_blind(int v)
{
	...
	if (v)
	{
		...
		{
			msg_print("Your eyes resist blindness!");
			notice = TRUE;
		}
	}
	...
	else
	{
		if (p_ptr->oppose_blind)
		{
			msg_print("Your eyes feel less resistant to blindness.");
			notice = TRUE;
		}
	}
...
bool set_oppose_conf(int v)
{
	...
	if (v)
	{
		...
		{
			msg_print("Your mind resists confusion!");
			notice = TRUE;
		}
	}
	...
	else
	{
		if (p_ptr->oppose_conf)
		{
			msg_print("Your mind feels less resistant to confusion.");
			notice = TRUE;
		}
	}
