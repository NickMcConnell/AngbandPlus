...
extern const u16b ps_id_table[160];
...
extern char *_killer;
extern s16b no_fw,fw_x[MAX_FORCE_WALLS],fw_y[MAX_FORCE_WALLS];
extern bool bale_clone_hack;
...
extern void do_cmd_extra_power(void);
...
/* cmd5.c */
extern void show_durations();
extern void do_balefire_effects(int effect);
extern int get_balefire_effect();
extern int get_psi_cost(int spell);
extern int amplify_dam(int dam);
extern int inverse_amplify(int dam);
...
extern bool lose_some_info(void);
...
extern bool balefire_done;
extern bool project_hack(int typ, int dam);
extern bool dimension_door(int lev);
...
/* xtra1.c */
extern bool target_pt(int *x, int *y);
...
extern bool set_adrenaline(int v);
extern bool set_mental_barrier(int v);
extern bool set_awareness(int v);
extern bool set_prob_travel(int v);
extern bool set_ts_anchor(int v);
extern bool set_biofeedback(int v);
extern bool set_inertial_barrier(int v);
extern bool set_precognition(int v);
...
extern bool tgt_pt(int *x, int *y, int mode);
