...
extern arena_type arena_info[MAX_ARENA_MONS + 4];
...
extern int ali_to_tr[ALI_MAX];
extern cptr weapon_skill_name[MAX_WT];
...
extern u16b max_p_idx;
extern u16b max_c_idx;
extern u16b max_h_idx;
...
extern bool alter_reality_water_flow;
...
extern void wiz_lite(bool dark);
...
extern s32b critical_shot(int weight, int plus, int dam);
extern s32b tot_dam_div(object_type *o_ptr, monster_type *m_ptr, bool in_hand);
extern s32b tot_dam_aux(object_type *o_ptr, int tdam, monster_type *m_ptr, bool in_hand);
...
extern bool do_cmd_fire(int shot_flgs, int x_to_h, int x_to_d, int penetrate, bool direct);
extern bool do_cmd_fire_aux(int item, object_type *j_ptr, int shot_flgs, int x_to_h, int x_to_d, int penetrate, bool direct);
...
extern bool set_monster_stoning(int m_idx, int v);
extern bool set_monster_melt_weapon(int m_idx, int v);
extern bool set_monster_opposite_elem(int m_idx, int v);
extern bool set_monster_silent(int m_idx, int v);
...
extern bool speed_monsters(int plev);
...
extern bool speed_monster(int dir, int plev);
extern bool slow_monster(int dir, int plev);
extern bool sleep_monster(int dir, int plev);
extern bool stasis_evil(int dir, int plev);    /* Like sleep, affects undead as well */
...
extern int activate_hi_summon(int y, int x);
...
extern bool teleport_swap(int dir, int plev);
...
extern bool explosive_rune(int plev);
...
extern bool dimension_door(int plev);
extern bool aqua_diving(int plev);
...
extern void set_mermaid_in_water(void);
...
extern void gain_class_exp(s32b amount);
extern void gain_racial_exp(s32b amount);
extern void gain_exp(s32b amount);
extern void lose_class_exp(s32b amount);
extern void lose_racial_exp(s32b amount);
extern void lose_exp(s32b amount);
extern bool drain_exp(s32b rdrain, s32b cdrain, s32b rslip, s32b cslip, int hold_life_prob);
...
extern void check_racial_experience(void);
...
extern s32b bow_energy(object_type *o_ptr);
extern int bow_tmul(object_type *o_ptr);
extern s32b rocket_damage(object_type *o_ptr, int to_d);
...
extern void change_your_alignment(int align, int amt);
extern void change_alignment_lnc(void);
...
/* obj_kind.c */
extern bool object_is_food(object_type *o_ptr);
extern bool object_is_potion(object_type *o_ptr);
extern bool object_is_readable(object_type *o_ptr);
extern bool object_is_activate(object_type *o_ptr);
extern bool object_is_useable(object_type *o_ptr);
...
extern bool object_is_recharge(object_type *o_ptr);
extern bool object_is_weapon_armour(object_type *o_ptr);
...
extern bool object_is_gun(object_type *o_ptr);
...
extern bool object_is_convertible(object_type *o_ptr);
extern bool object_is_ego_creatable(object_type *o_ptr);
extern bool object_is_corpse(object_type *o_ptr);
