...
extern sint critical_melee(int chance, int sleeping_bonus, char m_name[], object_type *o_ptr);
extern sint tot_dam_aux(object_type *o_ptr, monster_type *m_ptr);
...
extern void init_new_town(void);
...
extern void show_inven(int start);
...
extern s16b weapon_skill(object_type *o_ptr);
...
extern void apply_tmcurse();
extern bool project(int who, int rad, int y, int x, int dam, int typ, int flg, int degrees_of_arc, byte diameter_of_source);
...
extern bool detect_traps(int fail);
extern bool detect_doors(int fail);
extern bool detect_stairs(int fail);
extern bool detect_treasure(void);
extern bool detect_objects_gold(void);
extern bool detect_objects_normal(void);
extern bool detect_objects_magic(void);
extern bool detect_monsters_normal(int fail);
...
extern bool fire_sphere(int typ, int dir, int dam, int rad, byte diameter_of_source);
...
extern byte get_angle_to_grid[33][33];
...
extern bool set_nasty_poisoned(bool set);
...
extern bool set_temp_invis(int v);
