...
extern void drop_near(const object_type *j_ptr, int chance, int y, int x);
...
extern bool detect_traps(int animate);
extern bool detect_doors(int animate);
extern bool detect_stairs(int animate);
extern bool detect_treasure(int animate);
