...
extern quest q_list[MAX_QUESTS + DEFAULT_QUESTS];  /* Heino Vander Sanden */
...
extern bool identify_fully_aux2(object_type *o_ptr, cptr *info, int len);
...
extern bool project(int who, bool pet_attack, int rad, int y, int x, int dam, int typ, int flg, bool bolt);
...
extern bool detect_random(void);
...
extern bool detect_monsters_mental(void);
...
extern bool monk_empty_hands();
extern bool monk_heavy_armor();
