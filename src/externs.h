...
extern void do_cmd_throw(bool magic);
...
extern int click_area(key_event ke);
...
extern void do_cmd_note(char *note, int what_stage);
...
extern int get_recall_pt(cptr reason, bool extra);
