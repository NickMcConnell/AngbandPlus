...
extern const u16b realm_choices1[];
extern const u16b realm_choices2[];
extern cptr realm_names[];
extern cptr spell_names[10][32];
extern cptr spell_xtra[10][32];
...
extern bool earthquake(int cy, int cx, int r, int cast);
...
extern bool destroy_doors(int rad);
extern bool destroy_traps(int rad);
...
extern bool rain_effect(int type, int dam, int fuel, int rad, int area);
...
extern bool dimension_door(int i);
...
extern bool set_ac1(int v);
extern bool set_ac2(int v);
extern bool set_free_act(int v);
extern bool set_ffall(int v);
extern bool set_sh_fire(int v);
extern bool set_sh_elec(int v);
...
/* class.c */
extern class_power class_powers[CLASS_ABILITY_MAX];
extern void class_ability_info(char *p, int power);
extern void do_cmd_class(void);
