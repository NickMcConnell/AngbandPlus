...
extern void object_flags(object_type *i_ptr, u32b *f1, u32b *f2, u32b *f3);
extern void object_desc(char *buf, object_type *i_ptr, int pref, int mode);
extern void object_desc_store(char *buf, object_type *i_ptr, int pref, int mode);
extern bool identify_fully_aux(object_type *i_ptr);
...
extern s16b inven_carry(object_type *i_ptr);
...
extern void object_absorb(object_type *i_ptr, object_type *j_ptr);
extern s16b lookup_kind(int tval, int sval);
extern void invwipe(object_type *i_ptr);
extern void invcopy(object_type *i_ptr, int k_idx);
extern void apply_magic(object_type *i_ptr, int lev, bool okay, bool good, bool great);
extern void place_object(int y, int x, bool good, bool great);
extern void acquirement(int y1, int x1, int num, bool great);
extern void place_trap(int y, int x);
extern void place_gold(int y, int x);
extern void process_objects(void);
extern void drop_near(object_type *i_ptr, int chance, int y, int x);
...
extern bool enchant(object_type *i_ptr, int n, int eflag);
