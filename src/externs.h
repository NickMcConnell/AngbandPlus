...
extern s16b crusher_n;
extern s32b crusher_t[CRUSHER_MAX];
extern byte crusher_y[CRUSHER_MAX];
extern byte crusher_x[CRUSHER_MAX];
...
extern byte *temp_y;
extern byte *temp_x;
extern byte_256 *cave_info;
extern byte_256 *cave_feat;
extern s16b_wid *cave_o_idx;
extern s16b_wid *cave_m_idx;
extern byte_wid *cave_cost;
extern byte_wid *cave_when;
extern object_type *o_list;
extern monster_type *m_list;
extern quest_type q_list[MAX_Q_IDX];
extern int level_quest[MAX_DEPTH];
...
extern void do_cmd_knowledge_damage(void);
...
extern bool wrap_knowledge(cptr (*knowledge_hook)(FILE *fff, vptr xtra), vptr xtra);
...
/* generate.c */
extern void draw_grid_full(int x, int y, byte feat, byte info);
extern void draw_grid_feat(int x, int y, byte feat);
extern void draw_grid_info(int x, int y, byte info);
...
extern void get_mon_num_prep(bool (*check_race)(int r_idx));
...
extern s16b monster_carry(int m_idx, object_type *o_ptr);
...
extern bool summon_specific(int y1, int x1, int lev, int type, bool group, bool friendly);
...
extern cptr identify_fully_aux(FILE *fff, vptr v_ptr);
...
extern bool potion_smash_effect(int y, int x, int o_sval);
