...
extern bool alloc_monster(bool on_stairs);
...
extern byte strength_modified_ds(const object_type *o_ptr, bool wielded, bool offhand);
...
extern bool allow_player_paralysis(monster_type *m_ptr);
