...
extern player_weapon weapon_info[MAX_CLASS];
extern byte specialty_info [MAX_CLASS][CLASS_SPECIALTIES];
...
extern cptr specialty_names[255];
...
extern bool check_specialty(int specialty);
