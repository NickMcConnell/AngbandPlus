...
void do_cmd_wield(void)
{
	...
	if (munchkin_wield)
	{
		/* Allow all slots, even empty ones */
		item_tester_full = TRUE;

		/* Messages */
		q = "Wear/Wield into which slot? ";
		s = "You have no equipment slots. (Oops!)";
 ...
 * Heavily modified -- Prfnoff (scroll)
 */
void do_cmd_locate(void)
{
	...
	while (1)
	{
		...
		sprintf(out_val,
		        ...
		        y2 / (SCREEN_HGT / 2), y2 % (SCREEN_HGT / 2), /* Prfnoff (scroll) */
