...
OBJS = &
  ...
  main-ibm.obj main.obj skills.obj talents.obj

all: sangband.exe gredit.exe makepref.exe

# Use whichever of these two you wish...
sangband.exe: $(OBJS) sangband.lnk
   wlink system dos4g @sangband.lnk
#   wlink system pmodew @sangband.lnk
...
sangband.lnk:
    %create  sangband.lnk
#   @%append sangband.lnk debug all
    @%append sangband.lnk OPTION CASEEXACT
    @%append sangband.lnk OPTION STACK=16k
    @%append sangband.lnk name angband
    @for %i in ($(OBJS)) do @%append sangband.lnk file %i
