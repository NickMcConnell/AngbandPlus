...
static const s16b convert_old_kinds_normal[501] =
{
	...
	222,		/* a tonic of Slime Mold Juice */
	223,		/* a tonic of Apple Juice */
	224,		/* a tonic of Water */
	225,		/* a tonic of Strength */
	226,		/* a tonic of Weakness */
	227,		/* a tonic of Restore Strength */
	228,		/* a tonic of Intelligence */
	229,		/* a tonic of Stupidity */
	230,		/* a tonic of Restore Intelligence */
	231,		/* a tonic of Wisdom */
	232,		/* a tonic of Naivety */
	233,		/* a tonic of Restore Wisdom */
	234,		/* a tonic of Charisma */
	235,		/* a tonic of Ugliness */
	236,		/* a tonic of Restore Charisma */
	237,		/* a tonic of Cure Light Wounds */
	237,		/* Move: tonic of Cure Light Wounds (extra) */
	237,		/* Move: tonic of Cure Light Wounds (extra) */
	240,		/* a tonic of Cure Serious Wounds */
	241,		/* a tonic of Cure Critical Wounds */
	242,		/* a tonic of Healing */
	243,		/* a tonic of Constitution */
	244,		/* a tonic of Experience */
	245,		/* a tonic of Sleep */
	246,		/* a tonic of Blindness */
	247,		/* a tonic of Confusion */
	248,		/* a tonic of Poison */
	249,		/* a tonic of Speed */
	250,		/* a tonic of Slowness */
	251,		/* a tonic of Dexterity */
	252,		/* a tonic of Restore Dexterity */
	253,		/* a tonic of Restore Constitution */
	254,		/* a tonic of Lose Memories */
	255,		/* a tonic of Salt Water */
	249,		/* Move: tonic of Speed (extra) */
	257,		/* a tonic of Heroism */
	258,		/* a tonic of Berserk Strength */
	259,		/* a tonic of Boldness */
	260,		/* a tonic of Restore Life Levels */
	261,		/* a tonic of Resist Heat */
	262,		/* a tonic of Resist Cold */
	263,		/* a tonic of Detect Invisible */
	264,		/* a tonic of Slow Poison */
	265,		/* a tonic of Neutralize Poison */
	266,		/* a tonic of Restore Mana */
	267,		/* a tonic of Infra-vision */
	...
	43,			/* Move: Daggers (ancient artifacts?) */
	35,			/* Move: Short Sword */
	422,		/* Move: tonic of *Enlightenment* */
	417,		/* Move: tonic of Detonations */
	415,		/* Move: tonic of Death */
	420,		/* Move: tonic of Life */
	418,		/* Move: tonic of Augmentation */
	416,		/* Move: tonic of Ruination */
	...
	256,		/* Move: tonic of Enlightenment */
	421,		/* Move: tonic of Self Knowledge */
	...
	237,		/* Move: tonics of Cure Light Wounds (store) */
	257,		/* Move: tonics of Heroism (store) */
	259,		/* Move: tonics of Boldness (store) */
	264,		/* Move: tonics of Slow Poison (store) */
...
static errr rd_item_old(object_type *o_ptr)
{
	...
	if (!wearable_p(o_ptr))
	{
		...
		if (o_ptr->tval == TV_RAY) o_ptr->pval = old_pval;
		if (o_ptr->tval == TV_TOOL) o_ptr->pval = old_pval;
...
static void rd_extra_old(void)
{
	...
	if (!older_than(0, 0, 0)) strip_bytes(1);
...
static errr rd_dungeon_old(void)
{
	...
	for (i = 2; i < limit; i++)
	{
		...
		/* Strip max hitpoints */
		if (!older_than(0, 0, 0)) strip_bytes(2);
...
static void rd_options_old(void)
{
	...
	/* Hack -- Unused options */
	if (!older_than(0, 0, 0)) strip_bytes(12);
}
...
static errr rd_savefile_old_aux(void)
{
	...
	if (!older_than(0, 0, 0)) strip_bytes(98);
