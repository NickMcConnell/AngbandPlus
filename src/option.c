...
const int option_page[OPT_PAGE_MAX][OPT_PAGE_PER] =
  {
    ...
    
    {
      ...
      /* OPT_birth_dungeon, */ /* Dummied, added extra OPT_NONE to end */
      OPT_birth_no_sell,
...
static option_entry options[OPT_MAX] =
{
    ...
    {"birth_small_device",    "Birth: View and spell distances halved",
     FALSE /* 135 */},
     /*
      * Hack: Ponyband has no Wilderness. FORCE this to be True.
      * Never Display it - how?
          {"birth_dungeon",         "Birth: Dummied. Has no effect",
     TRUE},
      * If I uncomment this, replace the **s about to make a comment block
      */
    ...
    {"adult_small_device",    "Adult: View and spell distances halved",
     FALSE /* 198 */},
     /*
      * Ponyband has no Wilderness.
      *
      *{"adult_dungeon",         "Adult: Dummied: Ponyband has no Wilderness",
      *TRUE },
      */
    ...
    {NULL,                     NULL,
     FALSE /* 253 */},
     /*
      * Counts are off because I removed the no wilderness option.
      * Adding another NULL to compensate
      */
    {NULL,                     NULL,
     FALSE /* 254 */},
    {NULL,                     NULL,
