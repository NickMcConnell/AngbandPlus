...
/* Sorcery and Evocations */
   ...
   {		  /* Priest	   */
     ...
     { 15, 12, 75,  300},   /* Holy Shield */
     { 25, 25, 80,  1500},  /* Banishment */
     { 35, 35, 80,  1000},  /* Word of Destruction */
     { 45, 60, 75,  4000},  /* Invulnerability */
     { 45, 60, 75,  4000},  /* Annihilation */
   ...
   {		  /* Paladin	   */
     ...
     { 20, 20, 75,   300}, /* Holy Shield */
     { 30, 35, 80,  1500}, /* Banishment */
     { 40, 40, 80,  1000}, /* Word of Destruction */
     { 99, 99,  0,     0}, /* Invulnerability */
     { 47, 70, 75,  4000}, /* Annihilation */
...
char *spell_names[127] = {
  ...
  "Confusion",	"Lightning Bolt",  "Trap/Door Destruction", "Sleep Monster",
  "Wizard Lock",  "Teleport Self",  "Spear of Light",  "Frost Bolt",
  "Turn Stone to Mud",	"Create Food",	"Recharge Item I",  "Mass Sleep",
  "Polymorph Other",  "Identify",  "Cone of Cold", "Fire Bolt",  "Slow Monster",
...
/* tenser's transformations...*/
  ...
  "Spiritual Hammer", "Detect Traps/Doors", "Slow Poison", "Cause Fear",
