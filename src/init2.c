...
{
	{
		...
		{ TV_LITE, SV_WOODEN_TORCH },
		{ TV_LITE, SV_WOODEN_TORCH },
		{ TV_LITE, SV_WOODEN_TORCH },
		{ TV_LITE, SV_WOODEN_TORCH },
		{ TV_LITE, SV_ENCHANTED_TORCH },
		{ TV_LITE, SV_ENCHANTED_TORCH },
		{ TV_CLOAK, SV_CLOAK },
		{ TV_CLOAK, SV_CLOAK },
...

	{
		...
		{ TV_POTION, SV_POTION_SNEAKINESS },
		...
		{ TV_POTION, SV_POTION_RES_VIGOR },
		{ TV_POTION, SV_POTION_RES_VIGOR },
		{ TV_POTION, SV_POTION_RES_WIT },
		{ TV_POTION, SV_POTION_RES_WIT },
		{ TV_POTION, SV_POTION_RES_GRACE },
		{ TV_POTION, SV_POTION_RES_GRACE },
...

	{
		...
		{ TV_STAFF, SV_STAFF_DETECT_FORCE },
		{ TV_STAFF, SV_STAFF_DETECT_LIFE },
		{ TV_AMULET, SV_AMULET_CHR },
		{ TV_AMULET, SV_AMULET_INT },
		{ TV_AMULET, SV_AMULET_WIS },
...

	{
		...
		{ TV_MAGIC_BOOK, SV_BOOK_MAGE4 },
		{ TV_MAGIC_BOOK, SV_BOOK_MAGE5 },
		{ TV_MAGIC_BOOK, SV_BOOK_MAGE5 },
		{ TV_MAGIC_BOOK, SV_BOOK_MAGE6 },
