 ...
 *
 * Totally re-organized for Gumband 2.1.2b -- Gumby
 */
static byte store_table[MAX_STORES][STORE_CHOICES][2] =
{
...

	{
		...
		{ TV_HARD_ARMOR, SV_CHAIN_MAIL },
		{ TV_HARD_ARMOR, SV_METAL_BRIGANDINE },
...
static errr init_other(void)
{
	...
	for (i = 0; i < MAX_STORES; i++)
	{
		...
		/* Assume full stock */
		/* Home now has 4 pages (delete first 3 lines to revert) */
		if (i == 7)
			st_ptr->stock_size = STORE_INVEN_MAX * 2;
		else
