...
{
	{
		...
		{ TV_SHOT, SV_AMMO_NORMAL },
                ...
                { TV_SHOT, SV_AMMO_HEAVY },
		{ TV_SHOT, SV_AMMO_SILVER },
		{ TV_ARROW, SV_AMMO_NORMAL },
		{ TV_ARROW, SV_AMMO_HEAVY },
		{ TV_ARROW, SV_AMMO_SILVER },
		{ TV_BOLT, SV_AMMO_NORMAL },
		{ TV_BOLT, SV_AMMO_HEAVY },
		{ TV_BOLT, SV_AMMO_SILVER },
...

	{
		...
		{ TV_HARD_ARMOR, SV_MITHRIL_CHAIN_MAIL },
		{ TV_HARD_ARMOR, SV_MITHRIL_PLATE_MAIL },
		{ TV_HARD_ARMOR, SV_ADAMANTITE_PLATE_MAIL },
		...
		{ TV_SHIELD, SV_SHIELD_OF_DEFLECTION },
	},
...

	{
		...
		{ TV_STAFF, SV_STAFF_DETECT_INVIS },
                ...
                { TV_RING, SV_RING_SLAYING },
		{ TV_ROD, SV_ROD_IDENTIFY },
		{ TV_ROD, SV_ROD_RECALL },
		{ TV_ROD, SV_ROD_DETECTION },
...
static errr init_other(void)
{
	...
	for (i = 0; i < MAX_STORES; i++)
	{
		...
		if ((i == STORE_B_MARKET) || (i == STORE_HOME) ||
                     (i == STORE_A_G_1) || (i == STORE_A_G_2)) continue;
