 ...
 */
/* OBSOLETE FUNCTION */
/*static errr init_wilderness2(void)
{
	int i;
...
void init_angband(void)
{
	...
	if (init_r_info()) quit("Cannot initialize monsters");
        ...
        if (init_wilderness() != 1) quit("Cannot initialize wilderness map");
	...
	/* Initialize skills names */
        note("[Initializing arrays... (skills names)]");
        if (init_skills_names() != 0) quit("Cannot initialize skills names");

	/* Initialize classes */
        note("[Initializing arrays... (classes)]");
        if (init_classes() != 0) quit("Cannot initialize classes/abilities");
