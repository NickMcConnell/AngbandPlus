     ...
     for(;;)
     {
          ...
          switch(event.type)
          {
               ...
               case SDL_KEYDOWN:
                    ...
                    {
                         fprintf(stderr, "Handling shifted key.\n");
                         ...
                         */
                         switch(event.key.keysym.sym)
                         {
                              ...
                              case SDLK_KP8:
                              case SDLK_KP9:
                                   fprintf(stderr, "Handling keypad.\n");
                         ...
                         fprintf(stderr, "Inserting keypress '%c'\n", key);
                    Term_keypress(key);
 ...
 */
static errr Term_bigcurs_sdl(int x, int y)
{
     return(0);
}
...
bool IH_InitTerm(void)
{
     ...
     /* Initialize the term */
     term_init(t, 80 /* td->cols */, 25 /* td->rows */, 20 /* td->keys */);
