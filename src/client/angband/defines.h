 ...
 */
#define VERSION_NAME "Iron Hells"

/*
 * Current version string (even though the program name is different,
                           we keep the version number of Angband from
                           which it's based, for file compatibility.)
 */
