...
static int
toluaI_get_random_Rand_quick(lua_State * tolua_S)
{
...
static int
toluaI_set_random_Rand_quick(lua_State * tolua_S)
{
...
/* function: rand_int */
static int
toluaI_random_rand_int00(lua_State * tolua_S)
{
...
/* function: randint */
static int
toluaI_random_randint00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
/* function: rand_die */
static int
toluaI_random_rand_die00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
/* function: rand_range */
static int
toluaI_random_rand_range00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
...
static int
toluaI_random_rand_spread00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
/* function: damroll */
static int
toluaI_random_damroll00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
/* function: maxroll */
static int
toluaI_random_maxroll00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
static int
toluaI_random_Rand_state_init00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
/* function: Rand_div */
static int
toluaI_random_Rand_div00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_random_Rand_normal00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
static int
toluaI_random_Rand_simple00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
/* Open function */
int
tolua_random_open(lua_State * tolua_S)
{
     tolua_open(tolua_S);
     toluaI_reg_types(tolua_S);
     tolua_globalvar(tolua_S, "Rand_quick", toluaI_get_random_Rand_quick,
                     toluaI_set_random_Rand_quick);
     ...
     tolua_function(tolua_S, NULL, "rand_range",
                    toluaI_random_rand_range00);
     tolua_function(tolua_S, NULL, "rand_spread",
                    toluaI_random_rand_spread00);
     tolua_function(tolua_S, NULL, "damroll", toluaI_random_damroll00);
     tolua_function(tolua_S, NULL, "maxroll", toluaI_random_maxroll00);
     tolua_function(tolua_S, NULL, "Rand_state_init",
                    toluaI_random_Rand_state_init00);
     tolua_function(tolua_S, NULL, "Rand_div", toluaI_random_Rand_div00);
     tolua_function(tolua_S, NULL, "Rand_normal",
                    toluaI_random_Rand_normal00);
     tolua_function(tolua_S, NULL, "Rand_simple",
                    toluaI_random_Rand_simple00);
     return 1;
}

/* Close function */
void
tolua_random_close(lua_State * tolua_S)
{
     lua_getglobals(tolua_S);
     lua_pushstring(tolua_S, "Rand_quick");
     lua_pushnil(tolua_S);
     lua_rawset(tolua_S, -3);
     lua_pop(tolua_S, 1);
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "rand_int");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "randint");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "rand_die");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "rand_range");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "rand_spread");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "damroll");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "maxroll");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "Rand_state_init");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "Rand_div");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "Rand_normal");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "Rand_simple");
}
