...
static int
toluaI_ui_notice_stuff00(lua_State * tolua_S)
{
...
static int
toluaI_ui_update_stuff00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_ui_redraw_stuff00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_ui_window_stuff00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_ui_handle_stuff00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* function: inkey */
static int
toluaI_ui_inkey00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* function: bell */
static int
toluaI_ui_bell00(lua_State * tolua_S)
{
...
/* function: sound */
static int
toluaI_ui_sound00(lua_State * tolua_S)
{
...
/* function: msg_print */
static int
toluaI_ui_msg_print00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TSTRING, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
/* function: message */
static int
toluaI_ui_message00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
     ...
     {
          u16b            message_type =
              ((u16b) tolua_getnumber(tolua_S, 1, 0));
          s16b            extra = ((s16b) tolua_getnumber(tolua_S, 2, 0));
          cptr            message_text =
              ((cptr) tolua_getstring(tolua_S, 3, 0));
          {
...
static int
toluaI_ui_message_flush00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_ui_screen_save00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_ui_screen_load00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* function: c_put_str */
static int
toluaI_ui_c_put_str00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
...
/* function: put_str */
static int
toluaI_ui_put_str00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TSTRING, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
...
/* function: c_prt */
static int
toluaI_ui_c_prt00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TSTRING, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
...
/* function: prt */
static int
toluaI_ui_prt00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TSTRING, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
...
/* function: clear_from */
static int
toluaI_ui_clear_from00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
/* function: pause_line */
static int
toluaI_ui_pause_line00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_ui_request_command00(lua_State * tolua_S)
{
...
static int
toluaI_ui_get_aim_dir00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 1) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
     else
     {
...
static int
toluaI_ui_text_out00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TSTRING, 0) ||
...
/* function: flush */
static int
toluaI_ui_flush00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* function: flush_fail */
static int
toluaI_ui_flush_fail00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* Open function */
int
tolua_ui_open(lua_State * tolua_S)
{
     tolua_open(tolua_S);
     ...
     tolua_constant(tolua_S, NULL, "MSG_NOTHING_TO_OPEN",
                    MSG_NOTHING_TO_OPEN);
     ...
     tolua_function(tolua_S, NULL, "notice_stuff",
                    toluaI_ui_notice_stuff00);
     tolua_function(tolua_S, NULL, "update_stuff",
                    toluaI_ui_update_stuff00);
     tolua_function(tolua_S, NULL, "redraw_stuff",
                    toluaI_ui_redraw_stuff00);
     tolua_function(tolua_S, NULL, "window_stuff",
                    toluaI_ui_window_stuff00);
     tolua_function(tolua_S, NULL, "handle_stuff",
                    toluaI_ui_handle_stuff00);
     ...
     tolua_function(tolua_S, NULL, "message_flush",
                    toluaI_ui_message_flush00);
     ...
     tolua_function(tolua_S, NULL, "request_command",
...
tolua_ui_close(lua_State * tolua_S)
{
     ...
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_HIT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_MISS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_FLEE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_DROP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_KILL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_LEVEL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_DEATH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_STUDY");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_TELEPORT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_SHOOT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_QUAFF");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_ZAP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_WALK");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_TPOTHER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_HITWALL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_EAT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_STORE1");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_STORE2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_STORE3");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_STORE4");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_DIG");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_OPENDOOR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_SHUTDOOR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_TPLEVEL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_BELL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_NOTHING_TO_OPEN");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_LOCKPICK_FAIL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_STAIRS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_HITPOINT_WARN");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MSG_MAX");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PN_COMBINE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PN_REORDER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PU_BONUS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PU_TORCH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PU_HP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PU_MANA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PU_SPELLS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PU_FORGET_VIEW");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PU_UPDATE_VIEW");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PU_FORGET_FLOW");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PU_UPDATE_FLOW");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PU_MONSTERS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PU_DISTANCE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PU_PANEL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_MISC");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_TITLE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_LEV");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_EXP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_STATS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_ARMOR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_HP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_MANA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_GOLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_DEPTH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_EQUIPPY");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_HEALTH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_CUT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_STUN");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_HUNGER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_BLIND");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_CONFUSED");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_AFRAID");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_POISONED");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_STATE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_SPEED");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_STUDY");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_EXTRA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_BASIC");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PR_MAP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_INVEN");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_EQUIP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_PLAYER_0");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_PLAYER_1");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_MESSAGE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_OVERHEAD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_MONSTER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_OBJECT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_SNAPSHOT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_SCRIPT_VARS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_SCRIPT_SOURCE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_BORG_1");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "PW_BORG_2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "notice_stuff");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "update_stuff");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "redraw_stuff");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "window_stuff");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "handle_stuff");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "inkey");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "bell");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "sound");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "msg_print");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "message");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "message_flush");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "screen_save");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "screen_load");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "c_put_str");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "put_str");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "c_prt");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "prt");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "clear_from");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "pause_line");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "request_command");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "get_aim_dir");
     lua_pushnil(tolua_S);
     ...
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "flush_fail");
}
