 ...
 * This allows objects to be "memorized" independent of the terrain features.
 *
 ...
 */
static          bool
ang_sort_comp_hook_longs(const void *u,
                         const void *v,
                         int a,
                         int b)
{
 ...
 */
static void
ang_sort_swap_hook_longs(void *u,
                         void *v,
                         int a,
                         int b)
{
 ...
 */
static void
vinfo_init_aux(vinfo_hack * hack,
               int y,
               int x,
               long m)
{
