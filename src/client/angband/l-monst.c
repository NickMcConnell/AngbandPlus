...
static int
toluaI_get_monst_monster_blow_method(lua_State * tolua_S)
{
     monster_blow   *self =
         (monster_blow *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
          TOLUA_ERR_SELF;
...
static int
toluaI_set_monst_monster_blow_method(lua_State * tolua_S)
{
     monster_blow   *self =
         (monster_blow *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_blow_effect(lua_State * tolua_S)
{
     monster_blow   *self =
         (monster_blow *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_blow_effect(lua_State * tolua_S)
{
     monster_blow   *self =
         (monster_blow *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_blow_d_dice(lua_State * tolua_S)
{
     monster_blow   *self =
         (monster_blow *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_blow_d_dice(lua_State * tolua_S)
{
     monster_blow   *self =
         (monster_blow *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_blow_d_side(lua_State * tolua_S)
{
     monster_blow   *self =
         (monster_blow *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_blow_d_side(lua_State * tolua_S)
{
     monster_blow   *self =
         (monster_blow *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_name(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
          TOLUA_ERR_SELF;
...
static int
toluaI_set_monst_monster_race_name(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_text(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_text(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_hdice(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_hdice(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_hside(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_hside(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_ac(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_ac(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_sleep(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_sleep(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_aaf(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_aaf(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_speed(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_speed(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_mexp(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_mexp(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_freq_innate(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_freq_innate(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_freq_spell(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_freq_spell(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_flags1(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_flags1(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_flags2(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_flags2(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_flags3(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_flags3(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_flags4(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_flags4(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_flags5(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_flags5(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_flags6(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_flags6(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_blow(lua_State * tolua_S)
{
     int             toluaI_index;
     monster_race   *self;
     ...
     tolua_pushusertype(tolua_S, (void *) &self->blow[toluaI_index],
                        tolua_tag(tolua_S, "monster_blow"));
     return 1;
}

/* set function: blow of class  monster_race */
static int
toluaI_set_monst_monster_race_blow(lua_State * tolua_S)
{
     int             toluaI_index;
     monster_race   *self;
     ...
     if(toluaI_index < 0 || toluaI_index >= MONSTER_BLOW_MAX)
          tolua_error(tolua_S, "array indexing out of range.");
     self->blow[toluaI_index] =
         *((monster_blow *) tolua_getusertype(tolua_S, 3, 0));
     return 0;
}

/* get function: level of class  monster_race */
static int
toluaI_get_monst_monster_race_level(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_level(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_rarity(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_rarity(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_d_attr(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_d_attr(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_d_char(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_d_char(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_x_attr(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_x_attr(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_x_char(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_x_char(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_max_num(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_max_num(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_race_cur_num(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_race_cur_num(lua_State * tolua_S)
{
     monster_race   *self =
         (monster_race *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_sights(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
          TOLUA_ERR_SELF;
...
static int
toluaI_set_monst_monster_lore_sights(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_deaths(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_deaths(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_pkills(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_pkills(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_tkills(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_tkills(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_wake(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_wake(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_ignore(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_ignore(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_drop_gold(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_drop_gold(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_drop_item(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_drop_item(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_cast_innate(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_cast_innate(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_cast_spell(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_cast_spell(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_blows(lua_State * tolua_S)
{
     int             toluaI_index;
     monster_lore   *self;
...
static int
toluaI_set_monst_monster_lore_blows(lua_State * tolua_S)
{
     int             toluaI_index;
     monster_lore   *self;
...
static int
toluaI_get_monst_monster_lore_flags1(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_flags1(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_flags2(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_flags2(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_flags3(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_flags3(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_flags4(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_flags4(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_flags5(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_flags5(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_lore_flags6(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_lore_flags6(lua_State * tolua_S)
{
     monster_lore   *self =
         (monster_lore *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_r_idx(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
          TOLUA_ERR_SELF;
...
static int
toluaI_set_monst_monster_type_r_idx(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_fy(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_fy(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_fx(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_fx(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_hp(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_hp(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_maxhp(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_maxhp(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_csleep(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_csleep(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_mspeed(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_mspeed(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_energy(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_energy(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_stunned(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_stunned(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_confused(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_confused(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_monfear(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_monfear(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_cdis(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_cdis(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_mflag(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_mflag(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_ml(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_ml(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_monster_type_hold_o_idx(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_set_monst_monster_type_hold_o_idx(lua_State * tolua_S)
{
     monster_type   *self =
         (monster_type *) tolua_getusertype(tolua_S, 1, 0);
     if(!self)
...
static int
toluaI_get_monst_mon_max(lua_State * tolua_S)
{
...
static int
toluaI_set_monst_mon_max(lua_State * tolua_S)
{
...
static int
toluaI_get_monst_mon_cnt(lua_State * tolua_S)
{
...
static int
toluaI_set_monst_mon_cnt(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0))
          TOLUA_ERR_ASSIGN;
...
static int
toluaI_monst_make_attack_normal00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
...
static int
toluaI_monst_make_attack_spell00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_monst_process_monsters00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
     ...
     {
          byte            minimum_energy =
              ((byte) tolua_getnumber(tolua_S, 1, 0));
          {
...
/* function: roff_top */
static int
toluaI_monst_roff_top00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_monst_screen_roff00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_monst_display_roff00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_monst_delete_monster_idx00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_monst_delete_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
...
static int
toluaI_monst_compact_monsters00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_monst_wipe_mon_list00(lua_State * tolua_S)
{
...
/* function: mon_pop */
static int
toluaI_monst_mon_pop00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_monst_get_mon_num_prep00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_monst_get_mon_num00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_monst_monster_desc00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TSTRING, 0) ||
        !tolua_istype(tolua_S, 2, tolua_tag(tolua_S, "size_t"), 0) ||
        !tolua_istype(tolua_S, 3, tolua_tag(tolua_S, "const monster_type"),
                      0) || !tolua_istype(tolua_S, 4, LUA_TNUMBER, 0) ||
     ...
     else
     {
          ...
          size_t          max =
              *((size_t *) tolua_getusertype(tolua_S, 2, 0));
          const monster_type *m_ptr =
              ((const monster_type *) tolua_getusertype(tolua_S, 3, 0));
...
static int
toluaI_monst_lore_do_probe00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_monst_lore_treasure00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
     ...
     else
     {
          int             m_idx = ((int) tolua_getnumber(tolua_S, 1, 0));
          int             num_item =
              ((int) tolua_getnumber(tolua_S, 2, 0));
          int             num_gold =
...
/* function: update_mon */
static int
toluaI_monst_update_mon00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
...
static int
toluaI_monst_update_monsters00(lua_State * tolua_S)
{
...
static int
toluaI_monst_monster_carry00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
     ...
     else
     {
          int             m_idx = ((int) tolua_getnumber(tolua_S, 1, 0));
          object_type    *j_ptr =
              ((object_type *) tolua_getusertype(tolua_S, 2, 0));
          {
               s16b            toluaI_ret =
                   (s16b) monster_carry(m_idx, j_ptr);
               tolua_pushnumber(tolua_S, (long) toluaI_ret);
          }
     }
     return 1;
...
static int
toluaI_monst_monster_swap00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
...
static int
toluaI_monst_player_place00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
static int
toluaI_monst_monster_place00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
     ...
     else
     {
          ...
          int             x = ((int) tolua_getnumber(tolua_S, 2, 0));
          monster_type   *n_ptr =
              ((monster_type *) tolua_getusertype(tolua_S, 3, 0));
          {
               s16b            toluaI_ret =
                   (s16b) monster_place(y, x, n_ptr);
               tolua_pushnumber(tolua_S, (long) toluaI_ret);
          }
     }
     return 1;
...
static int
toluaI_monst_place_monster_aux00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
     ...
     else
     {
          ...
          {
               bool            toluaI_ret =
                   (bool) place_monster_aux(y, x, r_idx, slp, grp);
               tolua_pushbool(tolua_S, (int) toluaI_ret);
          }
     }
     return 1;
...
static int
toluaI_monst_place_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
     ...
     else
     {
          ...
          {
               bool            toluaI_ret =
                   (bool) place_monster(y, x, slp, grp);
               tolua_pushbool(tolua_S, (int) toluaI_ret);
          }
     }
     return 1;
...
static int
toluaI_monst_alloc_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, tolua_tag(tolua_S, "bool"), 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
static int
toluaI_monst_summon_specific00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
     ...
     else
     {
          ...
          {
               bool            toluaI_ret =
                   (bool) summon_specific(y1, x1, lev, type);
               tolua_pushbool(tolua_S, (int) toluaI_ret);
          }
     }
     return 1;
...
static int
toluaI_monst_multiply_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_monst_message_pain00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
static int
toluaI_monst_update_smart_learn00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
static int
toluaI_monst_monster_death00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_monst_mon_take_hit00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, tolua_tag(tolua_S, "bool"), 0) ||
     ...
     else
     {
          ...
          {
               bool            toluaI_ret =
                   (bool) mon_take_hit(m_idx, dam, &fear, note);
               tolua_pushbool(tolua_S, (int) toluaI_ret);
...
/* Open function */
int
tolua_monst_open(lua_State * tolua_S)
{
     tolua_open(tolua_S);
     ...
     tolua_tablevar(tolua_S, "monster_blow", "method",
                    toluaI_get_monst_monster_blow_method,
                    toluaI_set_monst_monster_blow_method);
     tolua_tablevar(tolua_S, "monster_blow", "effect",
                    toluaI_get_monst_monster_blow_effect,
                    toluaI_set_monst_monster_blow_effect);
     tolua_tablevar(tolua_S, "monster_blow", "d_dice",
                    toluaI_get_monst_monster_blow_d_dice,
                    toluaI_set_monst_monster_blow_d_dice);
     tolua_tablevar(tolua_S, "monster_blow", "d_side",
                    toluaI_get_monst_monster_blow_d_side,
                    toluaI_set_monst_monster_blow_d_side);
     tolua_cclass(tolua_S, "monster_race", "");
     tolua_tablevar(tolua_S, "monster_race", "name",
                    toluaI_get_monst_monster_race_name,
                    toluaI_set_monst_monster_race_name);
     tolua_tablevar(tolua_S, "monster_race", "text",
                    toluaI_get_monst_monster_race_text,
                    toluaI_set_monst_monster_race_text);
     tolua_tablevar(tolua_S, "monster_race", "hdice",
                    toluaI_get_monst_monster_race_hdice,
                    toluaI_set_monst_monster_race_hdice);
     tolua_tablevar(tolua_S, "monster_race", "hside",
                    toluaI_get_monst_monster_race_hside,
                    toluaI_set_monst_monster_race_hside);
     tolua_tablevar(tolua_S, "monster_race", "ac",
                    toluaI_get_monst_monster_race_ac,
                    toluaI_set_monst_monster_race_ac);
     tolua_tablevar(tolua_S, "monster_race", "sleep",
                    toluaI_get_monst_monster_race_sleep,
                    toluaI_set_monst_monster_race_sleep);
     tolua_tablevar(tolua_S, "monster_race", "aaf",
                    toluaI_get_monst_monster_race_aaf,
                    toluaI_set_monst_monster_race_aaf);
     tolua_tablevar(tolua_S, "monster_race", "speed",
                    toluaI_get_monst_monster_race_speed,
                    toluaI_set_monst_monster_race_speed);
     tolua_tablevar(tolua_S, "monster_race", "mexp",
                    toluaI_get_monst_monster_race_mexp,
                    toluaI_set_monst_monster_race_mexp);
     tolua_tablevar(tolua_S, "monster_race", "freq_innate",
                    toluaI_get_monst_monster_race_freq_innate,
                    toluaI_set_monst_monster_race_freq_innate);
     tolua_tablevar(tolua_S, "monster_race", "freq_spell",
                    toluaI_get_monst_monster_race_freq_spell,
                    toluaI_set_monst_monster_race_freq_spell);
     tolua_tablevar(tolua_S, "monster_race", "flags1",
                    toluaI_get_monst_monster_race_flags1,
                    toluaI_set_monst_monster_race_flags1);
     tolua_tablevar(tolua_S, "monster_race", "flags2",
                    toluaI_get_monst_monster_race_flags2,
                    toluaI_set_monst_monster_race_flags2);
     tolua_tablevar(tolua_S, "monster_race", "flags3",
                    toluaI_get_monst_monster_race_flags3,
                    toluaI_set_monst_monster_race_flags3);
     tolua_tablevar(tolua_S, "monster_race", "flags4",
                    toluaI_get_monst_monster_race_flags4,
                    toluaI_set_monst_monster_race_flags4);
     tolua_tablevar(tolua_S, "monster_race", "flags5",
                    toluaI_get_monst_monster_race_flags5,
                    toluaI_set_monst_monster_race_flags5);
     tolua_tablevar(tolua_S, "monster_race", "flags6",
                    toluaI_get_monst_monster_race_flags6,
                    toluaI_set_monst_monster_race_flags6);
     tolua_tablearray(tolua_S, "monster_race", "blow",
                      toluaI_get_monst_monster_race_blow,
                      toluaI_set_monst_monster_race_blow);
     tolua_tablevar(tolua_S, "monster_race", "level",
                    toluaI_get_monst_monster_race_level,
                    toluaI_set_monst_monster_race_level);
     tolua_tablevar(tolua_S, "monster_race", "rarity",
                    toluaI_get_monst_monster_race_rarity,
                    toluaI_set_monst_monster_race_rarity);
     tolua_tablevar(tolua_S, "monster_race", "d_attr",
                    toluaI_get_monst_monster_race_d_attr,
                    toluaI_set_monst_monster_race_d_attr);
     tolua_tablevar(tolua_S, "monster_race", "d_char",
                    toluaI_get_monst_monster_race_d_char,
                    toluaI_set_monst_monster_race_d_char);
     tolua_tablevar(tolua_S, "monster_race", "x_attr",
                    toluaI_get_monst_monster_race_x_attr,
                    toluaI_set_monst_monster_race_x_attr);
     tolua_tablevar(tolua_S, "monster_race", "x_char",
                    toluaI_get_monst_monster_race_x_char,
                    toluaI_set_monst_monster_race_x_char);
     tolua_tablevar(tolua_S, "monster_race", "max_num",
                    toluaI_get_monst_monster_race_max_num,
                    toluaI_set_monst_monster_race_max_num);
     tolua_tablevar(tolua_S, "monster_race", "cur_num",
                    toluaI_get_monst_monster_race_cur_num,
                    toluaI_set_monst_monster_race_cur_num);
     tolua_cclass(tolua_S, "monster_lore", "");
     tolua_tablevar(tolua_S, "monster_lore", "sights",
                    toluaI_get_monst_monster_lore_sights,
                    toluaI_set_monst_monster_lore_sights);
     tolua_tablevar(tolua_S, "monster_lore", "deaths",
                    toluaI_get_monst_monster_lore_deaths,
                    toluaI_set_monst_monster_lore_deaths);
     tolua_tablevar(tolua_S, "monster_lore", "pkills",
                    toluaI_get_monst_monster_lore_pkills,
                    toluaI_set_monst_monster_lore_pkills);
     tolua_tablevar(tolua_S, "monster_lore", "tkills",
                    toluaI_get_monst_monster_lore_tkills,
                    toluaI_set_monst_monster_lore_tkills);
     tolua_tablevar(tolua_S, "monster_lore", "wake",
                    toluaI_get_monst_monster_lore_wake,
                    toluaI_set_monst_monster_lore_wake);
     tolua_tablevar(tolua_S, "monster_lore", "ignore",
                    toluaI_get_monst_monster_lore_ignore,
                    toluaI_set_monst_monster_lore_ignore);
     tolua_tablevar(tolua_S, "monster_lore", "drop_gold",
                    toluaI_get_monst_monster_lore_drop_gold,
                    toluaI_set_monst_monster_lore_drop_gold);
     tolua_tablevar(tolua_S, "monster_lore", "drop_item",
                    toluaI_get_monst_monster_lore_drop_item,
                    toluaI_set_monst_monster_lore_drop_item);
     tolua_tablevar(tolua_S, "monster_lore", "cast_innate",
                    toluaI_get_monst_monster_lore_cast_innate,
                    toluaI_set_monst_monster_lore_cast_innate);
     tolua_tablevar(tolua_S, "monster_lore", "cast_spell",
                    toluaI_get_monst_monster_lore_cast_spell,
                    toluaI_set_monst_monster_lore_cast_spell);
     tolua_tablearray(tolua_S, "monster_lore", "blows",
                      toluaI_get_monst_monster_lore_blows,
                      toluaI_set_monst_monster_lore_blows);
     tolua_tablevar(tolua_S, "monster_lore", "flags1",
                    toluaI_get_monst_monster_lore_flags1,
                    toluaI_set_monst_monster_lore_flags1);
     tolua_tablevar(tolua_S, "monster_lore", "flags2",
                    toluaI_get_monst_monster_lore_flags2,
                    toluaI_set_monst_monster_lore_flags2);
     tolua_tablevar(tolua_S, "monster_lore", "flags3",
                    toluaI_get_monst_monster_lore_flags3,
                    toluaI_set_monst_monster_lore_flags3);
     tolua_tablevar(tolua_S, "monster_lore", "flags4",
                    toluaI_get_monst_monster_lore_flags4,
                    toluaI_set_monst_monster_lore_flags4);
     tolua_tablevar(tolua_S, "monster_lore", "flags5",
                    toluaI_get_monst_monster_lore_flags5,
                    toluaI_set_monst_monster_lore_flags5);
     tolua_tablevar(tolua_S, "monster_lore", "flags6",
                    toluaI_get_monst_monster_lore_flags6,
                    toluaI_set_monst_monster_lore_flags6);
     tolua_cclass(tolua_S, "monster_type", "");
     tolua_tablevar(tolua_S, "monster_type", "r_idx",
                    toluaI_get_monst_monster_type_r_idx,
                    toluaI_set_monst_monster_type_r_idx);
     tolua_tablevar(tolua_S, "monster_type", "fy",
                    toluaI_get_monst_monster_type_fy,
                    toluaI_set_monst_monster_type_fy);
     tolua_tablevar(tolua_S, "monster_type", "fx",
                    toluaI_get_monst_monster_type_fx,
                    toluaI_set_monst_monster_type_fx);
     tolua_tablevar(tolua_S, "monster_type", "hp",
                    toluaI_get_monst_monster_type_hp,
                    toluaI_set_monst_monster_type_hp);
     tolua_tablevar(tolua_S, "monster_type", "maxhp",
                    toluaI_get_monst_monster_type_maxhp,
                    toluaI_set_monst_monster_type_maxhp);
     tolua_tablevar(tolua_S, "monster_type", "csleep",
                    toluaI_get_monst_monster_type_csleep,
                    toluaI_set_monst_monster_type_csleep);
     tolua_tablevar(tolua_S, "monster_type", "mspeed",
                    toluaI_get_monst_monster_type_mspeed,
                    toluaI_set_monst_monster_type_mspeed);
     tolua_tablevar(tolua_S, "monster_type", "energy",
                    toluaI_get_monst_monster_type_energy,
                    toluaI_set_monst_monster_type_energy);
     tolua_tablevar(tolua_S, "monster_type", "stunned",
                    toluaI_get_monst_monster_type_stunned,
                    toluaI_set_monst_monster_type_stunned);
     tolua_tablevar(tolua_S, "monster_type", "confused",
                    toluaI_get_monst_monster_type_confused,
                    toluaI_set_monst_monster_type_confused);
     tolua_tablevar(tolua_S, "monster_type", "monfear",
                    toluaI_get_monst_monster_type_monfear,
                    toluaI_set_monst_monster_type_monfear);
     tolua_tablevar(tolua_S, "monster_type", "cdis",
                    toluaI_get_monst_monster_type_cdis,
                    toluaI_set_monst_monster_type_cdis);
     tolua_tablevar(tolua_S, "monster_type", "mflag",
                    toluaI_get_monst_monster_type_mflag,
                    toluaI_set_monst_monster_type_mflag);
     tolua_tablevar(tolua_S, "monster_type", "ml",
                    toluaI_get_monst_monster_type_ml,
                    toluaI_set_monst_monster_type_ml);
     tolua_tablevar(tolua_S, "monster_type", "hold_o_idx",
                    toluaI_get_monst_monster_type_hold_o_idx,
                    toluaI_set_monst_monster_type_hold_o_idx);
     tolua_globalvar(tolua_S, "mon_max", toluaI_get_monst_mon_max,
                     toluaI_set_monst_mon_max);
     tolua_globalvar(tolua_S, "mon_cnt", toluaI_get_monst_mon_cnt,
                     toluaI_set_monst_mon_cnt);
     tolua_function(tolua_S, NULL, "make_attack_normal",
                    toluaI_monst_make_attack_normal00);
     tolua_function(tolua_S, NULL, "make_attack_spell",
                    toluaI_monst_make_attack_spell00);
     tolua_function(tolua_S, NULL, "process_monsters",
                    toluaI_monst_process_monsters00);
     tolua_function(tolua_S, NULL, "roff_top", toluaI_monst_roff_top00);
     tolua_function(tolua_S, NULL, "screen_roff",
                    toluaI_monst_screen_roff00);
     tolua_function(tolua_S, NULL, "display_roff",
                    toluaI_monst_display_roff00);
     tolua_function(tolua_S, NULL, "delete_monster_idx",
                    toluaI_monst_delete_monster_idx00);
     tolua_function(tolua_S, NULL, "delete_monster",
                    toluaI_monst_delete_monster00);
     tolua_function(tolua_S, NULL, "compact_monsters",
                    toluaI_monst_compact_monsters00);
     tolua_function(tolua_S, NULL, "wipe_mon_list",
                    toluaI_monst_wipe_mon_list00);
     tolua_function(tolua_S, NULL, "mon_pop", toluaI_monst_mon_pop00);
     tolua_function(tolua_S, NULL, "get_mon_num_prep",
                    toluaI_monst_get_mon_num_prep00);
     tolua_function(tolua_S, NULL, "get_mon_num",
                    toluaI_monst_get_mon_num00);
     tolua_function(tolua_S, NULL, "monster_desc",
                    toluaI_monst_monster_desc00);
     tolua_function(tolua_S, NULL, "lore_do_probe",
                    toluaI_monst_lore_do_probe00);
     tolua_function(tolua_S, NULL, "lore_treasure",
                    toluaI_monst_lore_treasure00);
     tolua_function(tolua_S, NULL, "update_mon",
                    toluaI_monst_update_mon00);
     tolua_function(tolua_S, NULL, "update_monsters",
                    toluaI_monst_update_monsters00);
     tolua_function(tolua_S, NULL, "monster_carry",
                    toluaI_monst_monster_carry00);
     tolua_function(tolua_S, NULL, "monster_swap",
                    toluaI_monst_monster_swap00);
     tolua_function(tolua_S, NULL, "player_place",
                    toluaI_monst_player_place00);
     tolua_function(tolua_S, NULL, "monster_place",
                    toluaI_monst_monster_place00);
     tolua_function(tolua_S, NULL, "place_monster_aux",
                    toluaI_monst_place_monster_aux00);
     tolua_function(tolua_S, NULL, "place_monster",
                    toluaI_monst_place_monster00);
     tolua_function(tolua_S, NULL, "alloc_monster",
                    toluaI_monst_alloc_monster00);
     tolua_function(tolua_S, NULL, "summon_specific",
                    toluaI_monst_summon_specific00);
     tolua_function(tolua_S, NULL, "multiply_monster",
                    toluaI_monst_multiply_monster00);
     tolua_function(tolua_S, NULL, "message_pain",
                    toluaI_monst_message_pain00);
     tolua_function(tolua_S, NULL, "update_smart_learn",
                    toluaI_monst_update_smart_learn00);
     tolua_function(tolua_S, NULL, "monster_death",
                    toluaI_monst_monster_death00);
     tolua_function(tolua_S, NULL, "mon_take_hit",
                    toluaI_monst_mon_take_hit00);
     return 1;
}

/* Close function */
void
tolua_monst_close(lua_State * tolua_S)
{
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_HIT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_TOUCH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_PUNCH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_KICK");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_CLAW");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_BITE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_STING");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_XXX1");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_BUTT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_CRUSH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_ENGULF");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_XXX2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_CRAWL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_DROOL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_SPIT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_XXX3");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_GAZE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_WAIL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_SPORE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_XXX4");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_BEG");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_INSULT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_MOAN");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBM_XXX5");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_HURT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_POISON");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_UN_BONUS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_UN_POWER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_EAT_GOLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_EAT_ITEM");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_EAT_FOOD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_EAT_LITE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_ACID");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_ELEC");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_FIRE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_COLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_BLIND");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_CONFUSE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_TERRIFY");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_PARALYZE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_LOSE_STR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_LOSE_INT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_LOSE_WIS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_LOSE_DEX");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_LOSE_CON");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_LOSE_CHR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_LOSE_ALL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_SHATTER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_EXP_10");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_EXP_20");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_EXP_40");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_EXP_80");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RBE_HALLU");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_OPP_ACID");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_OPP_ELEC");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_OPP_FIRE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_OPP_COLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_OPP_POIS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_OPP_XXX1");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_OPP_XXX2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_OPP_XXX3");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_IMM_XXX5");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_IMM_XXX6");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_IMM_FREE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_IMM_MANA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_IMM_ACID");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_IMM_ELEC");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_IMM_FIRE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_IMM_COLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_ACID");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_ELEC");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_FIRE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_COLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_POIS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_FEAR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_LITE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_DARK");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_BLIND");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_CONFU");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_SOUND");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_SHARD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_NEXUS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_NETHR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_CHAOS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SM_RES_DISEN");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MFLAG_VIEW");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MFLAG_NICE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MFLAG_SHOW");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "MFLAG_MARK");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_UNIQUE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_QUESTOR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_MALE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_FEMALE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_CHAR_CLEAR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_CHAR_MULTI");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_ATTR_CLEAR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_ATTR_MULTI");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_FORCE_DEPTH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_FORCE_MAXHP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_FORCE_SLEEP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_FORCE_EXTRA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_FRIEND");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_FRIENDS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_ESCORT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_ESCORTS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_NEVER_BLOW");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_NEVER_MOVE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_RAND_25");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_RAND_50");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_ONLY_GOLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_ONLY_ITEM");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_DROP_60");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_DROP_90");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_DROP_1D2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_DROP_2D2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_DROP_3D2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_DROP_4D2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_DROP_GOOD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_DROP_GREAT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_DROP_USEFUL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF1_DROP_CHOSEN");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_STUPID");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_SMART");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_XXX1");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_XXX2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_INVISIBLE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_COLD_BLOOD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_EMPTY_MIND");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_WEIRD_MIND");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_MULTIPLY");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_REGENERATE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_XXX3");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_XXX4");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_POWERFUL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_XXX5");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_XXX7");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_XXX6");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_OPEN_DOOR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_BASH_DOOR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_PASS_WALL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_KILL_WALL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_MOVE_BODY");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_KILL_BODY");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_TAKE_ITEM");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_KILL_ITEM");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_BRAIN_1");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_BRAIN_2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_BRAIN_3");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_BRAIN_4");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_BRAIN_5");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_BRAIN_6");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_BRAIN_7");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF2_BRAIN_8");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_ORC");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_TROLL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_GIANT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_DRAGON");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_DEMON");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_UNDEAD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_EVIL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_ANIMAL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_XXX1");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_XXX2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_XXX3");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_XXX4");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_HURT_LITE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_HURT_ROCK");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_HURT_FIRE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_HURT_COLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_IM_ACID");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_IM_ELEC");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_IM_FIRE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_IM_COLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_IM_POIS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_XXX5");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_RES_NETH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_RES_WATE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_RES_PLAS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_RES_NEXU");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_RES_DISE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_XXX6");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_NO_FEAR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_NO_STUN");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_NO_CONF");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF3_NO_SLEEP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_SHRIEK");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_XXX2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_XXX3");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_XXX4");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_ARROW_1");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_ARROW_2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_ARROW_3");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_ARROW_4");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_ACID");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_ELEC");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_FIRE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_COLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_POIS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_NETH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_LITE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_DARK");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_CONF");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_SOUN");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_CHAO");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_DISE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_NEXU");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_TIME");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_INER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_GRAV");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_SHAR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_PLAS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_WALL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BR_MANA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_XXX5");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_XXX6");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_XXX7");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF4_BOULDER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BA_ACID");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BA_ELEC");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BA_FIRE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BA_COLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BA_POIS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BA_NETH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BA_WATE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BA_MANA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BA_DARK");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_DRAIN_MANA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_MIND_BLAST");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BRAIN_SMASH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_CAUSE_1");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_CAUSE_2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_CAUSE_3");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_CAUSE_4");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BO_ACID");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BO_ELEC");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BO_FIRE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BO_COLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BO_POIS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BO_NETH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BO_WATE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BO_MANA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BO_PLAS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BO_ICEE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_MISSILE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_SCARE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_BLIND");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_CONF");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_SLOW");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF5_HOLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_HASTE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_XXX1");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_HEAL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_XXX2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_BLINK");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_TPORT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_XXX3");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_XXX4");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_TELE_TO");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_TELE_AWAY");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_TELE_LEVEL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_XXX5");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_DARKNESS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_TRAPS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_FORGET");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_XXX6");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_KIN");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_HI_DEMON");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_MONSTER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_MONSTERS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_ANIMAL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_SPIDER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_HOUND");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_HYDRA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_ANGEL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_DEMON");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_UNDEAD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_DRAGON");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_HI_UNDEAD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_HI_DRAGON");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_WRAITH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "RF6_S_UNIQUE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "monster_blow");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "monster_race");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "monster_lore");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "monster_type");
     lua_getglobals(tolua_S);
     lua_pushstring(tolua_S, "mon_max");
     lua_pushnil(tolua_S);
     lua_rawset(tolua_S, -3);
     lua_pop(tolua_S, 1);
     lua_getglobals(tolua_S);
     lua_pushstring(tolua_S, "mon_cnt");
     lua_pushnil(tolua_S);
     lua_rawset(tolua_S, -3);
     lua_pop(tolua_S, 1);
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "make_attack_normal");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "make_attack_spell");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "process_monsters");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "roff_top");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "screen_roff");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "display_roff");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "delete_monster_idx");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "delete_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "compact_monsters");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "wipe_mon_list");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "mon_pop");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "get_mon_num_prep");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "get_mon_num");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "monster_desc");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "lore_do_probe");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "lore_treasure");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "update_mon");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "update_monsters");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "monster_carry");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "monster_swap");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "player_place");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "monster_place");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "place_monster_aux");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "place_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "alloc_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "summon_specific");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "multiply_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "message_pain");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "update_smart_learn");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "monster_death");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "mon_take_hit");
}
