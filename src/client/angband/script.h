...
/* $Id: script.h,v 1.3 2003/03/17 22:45:28 cipher Exp $ */
 ...
 * Event handlers
 */
extern bool     use_object(object_type * o_ptr,
                           bool * ident);
extern int      get_spell_index(const object_type * o_ptr,
                                int index);
extern cptr     get_spell_name(int tval,
                               int index);
extern cptr     get_spell_info(int tval,
                               int index);
extern bool     cast_spell(int tval,
                           int index);
extern int      get_store_choice(int store_num);
extern bool     store_will_buy(int store_num,
