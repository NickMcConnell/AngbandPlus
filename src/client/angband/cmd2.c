 ...
 */
static void
do_cmd_walk_or_jump(int jumping)
{
     int             y, x, dir;
 ...
 */
static int
breakage_chance(const object_type * o_ptr)
{
...
do_cmd_fire(void)
{
     ...
     for(i = 0; i < path_n; ++i)
     {
          ...
          if(cave_m_idx[y][x] > 0)
          {
               ...
               int             chance2 =
                   chance - distance(p_ptr->py, p_ptr->px, y, x);
               ...
               if(test_hit(chance2, r_ptr->ac, m_ptr->ml))
               {
                    ...
                    if(mon_take_hit
                       (cave_m_idx[y][x], tdam, &fear, note_dies))
                    {
                         /* Dead monster */
                    }
