...
/* $Id: use-obj.c,v 1.3 2003/03/17 22:45:29 cipher Exp $ */
          ...
          case SV_FOOD_PARALYSIS:
               {
                    ...
                    {
                         if(set_paralyzed
                            (p_ptr->paralyzed + rand_int(10) + 10))
                         {
                              *ident = TRUE;
                         }
                    }
...
static          bool
quaff_potion(object_type * o_ptr,
             bool * ident)
{
     /* Analyze the potion */
     switch (o_ptr->sval)
          ...
          case SV_SCROLL_SUMMON_UNDEAD:
               {
                    ...
                    {
                         if(summon_specific
                            (py, px, p_ptr->depth, SUMMON_UNDEAD))
                         {
                              *ident = TRUE;
                         }
                    }
 ...
 */
static          bool
activate_object(object_type * o_ptr,
                bool * ident)
{
     int             k, dir, i, chance;
     ...
     if(o_ptr->name1)
     {
          ...
          switch (a_ptr->activation)
          {
               case ACT_ILLUMINATION:
                    {
                         msg_format("The %s wells with clear light...",
                                    o_name);
               ...
               case ACT_CLAIRVOYANCE:
                    {
                         msg_format("The %s glows a deep green...",
                                    o_name);
                         wiz_lite();
                         (void) detect_traps();
                         (void) detect_doors();
               ...
               case ACT_PROT_EVIL:
                    {
                         msg_format("The %s lets out a shrill wail...",
                                    o_name);
                         k = 3 * p_ptr->lev;
               ...
               case ACT_DISP_EVIL:
                    {
                         msg_format
                             ("The %s floods the area with goodness...",
                              o_name);
               ...
               case ACT_FROST5:
                    {
                         msg_format("The %s glows bright white...",
                                    o_name);
                         if(!get_aim_dir(&dir))
                              return FALSE;
               ...
               case ACT_BIZZARE:
                    {
                         msg_format("The %s glows intensely black...",
                                    o_name);
                         if(!get_aim_dir(&dir))
                              return FALSE;
                         ring_of_power(dir);
               ...
               case ACT_STAR_BALL:
                    {
                         msg_format
                             ("Your %s is surrounded by lightning...",
                              o_name);
                         for(i = 0; i < 8; i++)
                              fire_ball(GF_ELEC, ddd[i], 150, 3);
                         break;
                    }

               case ACT_RAGE_BLESS_RESIST:
                    {
                         msg_format("Your %s glows many colours...",
                                    o_name);
                         (void) hp_player(30);
                         (void) set_afraid(0);
                         (void) set_shero(p_ptr->shero + randint(50) + 50);
                         (void) set_blessed(p_ptr->blessed + randint(50) +
                                            50);
               ...
               case ACT_HEAL2:
                    {
                         msg_format("Your %s glows a bright white...",
                                    o_name);
               ...
               case ACT_PHASE:
                    {
                         msg_format("Your %s twists space around you...",
                                    o_name);
                         teleport_player(10);
                         break;
                    }
               ...
               case ACT_DETECT:
                    {
                         msg_format("Your %s glows bright white...",
                                    o_name);
               ...
               case ACT_RECHARGE1:
                    {
                         msg_format("Your %s glows bright yellow...",
                                    o_name);
                         recharge(60);
                         break;
                    }
               ...
               case ACT_MISSILE:
                    {
                         msg_format("Your %s glows extremely brightly...",
                                    o_name);
                         if(!get_aim_dir(&dir))
                              return FALSE;
               ...
               case ACT_FIRE1:
                    {
                         msg_format("Your %s is covered in fire...",
                                    o_name);
                         if(!get_aim_dir(&dir))
                              return FALSE;
               ...
               case ACT_FROST1:
                    {
                         msg_format("Your %s is covered in frost...",
                                    o_name);
                         if(!get_aim_dir(&dir))
                              return FALSE;
               ...
               case ACT_LIGHTNING_BOLT:
                    {
                         msg_format("Your %s is covered in sparks...",
                                    o_name);
                         if(!get_aim_dir(&dir))
                              return FALSE;
               ...
               case ACT_ACID1:
                    {
                         msg_format("Your %s is covered in acid...",
                                    o_name);
                         if(!get_aim_dir(&dir))
                              return FALSE;
               ...
               case ACT_ARROW:
                    {
                         msg_format("Your %s grows magical spikes...",
                                    o_name);
                         if(!get_aim_dir(&dir))
                              return FALSE;
               ...
               case ACT_HASTE1:
                    {
                         msg_format("Your %s glows bright green...",
                                    o_name);
                         if(!p_ptr->fast)
                         {
               ...
               case ACT_STINKING_CLOUD:
                    {
                         msg_format("Your %s throbs deep green...",
                                    o_name);
                         if(!get_aim_dir(&dir))
                              return FALSE;
               ...
               case ACT_FROST4:
                    {
                         msg_format("Your %s glows a pale blue...",
                                    o_name);
                         if(!get_aim_dir(&dir))
                              return FALSE;
               ...
               case ACT_FROST3:
                    {
                         msg_format("Your %s glows a intense blue...",
                                    o_name);
                         if(!get_aim_dir(&dir))
                              return FALSE;
               ...
               case ACT_MASS_BANISHMENT:
                    {
                         msg_format
                             ("Your %s lets out a long, shrill note...",
                              o_name);
                         (void) mass_banishment();
                         break;
                    }
               ...
               case ACT_CURE_WOUNDS:
                    {
                         msg_format("Your %s radiates deep purple...",
                                    o_name);
               ...
               case ACT_CONFUSE:
                    {
                         msg_format
                             ("Your %s glows in scintillating colours...",
                              o_name);
                         if(!get_aim_dir(&dir))
                              return FALSE;
               ...
               case ACT_STARLIGHT:
                    {
                         msg_format
                             ("Your %s glows with the light of a thousand stars...",
                              o_name);
                         for(k = 0; k < 8; k++)
                              strong_lite_line(ddd[k]);
                         break;
                    }
          ...
          if(a_ptr->randtime)
               o_ptr->timeout =
                   a_ptr->time + (byte) randint(a_ptr->randtime);
          else
               ...
               case SV_RING_ACID:
                    {
                         ...
                         set_oppose_acid(p_ptr->oppose_acid + randint(20) +
                                         20);
               ...
               case SV_RING_FLAMES:
                    {
                         ...
                         set_oppose_fire(p_ptr->oppose_fire + randint(20) +
                                         20);
                         o_ptr->timeout = rand_int(50) + 50;
                         break;
                    }
               ...
               case SV_RING_ICE:
                    {
                         ...
                         set_oppose_cold(p_ptr->oppose_cold + randint(20) +
                                         20);
                         o_ptr->timeout = rand_int(50) + 50;
                         break;
                    }
               ...
               case SV_RING_LIGHTNING:
                    {
                         ...
                         set_oppose_elec(p_ptr->oppose_elec + randint(20) +
                                         20);
                         o_ptr->timeout = rand_int(50) + 50;
                         break;
                    }
...
describe_item_activation(const object_type * o_ptr)
{
     ...
     switch (o_ptr->sval)
     {
          case SV_DRAGON_BLUE:
               {
                    text_out
                        ("breathe lightning (100) every 450+d450 turns");
                    break;
               }
          case SV_DRAGON_WHITE:
               {
          ...
          case SV_DRAGON_GREEN:
               {
                    text_out
                        ("breathe poison gas (150) every 450+d450 turns");
                    break;
               }
          case SV_DRAGON_RED:
               {
          ...
          case SV_DRAGON_MULTIHUED:
               {
                    text_out
                        ("breathe multi-hued (250) every 225+d225 turns");
                    break;
               }
          case SV_DRAGON_BRONZE:
               {
                    text_out
                        ("breathe confusion (120) every 450+d450 turns");
                    break;
               }
          case SV_DRAGON_GOLD:
               {
          ...
          case SV_DRAGON_CHAOS:
               {
                    text_out
                        ("breathe chaos/disenchant (220) every 300+d300 turns");
                    break;
               }
          case SV_DRAGON_LAW:
               {
                    text_out
                        ("breathe sound/shards (230) every 300+d300 turns");
                    break;
               }
          case SV_DRAGON_BALANCE:
               {
          ...
          case SV_DRAGON_SHINING:
               {
                    text_out
                        ("breathe light/darkness (200) every 300+d300 turns");
                    break;
               }
          case SV_DRAGON_POWER:
               {
                    text_out
                        ("breathe the elements (300) every 300+d300 turns");
                    break;
               }
     }
}
