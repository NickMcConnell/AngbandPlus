...
/* $Id: xtra1.c,v 1.9 2003/04/08 16:37:26 cipher Exp $ */
...
calc_bonuses(void)
{
 ...
 /*** Analyze weapon ***/
     ...
     if(o_ptr->k_idx && !p_ptr->heavy_wield)
     {
          ...
          div =
              ((o_ptr->weight <
                cp_ptr->min_weight) ? cp_ptr->min_weight : o_ptr->weight);

          /* Get the strength vs weight */
          str_index =
              (adj_str_blow[p_ptr->stat_ind[A_STR]] *
          ...
          /* Maximal value */
          if(p_ptr->num_blow > cp_ptr->max_attacks)
