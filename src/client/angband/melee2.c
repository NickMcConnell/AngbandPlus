...
/* $Id: melee2.c,v 1.3 2003/03/17 22:45:27 cipher Exp $ */
 ...
 */
static          bool
int_outof(const monster_race * r_ptr,
          int prob)
{
           ...
           int x2)
{
     ...
     grid_n =
         project_path(grid_g, MAX_RANGE, y1, x1, y2, x2, PROJECT_STOP);
                    ...
                    u32b f6)
{
     ...
     if(smart_monsters && !(r_ptr->flags2 & (RF2_STUPID)))
     {
          ...
          has_annoy = ((f4 & (RF4_ANNOY_MASK)) ||
                       (f5 & (RF5_ANNOY_MASK)) || (f6 & (RF6_ANNOY_MASK)));
          has_haste = ((f4 & (RF4_HASTE_MASK)) ||
                       (f5 & (RF5_HASTE_MASK)) || (f6 & (RF6_HASTE_MASK)));
          has_heal = ((f4 & (RF4_HEAL_MASK)) ||
                      (f5 & (RF5_HEAL_MASK)) || (f6 & (RF6_HEAL_MASK)));
  ...
  /*** Try to pick an appropriate spell type ***/
          ...
          /* Player is close and we have attack spells, blink away */
                  ...
                  (distance(py, px, m_ptr->fy, m_ptr->fx) < 4) &&
...
make_attack_spell(int m_idx)
{
     ...
     if((r_ptr->flags2 & (RF2_SMART)) &&
        (m_ptr->hp < m_ptr->maxhp / 10) && (rand_int(100) < 50))
     {
          ...
          case RF4_OFFSET + 19:
               {
                    ...
                    if(blind)
                         ...
                         msg_format("%^s breathes disenchantment.",
                                    m_name);
          ...
          case RF4_OFFSET + 31:
               {
                    ...
                    if(blind)
                         msg_format
                             ("You hear something grunt with exertion.",
                              m_name);
                    else
                         msg_format("%^s hurls a boulder at you!", m_name);
                    bolt(m_idx, GF_ARROW,
                         damroll(1 + r_ptr->level / 7, 12));
                    break;
               }
          ...
          case RF5_OFFSET + 8:
               {
                    ...
                    if(blind)
                         ...
                         msg_format("%^s invokes a darkness storm.",
                                    m_name);
          ...
          case RF5_OFFSET + 9:
               {
                    ...
                    if(p_ptr->csp)
                    {
                         ...
                         /* Basic message */
                         msg_format("%^s draws psychic energy from you!",
                                    m_name);
          ...
          case RF5_OFFSET + 10:
               {
                    ...
                    {
                         msg_format("%^s gazes deep into your eyes.",
                                    m_name);
                    }
          ...
          case RF5_OFFSET + 11:
               {
                    ...
                    {
                         msg_format("%^s looks deep into your eyes.",
                                    m_name);
                    }
                    if(rand_int(100) < p_ptr->skill_sav)
                    {
          ...
          case RF5_OFFSET + 12:
               {
                    ...
                    if(blind)
                         ...
                         msg_format("%^s points at you and curses.",
                                    m_name);
                    if(rand_int(100) < p_ptr->skill_sav)
                    {
                         msg_print("You resist the effects!");
          ...
          case RF5_OFFSET + 27:
               {
                    ...
                    if(blind)
                         ...
                         msg_format("%^s casts a fearful illusion.",
                                    m_name);
                    if(p_ptr->resist_fear)
                    {
                    ...
                    {
                         (void) set_afraid(p_ptr->afraid + rand_int(4) +
                                           4);
                    }
          ...
          case RF5_OFFSET + 29:
               {
                    ...
                    if(blind)
                         ...
                         msg_format("%^s creates a mesmerising illusion.",
                                    m_name);
                    if(p_ptr->resist_confu)
                    {
          ...
          case RF5_OFFSET + 30:
               {
                    if(!direct)
                         break;
                    disturb(1, 0);
                    msg_format("%^s drains power from your muscles!",
                               m_name);
                    if(p_ptr->free_act)
                    {
                         msg_print("You are unaffected!");
          ...
          case RF5_OFFSET + 31:
               {
                    ...
                    if(blind)
                         ...
                         msg_format("%^s stares deep into your eyes!",
                                    m_name);
                    if(p_ptr->free_act)
                    {
                         msg_print("You are unaffected!");
          ...
          case RF6_OFFSET + 2:
               {
                    ...
                    if(m_ptr->hp >= m_ptr->maxhp)
                    {
                         ...
                         if(seen)
                         {
                              msg_format("%^s looks REALLY healthy!",
                                         m_name);
                         }
                         else
                         {
                              msg_format("%^s sounds REALLY healthy!",
                                         m_name);
                         }
                    }
          ...
          case RF6_OFFSET + 17:
               {
                    ...
                    if(blind)
                         ...
                         msg_format
                             ("%^s magically summons greater demons!",
                              m_name);
                    for(k = 0; k < 8; k++)
                    {
                         count +=
          ...
          case RF6_OFFSET + 20:
               {
                    ...
                    if(blind)
                         ...
                         msg_format("%^s magically summons animals.",
                                    m_name);
                    for(k = 0; k < 6; k++)
                    {
                         count +=
                             summon_specific(y, x, rlev, SUMMON_ANIMAL);
                    }
                    if(blind && count)
                    {
                         msg_print("You hear many things appear nearby.");
          ...
          case RF6_OFFSET + 26:
               {
                    ...
                    if(blind)
                         ...
                         msg_format
                             ("%^s magically summons an undead adversary!",
                              m_name);
                    for(k = 0; k < 1; k++)
                    {
                         count +=
          ...
          case RF6_OFFSET + 28:
               {
                    ...
                    if(blind)
                         ...
                         msg_format
                             ("%^s magically summons greater undead!",
                              m_name);
                    for(k = 0; k < 8; k++)
                    {
                         count +=
          ...
          int mm[5])
{
          ...
          (r_ptr->flags2 & (RF2_KILL_WALL))))
     {
          ...
          {
               /* Check grid */
               if(cave_info[py + ddy_ddd[i]][px + ddx_ddd[i]] &
                  (CAVE_ROOM))
               {
                    /* One more room grid */
                    room++;
 ...
 */
static int
compare_monsters(const monster_type * m_ptr,
                   ...
                   this_o_idx = next_o_idx)
               {
                       ...
                       (r_ptr->flags2 & (RF2_KILL_ITEM)))
                    {
                         ...
                         else if(r_ptr->flags2 & (RF2_TAKE_ITEM))
                         {
                              ...
                              {
                                   /* Dump a message */
                                   msg_format("%^s picks up %s.", m_name,
                                              o_name);
                              }
