...
/* function: poly_r_idx */
static int
toluaI_spell_poly_r_idx00(lua_State * tolua_S)
{
...
static int
toluaI_spell_teleport_away00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
...
static int
toluaI_spell_teleport_player00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_teleport_player_to00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
static int
toluaI_spell_teleport_player_level00(lua_State * tolua_S)
{
...
/* function: take_hit */
static int
toluaI_spell_take_hit00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
...
/* function: acid_dam */
static int
toluaI_spell_acid_dam00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TSTRING, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
/* function: elec_dam */
static int
toluaI_spell_elec_dam00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TSTRING, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
/* function: fire_dam */
static int
toluaI_spell_fire_dam00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TSTRING, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
/* function: cold_dam */
static int
toluaI_spell_cold_dam00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TSTRING, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
/* function: inc_stat */
static int
toluaI_spell_inc_stat00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
/* function: dec_stat */
static int
toluaI_spell_dec_stat00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
...
/* function: res_stat */
static int
toluaI_spell_res_stat00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_apply_disenchant00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
/* function: project */
static int
toluaI_spell_project00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
     ...
     else
     {
          ...
          {
               bool            toluaI_ret =
                   (bool) project(who, rad, y, x, dam, typ, flg);
               tolua_pushbool(tolua_S, (int) toluaI_ret);
          }
     }
     return 1;
...
static int
toluaI_spell_warding_glyph00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_identify_pack00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_remove_curse00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_remove_all_curse00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_self_knowledge00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_lose_all_info00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* function: set_recall */
static int
toluaI_spell_set_recall00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_detect_traps00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_detect_doors00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_detect_stairs00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_detect_treasure00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_detect_objects_gold00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_detect_objects_normal00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_detect_objects_magic00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_detect_monsters_normal00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_detect_monsters_invis00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_detect_monsters_evil00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* function: detect_all */
static int
toluaI_spell_detect_all00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_stair_creation00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* function: enchant */
static int
toluaI_spell_enchant00(lua_State * tolua_S)
{
...
static int
toluaI_spell_enchant_spell00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
     ...
     else
     {
          ...
          {
               bool            toluaI_ret =
                   (bool) enchant_spell(num_hit, num_dam, num_ac);
               tolua_pushbool(tolua_S, (int) toluaI_ret);
          }
     }
     return 1;
...
static int
toluaI_spell_ident_spell00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_identify_fully00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* function: recharge */
static int
toluaI_spell_recharge00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_speed_monsters00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_slow_monsters00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_sleep_monsters00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_banish_evil00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_turn_undead00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_dispel_undead00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_dispel_evil00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_dispel_monsters00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_aggravate_monsters00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
/* function: banishment */
static int
toluaI_spell_banishment00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_mass_banishment00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* function: probing */
static int
toluaI_spell_probing00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_destroy_area00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
...
/* function: earthquake */
static int
toluaI_spell_earthquake00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
...
/* function: lite_room */
static int
toluaI_spell_lite_room00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
static int
toluaI_spell_unlite_room00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
/* function: lite_area */
static int
toluaI_spell_lite_area00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
static int
toluaI_spell_unlite_area00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
/* function: fire_ball */
static int
toluaI_spell_fire_ball00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
     ...
     else
     {
          ...
          {
               bool            toluaI_ret =
                   (bool) fire_ball(typ, dir, dam, rad);
               tolua_pushbool(tolua_S, (int) toluaI_ret);
          }
     }
     return 1;
...
/* function: fire_swarm */
static int
toluaI_spell_fire_swarm00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
     ...
     else
     {
          ...
          {
               bool            toluaI_ret =
                   (bool) fire_swarm(num, typ, dir, dam, rad);
               tolua_pushbool(tolua_S, (int) toluaI_ret);
          }
     }
     return 1;
...
/* function: fire_bolt */
static int
toluaI_spell_fire_bolt00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
...
/* function: fire_beam */
static int
toluaI_spell_fire_beam00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
...
static int
toluaI_spell_fire_bolt_or_beam00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 3, LUA_TNUMBER, 0) ||
     ...
     else
     {
          ...
          {
               bool            toluaI_ret =
                   (bool) fire_bolt_or_beam(prob, typ, dir, dam);
               tolua_pushbool(tolua_S, (int) toluaI_ret);
          }
     }
     return 1;
...
static int
toluaI_spell_project_los00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
/* function: lite_line */
static int
toluaI_spell_lite_line00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_strong_lite_line00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
/* function: drain_life */
static int
toluaI_spell_drain_life00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
static int
toluaI_spell_wall_to_mud00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_destroy_door00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_disarm_trap00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_heal_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_speed_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_slow_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_sleep_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_confuse_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
static int
toluaI_spell_poly_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_clone_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_fear_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
...
static int
toluaI_spell_teleport_monster00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
static int
toluaI_spell_door_creation00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_trap_creation00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_destroy_doors_touch00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_sleep_monsters_touch00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_curse_armor00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_curse_weapon00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_brand_object00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, tolua_tag(tolua_S, "object_type"), 0) ||
        !tolua_istype(tolua_S, 2, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 3))
     ...
     else
     {
          object_type    *o_ptr =
              ((object_type *) tolua_getusertype(tolua_S, 1, 0));
          byte            brand_type =
              ((byte) tolua_getnumber(tolua_S, 2, 0));
          {
...
static int
toluaI_spell_brand_weapon00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* function: brand_ammo */
static int
toluaI_spell_brand_ammo00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_brand_bolts00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
static int
toluaI_spell_ring_of_power00(lua_State * tolua_S)
{
     if(!tolua_istype(tolua_S, 1, LUA_TNUMBER, 0) ||
        !tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
...
/* function: map_area */
static int
toluaI_spell_map_area00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* function: wiz_lite */
static int
toluaI_spell_wiz_lite00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* function: wiz_dark */
static int
toluaI_spell_wiz_dark00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 1))
          goto tolua_lerror;
     else
...
/* Open function */
int
tolua_spell_open(lua_State * tolua_S)
{
     tolua_open(tolua_S);
     ...
     tolua_function(tolua_S, NULL, "poly_r_idx",
                    toluaI_spell_poly_r_idx00);
     tolua_function(tolua_S, NULL, "teleport_away",
                    toluaI_spell_teleport_away00);
     tolua_function(tolua_S, NULL, "teleport_player",
                    toluaI_spell_teleport_player00);
     tolua_function(tolua_S, NULL, "teleport_player_to",
                    toluaI_spell_teleport_player_to00);
     tolua_function(tolua_S, NULL, "teleport_player_level",
                    toluaI_spell_teleport_player_level00);
     ...
     tolua_function(tolua_S, NULL, "apply_disenchant",
                    toluaI_spell_apply_disenchant00);
     tolua_function(tolua_S, NULL, "project", toluaI_spell_project00);
     tolua_function(tolua_S, NULL, "warding_glyph",
                    toluaI_spell_warding_glyph00);
     tolua_function(tolua_S, NULL, "identify_pack",
                    toluaI_spell_identify_pack00);
     tolua_function(tolua_S, NULL, "remove_curse",
                    toluaI_spell_remove_curse00);
     tolua_function(tolua_S, NULL, "remove_all_curse",
                    toluaI_spell_remove_all_curse00);
     tolua_function(tolua_S, NULL, "self_knowledge",
                    toluaI_spell_self_knowledge00);
     tolua_function(tolua_S, NULL, "lose_all_info",
                    toluaI_spell_lose_all_info00);
     tolua_function(tolua_S, NULL, "set_recall",
                    toluaI_spell_set_recall00);
     tolua_function(tolua_S, NULL, "detect_traps",
                    toluaI_spell_detect_traps00);
     tolua_function(tolua_S, NULL, "detect_doors",
                    toluaI_spell_detect_doors00);
     tolua_function(tolua_S, NULL, "detect_stairs",
                    toluaI_spell_detect_stairs00);
     tolua_function(tolua_S, NULL, "detect_treasure",
                    toluaI_spell_detect_treasure00);
     tolua_function(tolua_S, NULL, "detect_objects_gold",
                    toluaI_spell_detect_objects_gold00);
     tolua_function(tolua_S, NULL, "detect_objects_normal",
                    toluaI_spell_detect_objects_normal00);
     tolua_function(tolua_S, NULL, "detect_objects_magic",
                    toluaI_spell_detect_objects_magic00);
     tolua_function(tolua_S, NULL, "detect_monsters_normal",
                    toluaI_spell_detect_monsters_normal00);
     tolua_function(tolua_S, NULL, "detect_monsters_invis",
                    toluaI_spell_detect_monsters_invis00);
     tolua_function(tolua_S, NULL, "detect_monsters_evil",
                    toluaI_spell_detect_monsters_evil00);
     tolua_function(tolua_S, NULL, "detect_all",
                    toluaI_spell_detect_all00);
     tolua_function(tolua_S, NULL, "stair_creation",
                    toluaI_spell_stair_creation00);
     tolua_function(tolua_S, NULL, "enchant", toluaI_spell_enchant00);
     tolua_function(tolua_S, NULL, "enchant_spell",
                    toluaI_spell_enchant_spell00);
     tolua_function(tolua_S, NULL, "ident_spell",
                    toluaI_spell_ident_spell00);
     tolua_function(tolua_S, NULL, "identify_fully",
                    toluaI_spell_identify_fully00);
     tolua_function(tolua_S, NULL, "recharge", toluaI_spell_recharge00);
     tolua_function(tolua_S, NULL, "speed_monsters",
                    toluaI_spell_speed_monsters00);
     tolua_function(tolua_S, NULL, "slow_monsters",
                    toluaI_spell_slow_monsters00);
     tolua_function(tolua_S, NULL, "sleep_monsters",
                    toluaI_spell_sleep_monsters00);
     tolua_function(tolua_S, NULL, "banish_evil",
                    toluaI_spell_banish_evil00);
     tolua_function(tolua_S, NULL, "turn_undead",
                    toluaI_spell_turn_undead00);
     tolua_function(tolua_S, NULL, "dispel_undead",
                    toluaI_spell_dispel_undead00);
     tolua_function(tolua_S, NULL, "dispel_evil",
                    toluaI_spell_dispel_evil00);
     tolua_function(tolua_S, NULL, "dispel_monsters",
                    toluaI_spell_dispel_monsters00);
     tolua_function(tolua_S, NULL, "aggravate_monsters",
                    toluaI_spell_aggravate_monsters00);
     tolua_function(tolua_S, NULL, "banishment",
                    toluaI_spell_banishment00);
     tolua_function(tolua_S, NULL, "mass_banishment",
                    toluaI_spell_mass_banishment00);
     tolua_function(tolua_S, NULL, "probing", toluaI_spell_probing00);
     tolua_function(tolua_S, NULL, "destroy_area",
                    toluaI_spell_destroy_area00);
     tolua_function(tolua_S, NULL, "earthquake",
                    toluaI_spell_earthquake00);
     tolua_function(tolua_S, NULL, "lite_room", toluaI_spell_lite_room00);
     tolua_function(tolua_S, NULL, "unlite_room",
                    toluaI_spell_unlite_room00);
     tolua_function(tolua_S, NULL, "lite_area", toluaI_spell_lite_area00);
     tolua_function(tolua_S, NULL, "unlite_area",
                    toluaI_spell_unlite_area00);
     tolua_function(tolua_S, NULL, "fire_ball", toluaI_spell_fire_ball00);
     tolua_function(tolua_S, NULL, "fire_swarm",
                    toluaI_spell_fire_swarm00);
     ...
     tolua_function(tolua_S, NULL, "fire_bolt_or_beam",
                    toluaI_spell_fire_bolt_or_beam00);
     tolua_function(tolua_S, NULL, "project_los",
                    toluaI_spell_project_los00);
     tolua_function(tolua_S, NULL, "lite_line", toluaI_spell_lite_line00);
     tolua_function(tolua_S, NULL, "strong_lite_line",
                    toluaI_spell_strong_lite_line00);
     tolua_function(tolua_S, NULL, "drain_life",
                    toluaI_spell_drain_life00);
     tolua_function(tolua_S, NULL, "wall_to_mud",
                    toluaI_spell_wall_to_mud00);
     tolua_function(tolua_S, NULL, "destroy_door",
                    toluaI_spell_destroy_door00);
     tolua_function(tolua_S, NULL, "disarm_trap",
                    toluaI_spell_disarm_trap00);
     tolua_function(tolua_S, NULL, "heal_monster",
                    toluaI_spell_heal_monster00);
     tolua_function(tolua_S, NULL, "speed_monster",
                    toluaI_spell_speed_monster00);
     tolua_function(tolua_S, NULL, "slow_monster",
                    toluaI_spell_slow_monster00);
     tolua_function(tolua_S, NULL, "sleep_monster",
                    toluaI_spell_sleep_monster00);
     tolua_function(tolua_S, NULL, "confuse_monster",
                    toluaI_spell_confuse_monster00);
     tolua_function(tolua_S, NULL, "poly_monster",
                    toluaI_spell_poly_monster00);
     tolua_function(tolua_S, NULL, "clone_monster",
                    toluaI_spell_clone_monster00);
     tolua_function(tolua_S, NULL, "fear_monster",
                    toluaI_spell_fear_monster00);
     tolua_function(tolua_S, NULL, "teleport_monster",
                    toluaI_spell_teleport_monster00);
     tolua_function(tolua_S, NULL, "door_creation",
                    toluaI_spell_door_creation00);
     tolua_function(tolua_S, NULL, "trap_creation",
                    toluaI_spell_trap_creation00);
     tolua_function(tolua_S, NULL, "destroy_doors_touch",
                    toluaI_spell_destroy_doors_touch00);
     tolua_function(tolua_S, NULL, "sleep_monsters_touch",
                    toluaI_spell_sleep_monsters_touch00);
     tolua_function(tolua_S, NULL, "curse_armor",
                    toluaI_spell_curse_armor00);
     tolua_function(tolua_S, NULL, "curse_weapon",
                    toluaI_spell_curse_weapon00);
     tolua_function(tolua_S, NULL, "brand_object",
                    toluaI_spell_brand_object00);
     tolua_function(tolua_S, NULL, "brand_weapon",
                    toluaI_spell_brand_weapon00);
     tolua_function(tolua_S, NULL, "brand_ammo",
                    toluaI_spell_brand_ammo00);
     tolua_function(tolua_S, NULL, "brand_bolts",
                    toluaI_spell_brand_bolts00);
     tolua_function(tolua_S, NULL, "ring_of_power",
                    toluaI_spell_ring_of_power00);
...
/* Close function */
void
tolua_spell_close(lua_State * tolua_S)
{
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_ANIMAL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_SPIDER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_HOUND");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_HYDRA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_ANGEL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_DEMON");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_UNDEAD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_DRAGON");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_HI_DEMON");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_HI_UNDEAD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_HI_DRAGON");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_WRAITH");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_UNIQUE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "SUMMON_KIN");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_XXX1");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_ARROW");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_MISSILE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_MANA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_HOLY_ORB");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_LITE_WEAK");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_DARK_WEAK");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_WATER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_PLASMA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_METEOR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_ICE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_GRAVITY");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_INERTIA");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_FORCE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_TIME");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_ACID");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_ELEC");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_FIRE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_COLD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_POIS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_XXX2");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_LITE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_DARK");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_XXX3");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_CONFUSION");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_SOUND");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_SHARD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_NEXUS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_NETHER");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_CHAOS");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_DISENCHANT");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_XXX4");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_KILL_WALL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_KILL_DOOR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_KILL_TRAP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_MAKE_WALL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_MAKE_DOOR");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_MAKE_TRAP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_XXX5");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_XXX6");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_AWAY_UNDEAD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_AWAY_EVIL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_AWAY_ALL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_TURN_UNDEAD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_TURN_EVIL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_TURN_ALL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_DISP_UNDEAD");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_DISP_EVIL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_DISP_ALL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_XXX7");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_OLD_CLONE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_OLD_POLY");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_OLD_HEAL");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_OLD_SPEED");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_OLD_SLOW");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_OLD_CONF");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_OLD_SLEEP");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_OLD_DRAIN");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "GF_XXX8");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "poly_r_idx");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "teleport_away");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "teleport_player");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "teleport_player_to");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "teleport_player_level");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "take_hit");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "acid_dam");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "elec_dam");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "fire_dam");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "cold_dam");
     lua_pushnil(tolua_S);
     ...
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "apply_disenchant");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "project");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "warding_glyph");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "identify_pack");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "remove_curse");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "remove_all_curse");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "self_knowledge");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "lose_all_info");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "set_recall");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "detect_traps");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "detect_doors");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "detect_stairs");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "detect_treasure");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "detect_objects_gold");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "detect_objects_normal");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "detect_objects_magic");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "detect_monsters_normal");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "detect_monsters_invis");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "detect_monsters_evil");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "detect_all");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "stair_creation");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "enchant");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "enchant_spell");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "ident_spell");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "identify_fully");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "recharge");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "speed_monsters");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "slow_monsters");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "sleep_monsters");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "banish_evil");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "turn_undead");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "dispel_undead");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "dispel_evil");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "dispel_monsters");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "aggravate_monsters");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "banishment");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "mass_banishment");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "probing");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "destroy_area");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "earthquake");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "lite_room");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "unlite_room");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "lite_area");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "unlite_area");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "fire_ball");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "fire_swarm");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "fire_bolt");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "fire_beam");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "fire_bolt_or_beam");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "project_los");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "lite_line");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "strong_lite_line");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "drain_life");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "wall_to_mud");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "destroy_door");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "disarm_trap");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "heal_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "speed_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "slow_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "sleep_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "confuse_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "poly_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "clone_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "fear_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "teleport_monster");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "door_creation");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "trap_creation");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "destroy_doors_touch");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "sleep_monsters_touch");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "curse_armor");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "curse_weapon");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "brand_object");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "brand_weapon");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "brand_ammo");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "brand_bolts");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "ring_of_power");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "map_area");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "wiz_lite");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "wiz_dark");
}
