...
/* $Id: generate.c,v 1.4 2003/03/17 22:45:24 cipher Exp $ */
          ...
          case 4:
               {
                    ...
                    if(rand_int(3) == 0)
                    {
                         ...
                         if(rand_int(3) == 0)
                         {
                              generate_open(y1b - 1, x1a - 1, y2b + 1,
                                            x2a + 1, FEAT_SECRET);
                         }
                    }
          ...
          case 1:
               {
                    ...
                    generate_hole(y1 - 1, x1 - 1, y2 + 1, x2 + 1,
                                  FEAT_SECRET);
          ...
          case 2:
               {
                    ...
                    generate_draw(y0 - 1, x0 - 1, y0 + 1, x0 + 1,
                                  FEAT_WALL_INNER);
          ...
          case 3:
               {
                    ...
                    /* Inner pillar */
                    generate_fill(y0 - 1, x0 - 1, y0 + 1, x0 + 1,
                                  FEAT_WALL_INNER);
                    ...
                    if(rand_int(3) == 0)
                    {
                         ...
                         place_secret_door(y0 - 3 + (randint(2) * 2),
                                           x0 - 3);
                         place_secret_door(y0 - 3 + (randint(2) * 2),
                                           x0 + 3);
            ...
            int x0)
{
     ...
     /* Message */
     if(cheat_room)
          msg_format("Lesser vault (%s)", v_name + v_ptr->name);
            ...
            int x0)
{
     ...
     /* Message */
     if(cheat_room)
          msg_format("Greater vault (%s)", v_name + v_ptr->name);
