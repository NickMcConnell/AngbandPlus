 ...
 */
static          errr
grab_one_kind_flag(object_kind * k_ptr,
                   cptr what)
{
 ...
 */
static          errr
grab_one_artifact_flag(artifact_type * a_ptr,
                       cptr what)
{
 ...
 */
static          errr
grab_one_activation(artifact_type * a_ptr,
                    cptr what)
{
     int             i;
 ...
 */
static          bool
grab_one_ego_item_flag(ego_item_type * e_ptr,
                       cptr what)
{
 ...
 */
static          errr
grab_one_basic_flag(monster_race * r_ptr,
                    cptr what)
{
 ...
 */
static          errr
grab_one_spell_flag(monster_race * r_ptr,
                    cptr what)
{
 ...
 */
static          errr
grab_one_racial_flag(player_race * pr_ptr,
                     cptr what)
{
 ...
 */
static          errr
grab_one_class_flag(player_class * pc_ptr,
                    cptr what)
{
             ...
             header * head)
{
     ...
     {
          int             spell_book, spell_stat, spell_first,
              spell_weight;
