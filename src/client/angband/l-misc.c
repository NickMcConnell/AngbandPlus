...
/* get function: ddd */
static int
toluaI_get_misc_ddd(lua_State * tolua_S)
{
     int             toluaI_index;
...
/* get function: ddx */
static int
toluaI_get_misc_ddx(lua_State * tolua_S)
{
     int             toluaI_index;
...
/* get function: ddy */
static int
toluaI_get_misc_ddy(lua_State * tolua_S)
{
     int             toluaI_index;
...
static int
toluaI_get_misc_ddx_ddd(lua_State * tolua_S)
{
     int             toluaI_index;
...
static int
toluaI_get_misc_ddy_ddd(lua_State * tolua_S)
{
     int             toluaI_index;
...
static int
toluaI_misc_script_do_file00(lua_State * tolua_S)
{
     ...
     {
          cptr            filename =
              ((cptr) tolua_getstring(tolua_S, 1, 0));
          {
               bool            toluaI_ret =
                   (bool) script_do_file(filename);
...
/* Open function */
int
tolua_misc_open(lua_State * tolua_S)
{
     tolua_open(tolua_S);
     ...
     tolua_function(tolua_S, NULL, "script_do_file",
                    toluaI_misc_script_do_file00);
     return 1;
}

/* Close function */
void
tolua_misc_close(lua_State * tolua_S)
{
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "TRUE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "FALSE");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "ddd");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "ddx");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "ddy");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "ddx_ddd");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "ddy_ddd");
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "script_do_file");
}
