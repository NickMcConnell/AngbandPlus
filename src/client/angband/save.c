...
/* $Id: save.c,v 1.3 2003/03/17 22:45:28 cipher Exp $ */
 ...
 */
static void
wr_item(const object_type * o_ptr)
{
     wr_s16b(o_ptr->k_idx);
 ...
 */
static void
wr_monster(const monster_type * m_ptr)
{
     wr_s16b(m_ptr->r_idx);
     wr_byte(m_ptr->fy);
     wr_byte(m_ptr->fx);
 ...
 */
static void
wr_store(const store_type * st_ptr)
{
     int             j;
