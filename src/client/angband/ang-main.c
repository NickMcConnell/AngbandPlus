...
/* $Id: main.c,v 1.5 2003/03/17 22:45:27 cipher Exp $ */
...
#if !defined(MACINTOSH) && !defined(WINDOWS) && !defined(RISCOS) && !defined(MACOSX)
               ...
               case 'U':
                    {
                         ...
                         my_strcpy(op_ptr->full_name, arg,
