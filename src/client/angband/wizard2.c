...
do_cmd_wiz_change_aux(void)
{
     ...
     /* Query */
     if(!get_string("Max Exp: ", tmp_val, 10))
          return;
 ...
 */
static void
wiz_display_item(const object_type * o_ptr)
{
     int             j = 0;
     ...
     prt(format("name1 = %-4d  name2 = %-4d  cost = %ld",
                o_ptr->name1, o_ptr->name2, (long) object_value(o_ptr)), 7,
         j);
