...
/*
** $Id: lstate.c,v 1.1 2003/03/19 21:53:07 cipher Exp $
** Global State
...
{
     LUA_ASSERT(L != lua_state ||
                lua_gettop(L) == 0, "garbage in C stack");
     ...
     LUA_ASSERT(L->nblocks == sizeof(lua_State),
                "wrong count for nblocks");
     luaM_free(L, L);
