...
/*
** $Id: lstring.c,v 1.1 2003/03/19 21:53:07 cipher Exp $
            ...
            int newsize)
{
     ...
     for(i = 0; i < tb->size; i++)
     {
          ...
          {                     /* for each node in the list */
               ...
               unsigned long   h =
                   (tb == &L->strt) ? p->u.s.hash : IntPoint(p->u.d.value);
