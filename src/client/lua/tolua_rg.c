...
** TeCGraf/PUC-Rio
** Jul 1998
** $Id: tolua_rg.c,v 1.1 2003/03/19 21:53:07 cipher Exp $
*/
...
static int
toluaI_const_global_array(lua_State * L)
{
...
static int
toluaI_const_array(lua_State * L)
{
...
void
toluaI_setregistry(lua_State * L,
                   const char *field)
{
     lua_getregistry(L);
     lua_insert(L, -2);
...
void
toluaI_getregistry(lua_State * L,
                   const char *field)
{
     lua_getregistry(L);
     lua_pushstring(L, field);
