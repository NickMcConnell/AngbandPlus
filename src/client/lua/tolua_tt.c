...
** TeCGraf/PUC-Rio
** Jul 1998
** $Id: tolua_tt.c,v 1.2 2003/03/17 22:45:31 cipher Exp $
*/
...
const char     *
toluaI_tt_getobjtype(lua_State * L,
                     int lo)
{
       ...
       int tag)
{
     ...
     if(tag == otag)            /* check simplest case */
          return 1;
             ...
             tag != LUA_TNUMBER &&
             tag != LUA_TTABLE && tag != LUA_TFUNCTION)
          return 1;
...
void
toluaI_tt_init(lua_State * L)
{
     lua_newtable(L);
     toluaI_setregistry(L, "tolua_tbl_itype");
     lua_newtable(L);
     toluaI_setregistry(L, "tolua_tbl_itag");
     lua_newtable(L);
     toluaI_setregistry(L, "tolua_tbl_const");
     lua_newtable(L);
     toluaI_setregistry(L, "tolua_tbl_hierarchy");

     /* set and register basic Lua type tag */
#if 0
     lua_pushnumber(L, LUA_TNIL);
     toluaI_setregistry(L, "tolua_tag_nil");
     lua_pushnumber(L, LUA_TNUMBER);
     toluaI_setregistry(L, "tolua_tag_number");
     lua_pushnumber(L, LUA_TSTRING);
     toluaI_setregistry(L, "tolua_tag_string");
     lua_pushnumber(L, LUA_TUSERDATA);
     toluaI_setregistry(L, "tolua_tag_userdata");
     lua_pushnumber(L, LUA_TTABLE);
     toluaI_setregistry(L, "tolua_tag_table");
     lua_pushnumber(L, LUA_TFUNCTION);
     toluaI_setregistry(L, "tolua_tag_function");

     toluaI_tt_register(L, toluaI_tt_gettag(L, "tolua_tag_nil"), "nil");
     toluaI_tt_register(L, toluaI_tt_gettag(L, "tolua_tag_number"),
                        "number");
     toluaI_tt_register(L, toluaI_tt_gettag(L, "tolua_tag_string"),
                        "string");
     toluaI_tt_register(L, toluaI_tt_gettag(L, "tolua_tag_userdata"),
                        "userdata");
     toluaI_tt_register(L, toluaI_tt_gettag(L, "tolua_tag_table"),
                        "table");
     toluaI_tt_register(L, toluaI_tt_gettag(L, "tolua_tag_function"),
                        "function");
#else
...
void
toluaI_tt_register(lua_State * L,
                   int tag,
                   const char *type)
{
     toluaI_getregistry(L, "tolua_tbl_itype");
...
void
toluaI_tt_sethierarchy(lua_State * L,
                       int tag,
                       int btag)
{
     toluaI_getregistry(L, "tolua_tbl_hierarchy");
...
char           *
toluaI_tt_concat(const char *s1,
                 const char *s2)
{
...
int
toluaI_tt_isusertype(lua_State * L,
                     int lo)
{
                  ...
                  int def)
{
     ...
     for(i = 0; i < dim; ++i)
     {
          ...
          if(!istype(L, tf, tag) && (!def || !lua_isnil(L, tf)))
          {
               ...
               sprintf(t2, "array of %s (dimension=%d)", gettype(L, tag),
                       dim);
