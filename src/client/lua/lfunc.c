...
/*
** $Id: lfunc.c,v 1.1 2003/03/19 21:53:06 cipher Exp $
...
*/
const char     *
luaF_getlocalname(const Proto * f,
                  int local_number,
                  int pc)
{
     int             i;
