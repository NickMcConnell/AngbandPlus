...
void initkind()
{
	...
	add_constant(d, "TR1_CHR", TR1_CHR);
        add_constant(d, "TR1_MANA", TR1_MANA);
        add_constant(d, "TR1_SPELL", TR1_SPELL);
	...
	add_constant(d, "TR1_KILL_DRAGON", TR1_KILL_DRAGON);
        add_constant(d, "TR1_VORPAL", TR1_VORPAL);
        add_constant(d, "TR1_IMPACT", TR1_IMPACT);
        add_constant(d, "TR1_BRAND_POIS", TR1_BRAND_POIS);
	...
	add_constant(d, "TR2_SUST_CHR", TR2_SUST_CHR);
        add_constant(d, "TR2_INVIS", TR2_INVIS);
        add_constant(d, "TR2_LIFE", TR2_LIFE);
        add_constant(d, "TR2_SENS_FIRE", TR2_SENS_FIRE);
        add_constant(d, "TR2_REFLECT", TR2_REFLECT);
        add_constant(d, "TR2_FREE_ACT", TR2_FREE_ACT);
        add_constant(d, "TR2_HOLD_LIFE", TR2_HOLD_LIFE);
	...
	add_constant(d, "TR2_RES_BLIND", TR2_RES_BLIND);
        add_constant(d, "TR2_RES_CONF", TR2_RES_CONF);
	add_constant(d, "TR2_RES_SOUND", TR2_RES_SOUND);
        add_constant(d, "TR2_RES_SHARDS", TR2_RES_SHARDS);
	add_constant(d, "TR2_RES_NEXUS", TR2_RES_NEXUS);
        add_constant(d, "TR2_RES_NETHER", TR2_RES_NETHER);
	...
	add_constant(d, "TR3_SEE_INVIS", TR3_SEE_INVIS);
        add_constant(d, "TR3_DECAY", TR3_DECAY);
        add_constant(d, "TR3_QUESTITEM", TR3_QUESTITEM);
        add_constant(d, "TR3_WRAITH", TR3_WRAITH);
	...
	add_constant(d, "TR3_SHOW_MODS", TR3_SHOW_MODS);
        add_constant(d, "TR3_CURSED", TR3_CURSED);
