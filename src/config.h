 ...
 * Warning: Conglomo chooses to use a different place from Vanilla 2.9.2
 * and its friends.
 */
#ifdef SET_UID
#define PRIVATE_USER_PATH "~/.conglomoband"
#endif /* SET_UID */
 ...
 */
#define MAINTAINER      "sleaker@qwest.net"
