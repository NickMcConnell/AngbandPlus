...
EFFECT(GAIN_EXP,					false,	NULL,		1,		EFINFO_CONST,	"grants up to %d experience points")
EFFECT(DRAIN_LIGHT,					false,	NULL,		0,		EFINFO_NONE,	"drains your light source")
EFFECT(REMOVE_FAULT,				false,	NULL,		0,		EFINFO_NONE,	"attempts repair of a single fault on an object")
...
EFFECT(IDENTIFY,					false,	NULL,		0,		EFINFO_NONE,	"identifies a single unknown icon on a selected item")
...
EFFECT(RECHARGE,					false,	"power",	0,		EFINFO_NONE,	"tries to recharge a wand or device, destroying the wand or device on failure")
...
EFFECT(ACQUIRE,						false,	NULL,		0,		EFINFO_NONE,	"teleports in good items from off-level")
EFFECT(LOCAL_ACQUIRE,				false,	NULL,		0,		EFINFO_NONE,	"teleports the level's best item to you")
...
EFFECT(BLAST_ARMOR,					false,	NULL,		0,		EFINFO_NONE,	"blasts your worn armor")
EFFECT(BLAST_WEAPON,				false,	NULL,		0,		EFINFO_NONE,	"blasts your wielded melee weapon")
...
EFFECT(CREATE_ARROWS,				false,	NULL,		0,		EFINFO_NONE,	"uses a device to create a stack of arrows")
...
EFFECT(PRISMATIC,					false, NULL,		0, 		EFINFO_NONE,	"switches into an alternate mode")
