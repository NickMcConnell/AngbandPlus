	...
	for (i = 1; i < m_max; i++)
	{
		...
		switch (thrown_spell)
		{
			...
			case 160 + 16:
			{
				...
				{
					count +=
						summon_specific(m_idx, mx, my, rlev, SUMMON_KIN, TRUE,
										friendly, pet);
				}
			...
			case 160 + 18:
			{
				...
				count +=
					summon_specific(m_idx, mx, my, rlev, type, FALSE, friendly,
									pet);
			...
			case 160 + 19:
			{
				...
				{
					count +=
						summon_specific(m_idx, mx, my, rlev, type, TRUE, friendly,
										pet);
				}
			...
			case 160 + 20:
			{
				...
				{
					count +=
						summon_specific(m_idx, mx, my, rlev, SUMMON_ANT, TRUE,
										friendly, pet);
				}
