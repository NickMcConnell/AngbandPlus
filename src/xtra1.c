...
static void calc_bonuses(void)
{
	...
	p_ptr->dis_ac = p_ptr->ac = smod(S_DODGING) + p_ptr->ac_mod;

	/* Clear the Displayed/Real Bonuses */
	p_ptr->dis_to_h = p_ptr->to_h = p_ptr->to_h_mod;
	p_ptr->dis_to_d = p_ptr->to_d = p_ptr->to_d_mod;
...
/* Get level */
	...
	p_ptr->pspeed = 110 + p_ptr->pspeed_mod;
