...
int tolua_monst_open (lua_State* tolua_S)
{
 ...
 TOLUA_DEF(RF3_ARROW_1);
 TOLUA_DEF(RF3_ARROW_2);
 TOLUA_DEF(RF3_ARROW_3);
 TOLUA_DEF(RF3_ARROW_4);
...
void tolua_monst_close (lua_State* tolua_S)
{
 ...
 TOLUA_UNDEF(RF3_ARROW_1);
 TOLUA_UNDEF(RF3_ARROW_2);
 TOLUA_UNDEF(RF3_ARROW_3);
 TOLUA_UNDEF(RF3_ARROW_4);
