...
/*        bool sensible_acid;*/   /* Acid does more damage on the player */
	...
	s16b skill_defense_base; /* Improve effectiveness of armors! */
	s16b skill_fighting_base; /* Improve melee damages with ALL weapons! */
	s16b skill_elemental_base; /* Elemental magic! */
	s16b skill_alteration_base; /* Alteration magic! */
	s16b skill_healing_base; /* Healing magic! */
	s16b skill_conjuration_base; /* Conjuration magic! */
	s16b skill_divination_base; /* Divination magic! */
	s16b skill_bow_base; /* How good you are with bows. */
	s16b skill_crossbow_base; /* How good you are with crossbows. */
	s16b skill_sling_base; /* How good you are with slings. */
	s16b skill_dualwield_base; /* The art of dual wielding! */
	...
	s16b skill_defense_bonus; /* Improve effectiveness of armors! */
	s16b skill_fighting_bonus; /* Improve melee damages with ALL weapons! */
	s16b skill_elemental_bonus; /* Elemental magic! */
	s16b skill_alteration_bonus; /* Alteration magic! */
	s16b skill_healing_bonus; /* Healing magic! */
	s16b skill_conjuration_bonus; /* Conjuration magic! */
	s16b skill_divination_bonus; /* Divination magic! */
	s16b skill_bow_bonus; /* How good you are with bows. */
	s16b skill_crossbow_bonus; /* How good you are with crossbows. */
	s16b skill_sling_bonus; /* How good you are with slings. */
	s16b skill_dualwield_bonus; /* The art of dual wielding! */
	...
	s16b skill_defense; /* Improve effectiveness of armors! */
	s16b skill_fighting; /* Improve melee damages with ALL weapons! */
	s16b skill_elemental; /* Elemental magic! */
	s16b skill_alteration; /* Alteration magic! */
	s16b skill_healing; /* Healing magic! */
	s16b skill_conjuration; /* Conjuration magic! */
	s16b skill_divination; /* Divination magic! */
	s16b skill_bow; /* How good you are with bows. */
	s16b skill_crossbow; /* How good you are with crossbows. */
	s16b skill_sling; /* How good you are with slings. */
	s16b skill_dualwield; /* The art of dual wielding! */
