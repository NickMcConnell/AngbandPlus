...
static bool summon_specific_okay(int r_idx)
{
	...
	switch (summon_specific_type)
	{
		...
		case SUMMON_CHEESE1:
		{
			okay = ((strstr((r_name + r_ptr->name), "esser cheesy mold")) &&
			       !(r_ptr->flags1 & (RF1_UNIQUE)));
			break;
		}
		...
		case SUMMON_CHEESE2:
		{
			okay = ((strstr((r_name + r_ptr->name), "reater cheesy mold")) &&
			       !(r_ptr->flags1 & (RF1_UNIQUE)));
			break;
		}
