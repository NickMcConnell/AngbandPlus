...
#define DEF_TILE_FILE		"/oangband/lib/xtra/graf/8x8.bmp"
...
static void init_stuff(void)
{
	...
	/* Prepare the path */
	strcpy(path, "/oangband/lib/");

	/* Prepare the filepaths */
	init_file_paths(path);

	/* Hack */
	strcpy(savefile, "/oangband/lib/save/PLAYER");
...
int main(int argc, char *argv[])
{
  ...
  else if (access("/oangband/swapfont",04) != -1) 
    {
      swap_font(false);
    }
