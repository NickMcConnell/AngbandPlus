...
static int toluaI_ui_msgf00(lua_State* tolua_S)
{
 ...
 {
  tolua_error(tolua_S,"#ferror in function 'msgf'.");
  return 0;
 }
 else
 {
...
/* function: msg_effect */
static int toluaI_ui_msg_effect00(lua_State* tolua_S)
{
 if (
     !tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
 ...
 {
  tolua_error(tolua_S,"#ferror in function 'msg_effect'.");
  return 0;
 }
 else
 {
  u16b type = ((u16b)  tolua_getnumber(tolua_S,1,0));
  s16b extra = ((s16b)  tolua_getnumber(tolua_S,2,0));
  {
   msg_effect(type,extra);
  }
 }
 return 0;
}
...
int tolua_ui_open (lua_State* tolua_S)
{
 ...
 tolua_function(tolua_S,NULL,"msgf",toluaI_ui_msgf00);
 tolua_function(tolua_S,NULL,"msg_effect",toluaI_ui_msg_effect00);
...
void tolua_ui_close (lua_State* tolua_S)
{
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"msgf");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"msg_effect");
