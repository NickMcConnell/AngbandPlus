...
{"Giant yellow centipede", "It is about four feet long and carnivorous"},
{"Giant white centipede", "It is about four feet long and carnivorous"},
...
{"Blue yeek" , "A small humanoid figure"},
...
{"Metallic blue centipede", "It is about four feet long and carnivorous"},
...
{"Yellow jelly" , "It's a large pile of yellow flesh"},
...
{"Metallic red centipede", "It is about four feet long and carnivorous"},
...
{"Green naga" , "A large green serpent with a female's torso. Its"
...
{"Rattlesnake" , "It is recognized by the hard-scaled end of its body"
  " that is often rattled to frighten its prey"},
{"Manes" , "It is a minor but aggressive demon"},
...
{"Giant grey rat" , "It is a rodent of unusual size"},
...
{"Giant clear centipede" , "It is about four feet long and carnivorous"},
...
{"Gelatinous cube" , "It is a strange, vast gelatinous structure"
  ...
  " you can see treasures it has engulfed, and a few corpses as well"},
...
{"Stone giant" , "It is eighteen feet tall and looking at you"},
...
{"Master vampire" , "It is a humanoid form dressed in robes. Power"
  " emanates from its chilling frame"},
...
{"Glaurung, Father of the Dragons","Glaurung is the father of all"
  " dragons, and was for a long time the most powerful. He, nevertheless,"
  " still has full command over his brood and can command them"
  " to appear whenever he so wishes. His is the definition of dragonfire"},
...
{"Muar, the Balrog","A huge balrog surrounded by raging pillars of"
  ...
  " fire and a blazing sword, his fury blisters your skin, melts your flesh"},
...
{"Uvatha the Horseman","A tall black cloaked Ringwraith, he is a master"
  " of horsemanship. He longs to taste your blood"},
...
{"Khamul the Hammer","A warrior-king of the East. Khamul is a"
...
{"Feagwath the Undead Sorcerer","A stench of corruption and decay"
...
{"Pukelman","A stumpy figure carved from stone, with glittering eyes,"
  " this sentinel strides towards you with deadly intent"},
...
{"Mumak","A massive elephantine form with eyes twisted by madness"},
{"Mumak","A massive elephantine form with eyes twisted by madness"},
...
{"Monadic deva","A lesser angel wearing little more than a loincloth -"
  " its steely skin provides all the protection it needs"},
...
{"Dark elven sorcerer","A drow elven figure, dressed in deepest black."
...
{"Demonic quylthulg", "A pile of pulsing flesh that glows with an"
  " inner hellish fire. The world itself seems to cry out against it"},
...
{"Green ooze","It's green and it's oozing"},
{"Blue ooze","It's blue and it's oozing"},
...
{"Eldrak","A massive troll, larger and stronger than many men"
  " together. Usually a solitary creature"},
...
{"Eye druj","A bloodshot eyeball floating in the air, you'd be forgiven"
  " for assuming it harmless"},
{"Skull druj","A glowing skull possessed by sorcerous power. It need"
  " not move, but merely blast you with mighty magic"},
...
{"Giant gold dragon fly","Large beating wings support this dazzling"
  " insect. A loud buzzing noise pervades the air"},
...
{"Time hound","You get a terrible sense of deja vu, or is it a"
  ...
  " old dog. Perhaps you should give up and go to bed"},
...
{"5-headed hydra","A strange reptilian hybrid with five heads"
  " dripping venom"},
{"7-headed hydra","A strange reptilian hybrid with seven heads dripping venom"},
{"9-headed hydra","A strange reptilian hybrid with nine smouldering heads"},
{"11-headed hydra","A strange reptilian hybrid with eleven smouldering heads"},
...
{"Druid","A mystic at one with nature."},
