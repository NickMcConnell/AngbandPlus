 		...
 		if (p_ptr->total_winner)
        {
 		  	...
 		  	if (birth_take_notes)
			{
					...
					fprintf(notes_file, "============================================================\n");
 		    		...
 		    		fprintf(notes_file, "Long live %s!", op_ptr->full_name);
					fprintf(notes_file, "============================================================\n");
...
if (birth_take_notes)
	{
		  ...
		  fprintf(notes_file, "============================================================\n");
 		  	...
 		  	fprintf(notes_file,
		  		"%9d|  %2d |   %2d    | ,%s was killed by %s on %s\n",
				turn, 			/* record turn identified*/
				p_ptr->depth,	/* record player depth*/
				p_ptr->lev,    	/* record player level*/
				op_ptr->full_name, /*character name*/
				p_ptr->died_from,  /*killed by */
				long_day);		/* date and time*/
			fprintf(notes_file, "============================================================\n");
...
void close_game(void)
{
	...
	/* Close the notes file */
 	if (birth_take_notes) my_fclose(notes_file);
