...
#define SV_WAND_DESTROY_MUNDANE	30
...
#define SV_ROD_DESTROY_MUNDANE	12
...
/*
 * Sval limit - number of gold entries
 */
...
#define TR2_BERSERK						0x00001000L	/* Berserk strength */
...
#define TR3_LEVITATE					0x00001000L	/* Levitation */
 ...
 */
#define object_aware(T) \
	(k_info[(T)->k_idx].aware)

/*
 * Determine if a given inventory item is "tried"
 */
#define object_tried(T) \
...
/*
 * Normal artifacts use the "name1" field
 */
#define normart(T) \
	((T)->name1 != 0)

/*
 * Random artifacts use the "art_name" field
 */
#define randart(T) \
	((T)->art_name != 0)

/*
 * Normal artifacts and random artifacts are artifacts
 */
#define artifact(T) \
	((T)->name1 || (T)->art_name)
...
/*
 * Ego-items and artifacts are excellent
 */
#define excellent(T) \
	((T)->name2 || (T)->name1 || (T)->art_name)
