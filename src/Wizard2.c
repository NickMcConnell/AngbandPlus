...
static tval_desc tvals[] =
{
    ...
    { TV_FOLK_BOOK,       "Folk Spellbook"     },
	{ TV_CORPOREAL_BOOK, "Corporeal Spellbook"},
	{ TV_SPIKE,             "Spikes"               },
	{ TV_DIGGING,           "Digger"               },
	{ TV_CHEST,             "Chest"                },
	{ TV_FOOD,              "Food"                 },
...
void do_cmd_wiz_help(void)
{
	...
	c_put_str(TERM_RED,"General Commands",13,26);
	c_put_str(TERM_RED,"================",14,26);
	put_str("\" = Generate spoilers",16,26);
	put_str("d = Detect All",17,26);
	put_str("m = Map Area",18,26);
	put_str("w = Wizard Light",19,26);
