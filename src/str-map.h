...
extern void        str_map_add(str_map_ptr map, cptr key, vptr val); /* key is copied */
...
extern vptr             str_map_iter_current(str_map_iter_ptr iter);
extern cptr             str_map_iter_current_key(str_map_iter_ptr iter);
