...
const char VERSION_STRING[] = "v1.0a6";
 ...
 * Maximum size of the "lite" array (see "map.cpp")
 ...
 * Maximum size of the "view" array (see "map.cpp")
 ...
 * Maximum size of the "temp" array (see "map.cpp")
...
const byte CF_MAGMA              = 0x32;

const byte CF_QUARTZ             = 0x33;

const byte CF_MAGMA_H            = 0x34;

const byte CF_QUARTZ_H           = 0x35;

const byte CF_MAGMA_K            = 0x36;

const byte CF_QUARTZ_K           = 0x37;
...
#define floor_grid_bold(Y,X)    (!(cave[Y][X].get_feat() & 0x20))
...
#define clean_grid_bold(Y,X)     (floor_grid_bold(Y,X) &&     (cave[Y][X].get_feat() == CF_FLOOR) &&     (!cave[Y][X].i_ptr))
...
#define clean_stackable_grid_bold(Y,X)     (floor_grid_bold(Y,X) &&      (cave[Y][X].get_feat() == CF_FLOOR))
...
#define empty_grid_bold(Y,X)    (floor_grid_bold(Y,X) &&     !(cave[Y][X].m_ptr) &&      !(((Y) == p_ptr->GetY()) && ((X) == p_ptr->GetX())))
...
#define naked_grid_bold(Y,X)     (floor_grid_bold(Y,X) &&      (cave[Y][X].get_feat() == CF_FLOOR) &&      !(cave[Y][X].i_ptr) &&      !(cave[Y][X].m_ptr) &&      !(((Y) == p_ptr->GetY()) && ((X) == p_ptr->GetX())))
...
#define player_has_los_bold(Y,X)    ((cave[Y][X].flags & MAP_VIEW) != 0)
