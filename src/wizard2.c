...
static void wiz_display_item(object_type *o_ptr)
{
	...
	prt("+------------FLAGS2------------+", 17, j);
	prt("SUST..IMMU..RESIST............. ", 18, j);
	prt("      aefc  aefcpfldbc sn       ", 19, j);
	prt("siwdccclio  cliooeialoshtncdp   ", 20, j);
	prt("tnieohierl  ierliatrnnnrhehis   ", 21, j);
	prt("rtsxnadced  dcedsrekdfddrxssi   ", 22, j);
	prt_binary(f2, 23, j);
