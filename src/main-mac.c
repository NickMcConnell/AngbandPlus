 ...
 * by "USE_SFL_CODE".
 *
 * Steve Linberg released all changes to the Angband code under the terms of the GNU General Public License (version 2),
 * as well as under the traditional Angband license. It may be redistributed under the terms of the GPL (version 2 or any later version), 
 * or under the terms of the traditional Angband license.  
 *
 ...
 *
 * The code of Sprite World is on SourceForge under the ( zlib/libpng ) license : 
 *>>>>>
 * Copyright (c) 1997-2007 Karl Bunker, Vern Jensen, and Anders Bjšrklund
 *
