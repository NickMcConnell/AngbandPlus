 ...
 */
#ifdef JP
#define PREF_FILE_NAME "Questband Preferences"
#else
#define PREF_FILE_NAME "Questband-E Preferences"
#endif
...
static void init_stuff(void)
{
	...
	while (1)
	{
		...
		/* Warning */
#ifdef JP
		plog("Questbandの'lib'フォルダが存在しないか正しく無い可能性があります.");
#else
