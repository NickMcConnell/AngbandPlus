 ...
 *
 * Code by Ben Harrison (benh@voicenet.com) and Randy (randy@stat.tamu.edu).
 *
 ...
 * to give slightly better values.
 *
 ...
 *
 * This method has no bias and is not much affected by patterns
...
const int RANDNOR_NUM = 256;

// The standard deviation of the "randnor_table"
const int RANDNOR_STD = 64;
...
/*
 * Calculates maximum roll for dice rolls
 */
