...
{
	"aardvark", "abe", "aborgonk", "alice", "almond", "anole", 
    ...
    "eggnog", "elbow", "ernest", "fastbull", "farkle", "feral", "ferret", 
    ...
    "grinnedhisgrin", "grisbonk", "groovybacon", "guccigoop", "gustaf", 
    "hal", "heavymetal", "helmanns", "herekitty",
    "herman", "hillofbeans", "hippopotamus", "homer", "hompart", 
    "horsemanship", "hubert", "huntgwak", "ian", "ichabod", "igor", 
    "ihop", "insectoid", "jazzhands", "jackalope", 
    ...
    "laffinstock", "larmalee", "lebliljhic", "lemonscent", "lenny", 
    "levurna", "lobreth", "luigi", "lumok", "lyndandom", "macdonald", 
    "madester", "magrat", "marbaaz", "marcua", "mascot", 
    "maxwell", "mayonnaise", "melvin", "mildew", "misleading", 
    "moist", "monkey", "mullet", "mutant", "nababa", "narmold", 
    "nate", "neppvilsania", "nickel", "nigel", "ninja",
    "norman", "oblerger", "oliphaunt", "oppletox", "orpiphus", 
    "oscar", "oswald", "outsight", "panhead", "panic", "paraskeets",
    "peanut", "pedro", "peppermint", "perambulator", "peskon", 
    "plop", "pickle", "pieces", "pilly", "pipeweed", "pinefresh", 
    "pits", "plague", "ponfusion", "poobab", "proudfeet", "puffle", 
    "purplehaze", "quasimodo", "queazy", "quick", "quilto", 
    "randorf", "robin", "ribbet", "ricardo", "rubert", 
    "rumplestiltskin", "salamoonder", "sammy", "saveferris", 
    "scarecrow", "shimbletag", "shorts", "simpson", "skillet", 
    "slappy", "slimer", "smidgen", "snicket", "socks", "spork", 
    "stank", "stinkyhippy", "sugarlumps", "susie", "swingin",
    "teaspoon", "ted", "tiddlywink", "toadstool", "toby", "toefoo", 
    "tophat", "tourbagit", "tortoise", "turnip", "tweedledum",
    "twist", "ugluk", "underarm", "unicycle", 
    "urmas", "vandal", "vanhalen", "veggierock", "vigrom", 
    "vincent", "vulture", "wacko", "warmwoolenmittens",
    "waffle", "walrus", "wayne", "wendel", "windmill", "wit",
    "wizzard", "william", "wubble", "wuphdawg", "yakkity",
    "yelloworange", "yomama", "youknow", "zaigus", "zalzivit", 
    "zarka", "zelbibon", "zilvatoid", "zoe", "zulaghant",
	NULL
};
