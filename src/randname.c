 ...
 * Also used some non-elvish tolkien names (orcs, trolls, dragons, balrogs).
 */
static cptr silly_names[] =
{
	"aardvark", "abe", "aborgonk", "alice", "almond", "ancalagon", "anole", 
    "appleseed", "aquahoney", "arthur", "ascii", "asphalt", "ather", 
    "auklepog", "babamvillo", "bartholemew", "basket", "bagel", 
    "bean", "benstein", "bisensendo", "blodderjop", "bob", "bokpaddle",
    "bonderbiff", "boppo", "bordgak", "borkaloot", "bowlegged", 
    "bowser", "brown", "bryan", "bubble", "butter", "bwahahaha", 
    "caberdagabra", "cake", "callmeal", "candlestick", "chairface", 
    "cheese", "chocolate", "chowder", "cookingham", "chuck", "clamity",
    "cubbins", "deeboing", "deflator", "derrena", "diddly", "diggem", 
    "dilbert", "dogulhat", "doofus", "dork", "dotty", "eater", "ebbs", 
    "eggnog", "elbow", "ernest", "erotars", "fafner", "fastbull", 
    "farkle", "feral", "ferret", 
    "fish", "flan", "flopsided", "football", "forbgik", "frankfurter", 
    "frenzy", "frizbee", "froglegs", "frokbor", "frye", "furry", 
    "gafbop", "garret", "garlittle", "gatlin", 
    "gershtahlinpoheimmer", "gesundheit", "ghostbuster", "gobbledegook",
    "goober", "gordon", "gork", "gammuth", "geewizz", "gilbert", 
    "ginormus", "glaurung", "glover", "golfimbul", "goolonk", "gothmog",
    "grasshopper", "greebo", "griff", "grinnedhisgrin", "grisbonk", 
    "grishnak", "groovybacon", "guccigoop", "gustaf", 
    "hal", "haunluggapper", "heavymetal", "helmanns", "herekitty",
    "herman", "hillofbeans", "hippopotamus", "homer", "hompart", 
    "horsemanship", "hubert", "huntgwak", "ian", "ichabod", "igor", 
    "ihop", "insectoid", "itangast", "jazzhands", "jackalope", 
    "jammin", "jeffersonfred", "jeremy", "jenkins", "joe",
    "johnjacob", "joimungung", "jingleheimerschmidt", "juibazzle",
    "kawahawawa", "kettle", "kirdil", "kurtulmak", "krang", "krusty", 
    "kyoobert", "laffinstock", "lagduf", "larmalee", "lebliljhic", 
    "lemonscent", "lenny", "levurna", 
    "lobreth", "lungorcus", "lugbertz", "luigi", "lumok", 
    "lyndandom", "macdonald", "madester", "magrat", 
    "marbaaz", "marcua", "mascot", "maxwell", "mayonnaise", "melvin", 
    "mildew", "misleading", "moist", "monkey", "mughash", "mullet", 
    "mutant", "nababa", "narmold", "nate", "nashblat",
    "neppvilsania", "nickel", "nigel", "ninja", "norman", 
    "oblerger", "ocypete", "oliphaunt", "oppletox", "orfax", 
    "orpiphus", "oscar", "oswald", "outsight", "panhead", "panic", 
    "paraskeets", "parfamaeus", "peanut", "pedro", "peppermint", 
    "perambulator", "peskon", "plopbif", "pickle", "pieces", "pilly", 
    "pipdrarwah", "pipeweed", "pinefresh", "pits", "plague", 
    "ponfusion", "poobab", "pordbag", "proudfeet", "puffle", 
    "purplehaze", "quasimodo", "queazy", "quick", "quilto", 
    "razab", "ramvodo", "randorf", "reagent", "regattasplat", 
    "robin", "rogeyflem", "rogrog", "ribbet", 
    "ricardo", "rubert", "rumplestiltskin", "salamoonder", 
    "sammy", "saveferris", "sazzafrack", "scarecrow", "shagrat",
    "shimbletag", "shorts", "simpson", "skillet", "slappy", "slimer", 
    "smauth", "smidgen", "snicket", "socks", "spork", 
    "stank", "stinkyhippy", "sugarlumps", "susie", "swingin",
    "taflonac", "teaspoon", "ted", "telvildo", "thirpizoid", 
    "tiddlywink", "toadstool", "toby", "toefoo", "tophat", "tourbagit", 
    "tortoise", "tulzscha", "turnip", "tweedledum", "twist", 
    "ugluk", "underarm", "unicycle", "urmas", 
    "vandal", "vanhalen", "veggierock", "vigrom", "vincent", "vulture", 
    "wacko", "waffle", "walrus", "warmwoolenmittens",
    "wayne", "wendel", "william", "windmill", "wit",
    "wizzard", "wubble", "wuphdawg", "yakkity",
    "yelloworange", "yowsothoth", "yomama", "youknow", "zaigus", 
    "zalzivit", "zarka", "zelbibon", "zilvatoid", "zoe", "zulaghant",
	NULL
};
