...
/*
 * This file helps Angband work with OS/2 EMX computers.
 * 
 *
 ...
 *
 * A newer version of this file is available in my email.  XXX XXX XXX XXX
 *
 *
 ...
 *
 * The "key handling" really needs to be fixed.  XXX XXX XXX
...
static errr CheckEvents(int returnImmediately)
{
	...
	/* We're not able to extract shift/ctrl/alt key information here. */
	/* That is ridiculous.  What kind of operating system is this? XXX */

	/* Hack -- send the key sequence */
	Term_keypress(I2D((ke % 1000) / 100));
	Term_keypress(I2D((ke % 100) / 10));
	Term_keypress(I2D((ke % 10)));
...
From: Dr James Denholm-Price <j.c.w.price@sheffield.ac.uk>
Organization: Dept. Applied Maths, University of Sheffield


Dear Ben,

I have hacked together a modified version of 'main-emx.c' to support all
of your your multiple Term windows (thanks to Ekkehard for making it an
easy job!). I've attached the diffs to 'main-emx.c' from the 2.8.0/2.8.1
distribution & hope you can incorporate these changes into the archive.
I'll also upload them plus the new 'main-emx.c' to the site as: 

    export.andrew.cmu.edu/angband/Incoming/ang281-os2-mods.zip

I've been in touch with Ekkehard, who lacks the time @ present to spend
much time with Angband (or programming in general) & he seems happy with
the changes. It seems he u/l'd patches for 2.8.0 to you some time ago,
but I guess they must have gotten lost somewhere...

It's not my intention to 'take over' as OS/2 maintainer (my 'C' ain't up
to much!) but I _do_ like the new windows & guess that others do too!

Cheers,
         James

PS: diffs attached using Netscape's MIME - I hope that's OK...

-- 
---------------------------------------------------------
Dr James Denholm-Price             j.c.w.price@shef.ac.uk
Team-OS/2

*** old/main-emx.c	Wed Apr  2 10:18:36 1997
--- main-emx.c	Wed Apr  2 10:17:10 1997
***************
*** 3,16 ****
