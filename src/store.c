 ...
 *
 * Halflings still left at old Spectre values -- RDH
 */
static byte rgold_adj[MAX_RACES][MAX_RACES] =
{
	/*
	* Shopkeeper listed below, this is player race order:
	* Hum, Eld, Oag, Gno, Dwa, Nha, HTr, Gam, HiE, Bar,
	* HGi, Sid, Kla, Kob, Dra, MFl, Gol, Vam, Hal, Bea,
	* Yek, Mel, Vad
	*/
			/* Human */
	{ 100, 110, 110, 113, 115, 115, 125, 100, 105, 100,
	  120, 110, 120, 120, 115, 120, 105, 125, 125, 120,
	  150, 130, 105 },

			/* Eldren */
	{ 110, 100, 100, 110, 110, 115, 120, 110, 105, 125,
	  115, 100, 105, 120, 115, 120, 115, 120, 100, 125,
	  130, 110, 100 },

			/* Oager Uv */
	{ 110, 105, 100, 105, 105, 105, 120, 105, 105, 115,
	  110, 110, 120, 120, 110, 125, 110, 110, 105, 135,
	  130, 110, 105 },

			/* Gnome */
	{ 113, 110, 105, 100, 110, 105, 130, 115, 110, 115,
	  125, 110, 105, 120, 105, 110, 105, 120, 120, 130,
	  150, 110, 110 },

			/* Dwarf */
	{ 115, 115, 110, 110, 100, 105, 135, 115, 120, 115,
	  140, 115, 115, 115, 125, 120, 105, 115, 115, 130,
	  150, 115, 115 },

			/* Nhadragh */
	{ 140, 130, 100, 115, 110, 100, 125, 115, 135, 150,
	  130, 140, 120, 115, 120, 130, 110, 125, 135, 135,
	  110, 130, 165 },

			/* Half-Troll */
	{ 125, 130, 120, 130, 135, 125, 100, 110, 130, 110,
	  115, 120, 120, 110, 115, 110, 115, 115, 135, 110,
	  150, 130, 130 },

			/* Gambolt */
	{ 100, 110, 105, 115, 115, 115, 110, 100, 110, 115,
	  120, 115, 110, 120, 115, 115, 110, 130, 110, 130,
	  150, 110, 110 },

			/* High_Elf */
	{ 115, 100, 105, 110, 120, 110, 130, 110, 100, 140,
	  115, 105, 110, 115, 110, 125, 115, 125, 120, 125,
	  150, 110, 100 },

			/* Barbarian */
	{ 100, 150, 110, 115, 115, 135, 110, 115, 130, 100,
	  120, 135, 120, 120, 115, 120, 105, 130, 150, 110,
	  150, 130, 140 },

			/* Half-Giant */
	{ 110, 120, 110, 125, 140, 110, 115, 120, 125, 115,
	  100, 120, 120, 110, 115, 110, 115, 115, 112, 130,
	  150, 130, 120 },

			/* Sidhi */
	{ 110, 105, 110, 110, 120, 120, 120, 110, 105, 120,
	  110, 100, 110, 115, 110, 110, 115, 120, 120, 130,
	  130, 105, 100 },

			/* Klackon */
	{ 120, 110, 110, 105, 105, 110, 130, 130, 110, 120,
	  120, 110, 100, 110, 105, 110, 100, 120, 120, 150,
	  140, 135, 110 },

			/* Kobold */
	{ 125, 125, 120, 120, 120, 110, 110, 120, 125, 120,
	  110, 115, 120, 100, 120, 110, 110, 120, 135, 130,
	  150, 140, 125 },

			/* Draconian */
	{ 115, 115, 115, 125, 125, 115, 115, 115, 115, 125,
	  115, 115, 105, 130, 100, 110, 110, 120, 120, 130,
	  150, 105, 115 },

			/* Mind Flayer */
	{ 120, 110, 115, 110, 120, 120, 110, 115, 110, 120,
	  115, 110, 110, 110, 110, 100, 115, 110, 120, 120,
	  150, 110, 110 },

			/* Golem -- can't bother to distinguish between organics -- RDH */
	{ 115, 115, 115, 115, 115, 115, 115, 115, 115, 115,
	  115, 115, 115, 115, 115, 115, 100, 115, 115, 115,
	  115, 115, 115 },

			/* Vampire */
	{ 125, 120, 120, 120, 115, 120, 115, 130, 125, 130,
	  125, 120, 120, 130, 120, 110, 120, 100, 110, 130,
	  150, 120, 125 },

			/* Halfling */
	{ 125, 100, 105, 120, 120, 115, 120, 110, 120, 145,
	  120, 105, 120, 120, 120, 120, 110, 120, 100, 140,
	  130, 110, 105 },

			/* Beastman */
	{ 120, 125, 130, 130, 130, 125, 120, 130, 125, 120,
	...
	{ 150, 150, 150, 150, 150, 150, 150, 150, 150, 150,
	  150, 150, 150, 150, 150, 150, 150, 150, 150, 150,
		50, 150, 150 },
			...
			/* Melnibonean */
	{ 110, 105, 110, 110, 120, 125, 130, 115, 110, 120,
	  115, 105, 105, 125, 105, 120, 110, 115, 105, 115,
	  150, 100, 105 },

			/* Vadhagh */
	{ 110, 100, 105, 110, 120, 155, 115, 110, 105, 130,
	  120, 100, 110, 115, 110, 115, 110, 125, 105, 135,
	  150, 105, 100 },
};
	...
	switch (store_num)
	{
		...
		case 0:
		{
			...
			switch (o_ptr->tval)
			{
				...
				case TV_AXE:
				{
					if (!((o_ptr->sval == SV_HATCHET) ||
					      (o_ptr->sval == SV_CLEAVER)))
						return(FALSE);
					break;
				}
...
static void store_purchase(void)
{
	...
	if (o_ptr->number > 1)
	{
		...
		if ((store_num != 7) && (o_ptr->ident & (IDENT_FIXED)))
		{
