...
/*
 * This file loads savefiles from DvEband 1.0.0
 *
 *
 *
...
static errr rd_extra(void)
{
	...
	/* Repair psex (2.8.1 beta)  can we get rid of this? DvE */
	...
	/* Skills */
	rd_s16b(&p_ptr->skill_swords);
	rd_s16b(&p_ptr->skill_axes);
	rd_s16b(&p_ptr->skill_daggers);
	rd_s16b(&p_ptr->skill_polearms);
	rd_s16b(&p_ptr->sc);
	rd_s16b(&p_ptr->skill_hafted);
	/* strip_bytes(2); */

	/* Read the flags */
	rd_s16b(&p_ptr->skill_slings); /* was strip_bytes(2);	/* Old "rest" */
	rd_s16b(&p_ptr->blind);
	rd_s16b(&p_ptr->paralyzed);
	rd_s16b(&p_ptr->confused);
	rd_s16b(&p_ptr->food);
	rd_s16b(&p_ptr->skill_bows); /* was strip_bytes(4);	/* Old "food_digested" / "protection" */
	rd_s16b(&p_ptr->skill_xbows);
...
static errr rd_dungeon(void)
{
	...
	/* Here starts the loading of the cave dam array DvE */
	/*** Run length decoding ***/
	...
	/* Here ends the loading of the cave dam array DvE */
