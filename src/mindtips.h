...
},
{
	...
	"Rush towards a nearby opponent and attack.",
	"You begin to feast on your opponents blood, doing extra damage but at a cost to your own health.",
	"Gives an aura of bloody revenge.  Monsters take damaged based on your cut status.",
...
{	/* Warlock: Undead */
	"Fires your basic Eldritch Blast.",
	"Fires an Eldritch Blast with increased range.",
	"Fires an Eldritch Beam.",
	"Fires an Eldritch Blast with increased radius.",
	"Augments your Eldritch Blast with stunning effects.",
	"Fires an Eldritch Blast which also does Drain Life.",
	"Fires a very powerful Eldritch Blast, but you can't use your powers again for a bit.",
	"",
	"",
	"",
	"",
...
{	/* Warlock: Dragon */
	...
	"Fires an Eldritch Blast with increased radius.",
	"Augments your Eldritch Blast with stunning effects.",
	"Fires multiple blasts, one each of fire, frost, acid, lightning and poison.",
	"Fires a very powerful Eldritch Blast, but you can't use your powers again for a bit.",
	"",
	"",
	"",
...
{	/* Warlock: Angel */
	...
	"Fires an Eldritch Blast with increased radius.",
	"Augments your Eldritch Blast with stunning effects.",
	"Fires an Eldritch Blast which also does Dispel Magic.",
	"Fires a very powerful Eldritch Blast, but you can't use your powers again for a bit.",
	"",
	"",
	"",
...
{	/* Warlock: Demon */
	...
	"Fires an Eldritch Blast with increased radius.",
	"Augments your Eldritch Blast with stunning effects.",
	"Fires an extremely deadly Eldritch Blast, but you also take damage.",
	"Fires a very powerful Eldritch Blast, but you can't use your powers again for a bit.",
	"",
	"",
	"",
...
{	/* Warlock: Aberration */
	...
	"Fires an Eldritch Blast with increased radius.",
	"Augments your Eldritch Blast with stunning effects.",
	"Fires an Eldritch Blast that also confuses your opponent.",
	"Fires a very powerful Eldritch Blast, but you can't use your powers again for a bit.",
	"",
	"",
	"",
