...
static void describe_autopick(char *buff, autopick_type *entry)
{
	...
	if (IS_FLG(FLG_RARE))
	{
		before_str[before_n++] = "ドラゴン装備や妖刀等を含む珍しい";
		body_str = "装備";
	}
	...
	{
		before_str[before_n++] = "ありふれた(ドラゴン装備や妖刀等の珍しい物ではない)";
		body_str = "装備";
	}
...
static char MN_WALSTANIAN[] = "ウォルスタ人の (像)";
static char MN_GARGASTAN[] = "ガルガスタン人の (像)";
static char MN_BACRUM[] = "バクラム人の (像)";
static char MN_ZENOBIAN[] = "ゼノビア人の (像)";
static char MN_LODIS[] = "ローディス人の (像)";

static char MN_NOUN[] = "名詞の選択";
static char MN_NOUN2[] = "名詞の選択 (武器タイプ)";
