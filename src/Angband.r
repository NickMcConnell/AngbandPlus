...
/* 
 * For Carbon builds under CodeWarrior, use Carbon.r as a prefix file for Rez
 * -- this will define TARGET_API_MAC_CARBON.  For command-line Carbon builds
 * (including MPW), use -d TARGET_API_MAC_CARBON=1 as a parameter to the Rez
 * command.
 */
...
/*
 * OS X Finder requires this to launch Carbon apps
 */
data 'plst' (0)
{
	$"00"
...
resource 'MENU' (128, preload)
{
	...
	{
		/* First item */
		"About Sangband...", noicon, nokey, nomark, plain;
...
#if 0
		/* item #7 */
		"Show score", noicon, nokey, nomark, plain;
#endif
 ...
 * This was Ben's doing and, being such, hd a logical
 * reason to had been allowed - frequent and often
