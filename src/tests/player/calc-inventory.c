...
int setup_tests(void **state) {
	...
	/* Set up the player. */
	if (!player_make_simple(NULL, NULL, "Engineer", "Tester")) {
		cleanup_angband();
		return 1;
	}
	...
	struct simple_test_case only_pack_case = {
		{
			...
			{ TV_DEVICE, 2, 2, true, false },
			{ TV_PILL, 4, 5, true, false },
			{ TV_LIGHT, 1, 6, true, false },
			{ TV_DIGGING, 1, 1, true, false },
			{ TV_BATTERY, 1, 1, true, false },
			{ TV_GADGET, 3, 1, true, false },
			{ -1, -1, -1, false, false }
		},
		/*
	...
	struct simple_test_case only_quiver_case = {
		{
			...
			{ TV_AMMO_6, 1, 27, true, false },
			{ TV_AMMO_9, 1, 15, true, false },
		},
		{ { -1, -1, -1 } },
		/*
...
static int test_calc_inventory_equipped_pack_quiver(void *state) {
	struct simple_test_case this_test_case = {
		{
			{ TV_AMMO_12, 1, 10, true, false },
			{ TV_CARD, 3, 4, true, false },
			{ TV_SOFT_ARMOR, 2, 1, false, true },
			/* dagger */
			{ TV_SWORD, 1, 1, false, false },
			{ TV_PILL, 2, 3, false, false },
			//{ TV_AMMO_9, 2, 7, true, false },
			{ TV_AMMO_6, 1, 13, true, false },
			{ TV_AMMO_9, 1, 15, true, false },
			{ TV_CARD, 1, 3, false, false },
			{ TV_PILL, 3, 1, true, false },
			//{ TV_AMMO_12, 2, 5, true, false },
			//{ TV_AMMO_6, 2, 3, true, false },
			/* sling */
			//{ TV_GUN, 1, 1, false, true },
			{ TV_PILL, 5, 2, true, false },
		},
		{
			{ TV_PILL, 3, 1 },
			{ TV_PILL, 5, 2 },
