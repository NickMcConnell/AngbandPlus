...
static bool perform_one_test(struct carry_num_state *cns, struct object *obj,
	...
	obj->number = n_try;
	if (inven_carry_num(obj, true) != n_expected) {
		success = false;
	}
