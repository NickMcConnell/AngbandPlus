...
* can display a two dimensional array of grids containing coloured
...
* to display "coloured textual symbols" in a standard 80x24 "window",
...
*   changing "colours" may be expensive
*   the "colour" of a "blank" is rarely important
...
*   changing "colours" is usually cheap
*   the "colour" of a "blank" may be important
...
* adjacent characters of the same colour can both be drawn together using
...
* and for applications that do a lot of "detailed" colour printing.
*
...
* drawn in the colour "black", to be explicitly drawn.  This is useful
