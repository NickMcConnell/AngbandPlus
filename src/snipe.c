...
static bool cast_sniper_spell(int spell)
{
	...
	case 6: snipe_type = SP_RUSH; break;
	case 7: snipe_type = SP_PIERCE; break;
	case 8: snipe_type = SP_EVILNESS; break;
	case 9: snipe_type = SP_HOLYNESS; break;
	case 10: snipe_type = SP_EXPLODE; break;
	case 11: snipe_type = SP_DOUBLE; break;
	case 12: snipe_type = SP_ELEC; break;
	case 13: snipe_type = SP_FINAL; break;
	default:
#ifdef JP
		msg_print("なに？");
#else
