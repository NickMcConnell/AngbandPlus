...
const char help_sdl[] = "Isometric tiles.";
...
#define ungetarg (++argc, --argv)
	...
	SDL_WM_SetCaption(td->name, "Iso-Angband");
	...
	*/
    ...
    {
        int i;
        for(i=0; i<data[0].t.hgt; i++) {
            set_spots(0, i, data[0].t.wid, TRUE);
        }
    }        
 ...
 * I'm offering a main here, and try to simulate the function
 * of Angband main()
 */
int main(int argc, char ** argv)
{
    printf("Calling sdl_main_hook.\n");
    return sdl_main_hook(argc, argv);
}
