...
static void rd_extra(void)
{
	...
	rd_s32b(&turn);
        ...
        rd_s16b(&p_ptr->current_ability);
        /* rd_s16b(&p_ptr->slave_ryenna); */
}
...
static errr rd_dungeon(void)
{
	...
	rd_s16b(&max_panel_cols);
        ...
        /* SAVE MY LIFE */
        /* This little add-on allow you to restore a character if an */
...
static errr rd_savefile_new_aux(void)
{
        ...
        else if (death)
	{
		/* Dead players have no dungeon */
                ...
                {
                        p_ptr->chp = p_ptr->mhp;
                        /* p_ptr->recall_dungeon = 8; */
                        dun_level = max_dlv[p_ptr->recall_dungeon];
