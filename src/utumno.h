...
// Main Utumno header file

#ifndef INCLUDED_UTUMNO_H
#define INCLUDED_UTUMNO_H
...
// Now, include the defines, types, and externs
#include "consts.h"
#include "types.h"
#include "gui.h"
#include "externs.h"
...
/* Original copyright message (reformatted) follows. */
