...
static int
toluaI_tolua_tolua_using00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
     else
     {
          LUA_VALUE       module =
              ((LUA_VALUE) tolua_getvalue(tolua_S, 1, 0));
          {
               tolua_using(module);
          }
     }
...
/* function: tolua_type */
static int
toluaI_tolua_tolua_type00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
     else
...
static int
toluaI_tolua_tolua_foreach00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 3))
          goto tolua_lerror;
     else
     {
          LUA_VALUE       lo = ((LUA_VALUE) tolua_getvalue(tolua_S, 1, 0));
...
static int
toluaI_tolua_tolua_class00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 3))
          goto tolua_lerror;
     else
     {
          LUA_VALUE       derived =
              ((LUA_VALUE) tolua_getvalue(tolua_S, 1, 0));
          LUA_VALUE       base =
              ((LUA_VALUE) tolua_getvalue(tolua_S, 2, 0));
          {
...
static int
toluaI_tolua_tolua_instance00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 3))
          goto tolua_lerror;
     else
...
/* function: tolua_base */
static int
toluaI_tolua_tolua_base00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
     else
...
/* function: tolua_cast */
static int
toluaI_tolua_tolua_cast00(lua_State * tolua_S)
{
     ...
     else
     {
          ...
          {
               LUA_VALUE       toluaI_ret =
                   (LUA_VALUE) tolua_cast(lo, type);
               tolua_pushvalue(tolua_S, toluaI_ret);
          }
     }
     return 1;
...
static int
toluaI_tolua_tolua_takeownership00(lua_State * tolua_S)
{
     if(!tolua_isnoobj(tolua_S, 2))
          goto tolua_lerror;
     else
...
/* Open function */
int
tolua_tolua_open(lua_State * tolua_S)
{
     tolua_open(tolua_S);
     ...
     tolua_function(tolua_S, "tolua", "foreach",
                    toluaI_tolua_tolua_foreach00);
     tolua_function(tolua_S, "tolua", "class", toluaI_tolua_tolua_class00);
     tolua_function(tolua_S, "tolua", "instance",
                    toluaI_tolua_tolua_instance00);
     tolua_function(tolua_S, "tolua", "base", toluaI_tolua_tolua_base00);
     tolua_function(tolua_S, "tolua", "cast", toluaI_tolua_tolua_cast00);
     tolua_function(tolua_S, "tolua", "takeownership",
                    toluaI_tolua_tolua_takeownership00);
     return 1;
}

/* Close function */
void
tolua_tolua_close(lua_State * tolua_S)
{
     lua_pushnil(tolua_S);
     lua_setglobal(tolua_S, "tolua");
}
