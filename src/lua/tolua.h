...
** Jul 1998
** $Id: tolua.h,v 1.1 2003/04/09 00:19:01 cipher Exp $
*/
...
#define TOLUA_VERSION       "tolua 4.0a - ironhells"
...
void            tolua_using(lua_State * L,
                            int module);
void            tolua_class(lua_State * L,
                            int derived,
                            int base);
void            tolua_instance(lua_State * L,
                               int instance,
                               int classobj);
void            tolua_foreach(lua_State * L,
                              int lo,
                              int f);
int             tolua_tag(lua_State * L,
                          const char *type);
const char     *tolua_type(lua_State * L,
                           int lo);
int             tolua_base(lua_State * L,
                           int lo);
int             tolua_cast(lua_State * L,
                           int lo,
                           char *type);
void            tolua_takeownership(lua_State * L,
                                    int lo);
...
/* Register functions */
void            tolua_globalvar(lua_State * L,
                                const char *name,
                                lua_CFunction get,
                                lua_CFunction set);
void            tolua_globalarray(lua_State * L,
                                  const char *name,
                                  lua_CFunction get,
                                  lua_CFunction set);
...
void            tolua_constant(lua_State * L,
                               ...
                               const char *name,
                               long value);
void            tolua_tablevar(lua_State * L,
                               const char *table,
                               const char *name,
                               lua_CFunction get,
                               lua_CFunction set);
void            tolua_tablearray(lua_State * L,
                                 const char *table,
                                 const char *name,
                                 lua_CFunction get,
                                 lua_CFunction set);
...
long            tolua_getnumber(lua_State * L,
                                int narg,
                                long def);
const char     *tolua_getstring(lua_State * L,
                                int narg,
                                const char *def);
void           *tolua_getuserdata(lua_State * L,
                                  int narg,
                                  void *def);
void           *tolua_getusertype(lua_State * L,
                                  int narg,
                                  void *def);
int             tolua_getvalue(lua_State * L,
                               int narg,
                               int def);
int             tolua_getbool(lua_State * L,
                              int narg,
                              int def);
long            tolua_getfieldnumber(lua_State * L,
                                     int lo,
                                     int index,
                                     long def);
const char     *tolua_getfieldstring(lua_State * L,
                                     int lo,
                                     int index,
                                     const char *def);
void           *tolua_getfielduserdata(lua_State * L,
                                       int lo,
                                       int index,
                                       void *def);
void           *tolua_getfieldusertype(lua_State * L,
                                       int lo,
                                       int index,
                                       void *def);
int             tolua_getfieldvalue(lua_State * L,
                                    int lo,
                                    int index,
                                    int def);
int             tolua_getfieldbool(lua_State * L,
                                   int lo,
                                   int index,
                                   int def);
...
void            tolua_pushvalue(lua_State * L,
                                int lo);
void            tolua_pushbool(lua_State * L,
                               int value);
...
void            tolua_pushfieldvalue(lua_State * L,
                                     ...
                                     int index,
                                     int v);
void            tolua_pushfieldbool(lua_State * L,
                                    int lo,
                                    int index,
                                    int v);
...
#if 0
void            tolua_settag(lua_State * L,
                             char *type,
                             int *tag);
#endif
int             tolua_istype(lua_State * L,
                             int narg,
                             int tag,
                             int dim);
int             tolua_arrayistype(lua_State * L,
                                  int narg,
                                  int tag,
                                  int dim,
                                  int def);
...
void           *tolua_doclone(lua_State * L,
                              void *value,
                              int tag);
