...
/*
** $Id: llex.c,v 1.1 2003/04/09 00:19:01 cipher Exp $
** Lexical Analyzer
...
static const char *const token2string[] = {
     ...
     "function", "if", "local", "nil", "not", "or", "repeat", "return",
     "then",
     "until", "while", "", "..", "...", "==", ">=", "<=", "~=", "", "",
     "<eof>"
};
          ...
          switch (LS->current)
          {
               ...
               default:
                  ...
                  tname:{      /* identifier or reserved word */
                         TString        *ts =
                             luaS_new(LS->L, readname(LS));
                         if(ts->marked >= RESERVEDMARK) /* reserved word? */
                              return ts->marked - RESERVEDMARK +
                                  FIRST_RESERVED;
                         seminfo->ts = ts;
                         return TK_NAME;
                    }
