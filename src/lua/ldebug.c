...
/*
** $Id: ldebug.c,v 1.1 2003/04/09 00:19:01 cipher Exp $
** Debug Interface
...
static          StkId
aux_stackedfunction(lua_State * L,
                    int level,
                    StkId top)
{
     int             i;
