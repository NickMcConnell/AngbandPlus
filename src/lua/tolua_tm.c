...
** TeCGraf/PUC-Rio
** Jul 1998
** $Id: tolua_tm.c,v 1.1 2003/04/09 00:19:01 cipher Exp $
*/
...
void
toluaI_tm_setclass(lua_State * L,
                   int lo)
{
...
void
toluaI_tm_instance(lua_State * L,
                   int tag,
                   int lo)
{
...
void
toluaI_tm_linstance(lua_State * L,
                    int tag,
                    int lo)
{
     toluaI_getregistry(L, "tolua_tbl_class");
...
static void
toluaI_tm_undoclone(lua_State * L,
                    int tag,
                    void *clone)
{
     toluaI_getregistry(L, "tolua_tbl_clone");
...
void
toluaI_tm_pushmate(lua_State * L,
                   int lo)
{
...
void
toluaI_tm_pushclass(lua_State * L,
                    int lo)
{
     toluaI_getregistry(L, "tolua_tbl_class");
...
void
toluaI_tm_init(lua_State * L)
{
     lua_newtable(L);
     toluaI_setregistry(L, "tolua_tbl_class");
     lua_newtable(L);
     toluaI_setregistry(L, "tolua_tbl_clone");
     lua_newtable(L);
     toluaI_setregistry(L, "tolua_tbl_mate");

     lua_pushnumber(L, lua_newtag(L));
     toluaI_setregistry(L, "tolua_tag_global");
     lua_pushnumber(L, lua_newtag(L));
     toluaI_setregistry(L, "tolua_tag_module");
     lua_pushnumber(L, lua_newtag(L));
     toluaI_setregistry(L, "tolua_tag_class");
     lua_pushnumber(L, lua_newtag(L));
     toluaI_setregistry(L, "tolua_tag_instance");
     lua_pushnumber(L, lua_newtag(L));
     toluaI_setregistry(L, "tolua_tag_linstance");
     lua_pushnumber(L, lua_newtag(L));
     toluaI_setregistry(L, "tolua_tag_indirect");

     toluaI_tt_register(L, toluaI_gettag(L, "tolua_tag_global"),
                        "generic variable");
     toluaI_tt_register(L, toluaI_gettag(L, "tolua_tag_module"),
                        "generic module");
     toluaI_tt_register(L, toluaI_gettag(L, "tolua_tag_class"),
                        "generic class");
     toluaI_tt_register(L, toluaI_gettag(L, "tolua_tag_indirect"),
                        "generic indirect");
     toluaI_tt_register(L, toluaI_gettag(L, "tolua_tag_instance"),
                        "generic instance");
     toluaI_tt_register(L, toluaI_gettag(L, "tolua_tag_linstance"),
                        "generic lua instance");

     /* allows modules and classes to be used as ordinary tables */
     toluaI_tt_sethierarchy(L, toluaI_gettag(L, "tolua_tag_module"),
                            tolua_tag_table);
     toluaI_tt_sethierarchy(L, toluaI_gettag(L, "tolua_tag_class"),
                            tolua_tag_table);
...
static int
instance_gc(lua_State * L)
{
     toluaI_tm_undoclone(L, lua_tag(L, 1), lua_touserdata(L, 1));
     return 0;
}
static int
gen_operator(lua_State * L)
{
     int             op1 = 1;
     int             op2 = 2;
     int             event = 3;
     char           *name =
         toluaI_tt_concat("operator_", lua_tostring(L, event));
...
static int
instance_operator(lua_State * L)
{
     return gen_operator(L);
}
static int
instance_relational(lua_State * L)
{
     gen_operator(L);
     if((int) lua_tonumber(L, -1) == 0)
          lua_pushnil(L);
     return 1;
}
...
static int
indirect_getglobal(lua_State * L)
{
     int             varname = 1;
     int             value = 2;
...
static int
indirect_setglobal(lua_State * L)
{
     int             varname = 1;
     int             value = 2;
     int             newvalue = 3;
...
static void
setmethods(lua_State * L)
{
     /* global variable */
     lua_pushcfunction(L, global_getglobal);
     lua_settagmethod(L, toluaI_gettag(L, "tolua_tag_global"),
                      "getglobal");
     ...
     lua_settagmethod(L, toluaI_gettag(L, "tolua_tag_indirect"),
                      "getglobal");
