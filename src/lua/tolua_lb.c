...
** TeCGraf/PUC-Rio
** Jul 1998
** $Id: tolua_lb.c,v 1.1 2003/04/09 00:19:01 cipher Exp $
*/
               ...
               int classobj)
{
     ...
     if(tag == 0)
          tolua_error(L,
                      "unregistered 'classobj' in function 'tolua_instance'.");
...
void
tolua_takeownership(lua_State * L,
                    int lo)
{
     if(toluaI_tt_isusertype(L, lo))
     {
