...
/*
** $Id: lbaselib.c,v 1.1 2003/04/09 00:19:01 cipher Exp $
** Basic library
...
*/
static int
luaB__ERRORMESSAGE(lua_State * L)
{
...
static int
luaB_copytagmethods(lua_State * L)
{
