...
/*
** $Id: lgc.c,v 1.1 2003/04/09 00:19:01 cipher Exp $
** Garbage Collector
...
static void     markobject(GCState * st,
                           TObject * o);
