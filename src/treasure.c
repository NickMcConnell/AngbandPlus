...
{"Poison"  /*Last Mushroom*/	,0x00000001L,	TV_FOOD, ',', /* 15*/
...
{"Flames"	                ,0x00080000L,	TV_RING, '=', /*146*/
    0,	3000,	14,   1,   2,	0,   0,	 0,   0, {0,0}	, 50, 0, 0L
#ifdef TC_COLOR
  ,0
#endif
},
{"Acid"         	        ,0x00100000L,	TV_RING, '=', /*147*/
    0,	3000,	15,   1,   2,	0,   0,	 0,   0, {0,0}	, 50, 0, 0L
#ifdef TC_COLOR
  ,0
#endif
},
{"Ice"          	        ,0x00200000L,	TV_RING, '=', /*148*/
    0,	3000,	16,   1,   2,	0,   0,	 0,   0, {0,0}	, 50, 0, 0L
#ifdef TC_COLOR
  ,0
#endif
},
...
{"Elemental Branding"		,0x00001000L,	TV_SCROLL1, '?', /*183*/
    0,	10000,	87,   1,   5,	0,   0,	 0,   0, {0,0}	,  80, 2, 0L
#ifdef TC_COLOR
  ,WHITE
#endif
},
...
{"Nexus Resistance"		,0x00000000L,	 TV_RING, '=', /*344*/
    0,	 12000,	38,   1,  2,	0,   0,	 0,   0, {0,0}	,  24, 2, 0x00400000L
#ifdef TC_COLOR
  ,0
#endif
},
{"Wall Building"        	,RD_MK_WALL,	 TV_ROD, '-', /*345*/
    0,	3600,	26,   1,  15,	0,   0,	 0,   0, {0,0}	,  70, 12, 0x800L
#ifdef TC_COLOR
  ,0
#endif
},
...
{"Resist Fear"			,0x00000000L,	TV_RING, '=', /*348*/
    0,	 100,	41,   1,   2,	0,   0,	 0,   0, {0,0}	, 3, 0, 0x10000000L
#ifdef TC_COLOR
  ,0
#endif
},
{"Nether Resistance"		,0x00000000L,	 TV_RING, '=', /*349*/
    0,	 20000,	39,   1,  2,	0,   0,	 0,   0, {0,0}	,  34, 2, 0x01000008L
#ifdef TC_COLOR
  ,0
#endif
},
{"Chaos Resistance"		,0x00000000L,	 TV_RING, '=', /*350*/
    0,	30000,	40,   1,  2,	0,   0,	 0,   0, {0,0}	,  50, 2, 0x00080000L
#ifdef TC_COLOR
  ,0
#endif
},
{"& Triple Crossbow"		,0x00000000L,	 TV_BOW, '}', /*351*/
    7,	10000,	12,   1,  220,	0,   0,	 0,   0, {0,0}	, 70, 3, 0L
#ifdef TC_COLOR
  ,CYAN
#endif
},
{"& Composite Bow"		,0x00000000L,	 TV_BOW, '}', /*352*/
    4,	  250,	 3,   1,  60,	0,   0,	 0,   0, {0,0}	, 20, 0, 0L
#ifdef TC_COLOR
  ,BROWN
#endif
},
{"Extra Attacks"		,0x00000000L,	 TV_RING, '=', /*353*/
    0, 100000L,	 12,   1,   2,	0,   0,	 0,   0, {0,0}	,  50, 2, 0x08000000L
#ifdef TC_COLOR
  ,0   /* Was broken set of teeth */
#endif
},
{"& large broken bone"		,0x00000000L,	 TV_MISC, '-', /*354*/
...
{"Probing"			,ST_PROBE,	TV_STAFF,  '_', /*407*/
    6,  2000,  30,   1,  50,    0,   0,  0,   2, {1,2}  , 30, 1, 0L
#ifdef TC_COLOR
  ,0
#endif
},
...
{"Chaos Dragon Scale Mail"	,0x00100000L,  TV_HARD_ARMOR, '[', /*415*/
    0, 80000L,  25,   1, 200,   -2,   0, 30,  10, {2,4}, 75, 20, 0x00180800L
#ifdef TC_COLOR
  ,DARKGRAY
#endif
},
{"Shadow Dragon Scale Mail"	,0x00100000L,  TV_HARD_ARMOR, '[', /*416*/
    0, 70000L,  26,   1, 200,   -2,   0, 30,  10, {2,4}, 75, 15, 0x01040800L
#ifdef TC_COLOR
  ,DARKGRAY
#endif
},
{"Crystal Dragon Scale Mail"    ,0x00100000L,  TV_HARD_ARMOR, '[', /*417*/
    0, 80000L,  27,   1, 200,   -2,   0, 30,  10, {2,4}, 70, 10, 0x00200800L
#ifdef TC_COLOR
  ,CYAN
#endif
},
{"Pseudo Dragon Scale Mail"    ,0x00100000L,  TV_HARD_ARMOR, '[', /*418*/
    0, 50000L,  28,   1, 200,   -2,   0, 30,  10, {2,4}, 65, 12, 0x00060800L
#ifdef TC_COLOR
  , MAGENTA
#endif
},
{"Celestial Dragon Scale Mail" ,0x00000000L,  TV_HARD_ARMOR, '[', /*419*/
    0, 0,  29,   1, 400,   -3,   0, 40,  15, {2,4}, 255, 255, 0x02000000L
#ifdef TC_COLOR
  , LIGHTCYAN  /*Dropped only by Tiamat; all flags are added there. -DGK */
#endif
},
...
{"Self Knowledge"               ,0x00400000L,   TV_POTION2, '!', /*421*/
    0,  300,  114,   1,   4,     0,   0,  0,   0, {1,1},   20, 0, 0L
#ifdef TC_COLOR
  ,0
#endif
},
...
{"Power 'Narya'"		,0x01C008BFL,	TV_RING, '=', /* +78 */
...
{"Power 'Nenya'"		,0x05C008BFL,	TV_RING, '=', /*467*/
    2,	200000L,	32,   1,   2,	0,   0,	 0,   0, {0,0}	, 90, 0, 0x02000888L
#ifdef TC_COLOR
  ,0
#endif
},
{"Power 'Vilya'"		,0x01C008BFL,	TV_RING, '=', /*468*/
...
#ifdef ACCENTS
{"The Arkenstone of Thr in"
#else
{"The Arkenstone of Thrain"
#endif
				 ,0x0100000CL,  TV_LIGHT,   '~', /*474*/
...
"'Anduril'",
#endif
	"of Orc Slaying",       "of Power",        "of Durin",
#ifdef ACCENTS
"of Aul‰",
#else
"of Aule",
#endif
"of Westernesse", "(Blessed Blade)", "of Demon Slaying", "of Troll Slaying",
...
#ifdef ACCENTS
"of F‰anor", "of An rion",
#else
"of Feanor", "of Anarion",
#endif
	"of Isildur", "of Fingolfin", "of Elvenkind", "'Soulkeeper'",
#ifdef ACCENTS
"of Dor-l¢min",
#else
"of Dor-lomin",
...
"of Beleg Cuthalion",
	...
	"'Camlost'",        "of Nimloth",        "'Nar-i-vagil'",
#ifdef ACCENTS
"of Ber£thiel",
#else
"of Beruthiel",
#endif
	"of Gorlim", "'Narthanc'", "'Nimthanc'", "'Dethanc'", "'Gilettar'",
...
"'Cubragol'",
#endif
	"of Bard", "'Colluin'", "'Holcolleth'", "'Totila'", "of Pain",
	"'Elvagil'",        "'Aglarang'",	"of Rohan",
	"of the Eorlingas",  "'Barukkheled'",  "of Wrath", "'Haradekket'",
#ifdef ACCENTS
"'Mundwin‰'",
#else
"'Mundwine'",
#endif
	"'Gondricam'", "'Zarcuthra'", "'Careth Asdriag'", "'Forasgil'",
#ifdef ACCENTS
"'Crisd–rian'", "Colannon", "'HŒthl¢mŒr'",
#else
"'Crisdurian'", "Colannon", "'Hithlomir'",
#endif
	"'Thalkettoth'",    "of Arvedui",     	"of Thranduil",
	"of Thengel",           "'Hammerhand'",     "of Celegorm",
#ifdef ACCENTS
"of Thr¢r", "of Maedhros", "of Ol¢rin",
#else
"of Thror", "of Maedhros", "of Olorin",
#endif
	"'Anguirel'",       "of Thorin",		"of Celeborn",
#ifdef ACCENTS
"of Orom‰", "of E”nw‰", "of Gondor", "of Th‚oden",
#else
"of Orome", "of Eonwe", "of Gondor", "of Theoden",
#endif
	"of Thingol", 		"of Thorongil",
#ifdef ACCENTS
"of L£thien",
#else
"of Luthien",
#endif
	"of Tuor", "of Ulmo", "'Osondir'", "'Turmil'", "of Caspanion",
	"'Til-i-arc'",	"'Deathwreaker'",	"'Avavir'",
	"'Taratol'",        "'Razorback'",      "(Black)",
	"(Shattered)",		"(Blasted)",
};
