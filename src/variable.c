...
bool stack_floor;		/* Allow objects to stack on floor */
...
bool munchkin_death;          /* Prfnoff -- Ask for saving death */
bool ironman_rooms;           /* Prfnoff -- Always generate very unusual rooms */
bool munchkin_combo;          /* Prfnoff -- Help various 'illegal' race/class combos */
bool munchkin_quest;          /* Prfnoff -- Allow some quests to be tried again */
