...
extern str_ptr      savefile_read_string(savefile_ptr file);
extern sym_t        savefile_read_sym(savefile_ptr file);
...
extern void         savefile_write_sym(savefile_ptr file, sym_t v);
