...
SRCS = z-util.c z-virt.c z-form.c z-rand.c z-term.c variable.c tables.c util.c cave.c object1.c object2.c traps.c monster1.c monster2.c xtra1.c xtra2.c spells1.c spells2.c melee1.c melee2.c save.c files.c cmd1.c cmd2.c cmd3.c cmd4.c cmd5.c cmd6.c cmd7.c store.c birth.c load2.c notes.c wizard1.c wizard2.c levels.c generate.c dungeon.c init1.c init2.c bldg.c main-cap.c main-gcu.c main-x11.c main-xaw.c main-ibm.c main.c

OBJS = z-util.o z-virt.o z-form.o z-rand.o z-term.o variable.o tables.o util.o cave.o object1.o object2.o traps.o monster1.o monster2.o xtra1.o xtra2.o spells1.o spells2.o melee1.o melee2.o save.o files.o cmd1.o cmd2.o cmd3.o cmd4.o cmd5.o cmd6.o cmd7.o store.o birth.o load2.o notes.o wizard1.o wizard2.o levels.o generate.o dungeon.o init1.o init2.o bldg.o main-cap.o main-gcu.o main-x11.o main-xaw.o main-ibm.o main.o
...
INCS = angband.h config.h defines.h types.h externs.h z-term.h z-rand.h z-util.h z-virt.h z-form.h $(HDRS)
