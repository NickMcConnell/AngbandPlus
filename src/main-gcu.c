 ...
 * +--------------------------+--------------------------+
 * | misc 1                   | misc 2                   |
 * | (messages/inventory/     | (messages/inventory/     |
 * |  overhead etc)           |  overhead etc)           |
 * |                          |                          |
 * |                          |                          |
 * +--------------------------+--------------------------+
 */
/* 
 * this initializes 4 windows on a normal to medium sized screen 
 */
static void init_gcu_terms_normal(s16b max_term)
{
   int next_win = 0, i;
...
/*
 * +-----------------------------------------------------+
 * | main window              | monster/object recall    |
 * |                          |                          |
 * |                          |                          |
 * |                          |                          |
 * |                          +--------------------------+
 * |                          | object/monster recall    |
 * |                          |                          |
 * |                          |                          |
 * |                          |                          |
 * +--------------------------+--------------------------+
 ...
 */
/* 
 * this makes 5 windows on a really big screen, see the above layout
 */
static void init_gcu_terms_big_screen(s16b max_term)
{
   int next_win = 0, i;
...
errr init_gcu(int argc, char *argv[])
{
   ...
   if (big_screen)
   {
      init_gcu_terms_big_screen(5);
   }
   else
   {
      init_gcu_terms_normal(4);
   }
