...
/* Crusaders */
#define MAX_POWERS        21
#define POWER_BLESSING     0
#define POWER_STEALTH      1
#define POWER_HEROISM      2
#define POWER_VISION       3
#define POWER_WPN_LIGHT    4
#define POWER_BERSERK      5
#define POWER_SHIELD       6
#define POWER_REGEN        7
#define POWER_WPN_COLD     8
#define POWER_WPN_FLAME    9
#define POWER_MEDITATION  10
#define POWER_RESISTANCE1 11
#define POWER_WPN_DARK    12
#define POWER_RESISTANCE2 13
#define POWER_HASTE       14
#define POWER_SLAY_UNDEAD 15
#define POWER_WPN_POISON  16
#define POWER_PROT_EVIL   17
#define POWER_PROT_ANIMAL 18
#define POWER_SLAY_EVIL   19
...
#define CLASS_ILLUSIONIST       4
#define CLASS_ARCHER            5
#define CLASS_DEATH_PRIEST      6
#define CLASS_BERSERKER         7
#define CLASS_MONK              8
#define CLASS_RUNECASTER        9
...
enum EFFECTS
{
  ...
  EFFECT_CURE_BLIND_CONF,
  EFFECT_CURE_LIGHT_SERIOUS,
  EFFECT_CURE_CRIT_MORTAL,
  EFFECT_CURE_POISON,
  EFFECT_DESTRUCTION,
  EFFECT_DETECT_SEMI,
  EFFECT_DETECT_MONSTERS,
  EFFECT_DETECT_INVIS,
  EFFECT_DETECT_DOOR_TRAP,
  EFFECT_DETECT_ITEM,
  EFFECT_DETECT_ALL,
  EFFECT_DISPEL_REMOVE_CURSE,
  EFFECT_DISPEL_EVIL_UNDEAD,
  EFFECT_DISPEL_ALL,
