...
/*
 * Normal dungeon height in grids, must be a multiple of SCREEN_HGT
 */
#define DUN_HGT		66

/*
 * Normal dungeon width in grids, must be a multiple of SCREEN_WID
 */
#define DUN_WID		198
...
/*
 * Maximum number of player "realm" types (see "table.c", etc)
 */
#define MAX_REALM			8
...
#define MAX_Q_IDX			127	/* Max size for 'q_list[]' */
 ...
 */
#define TEMP_MAX 2048

/*
 * Maximum size of the crushing ceiling array (see "dungeon.c" and "spells1.c")
 */
#define CRUSHER_MAX 1024
...
#define CRUSHER_TURNS	100		/* Length of time between crusher changes */
...
#define CH_LIFE		0x0001
#define CH_SORCERY	0x0002
#define CH_NATURE		0x0004
#define CH_CHAOS		0x0008
#define CH_DEATH		0x0010
#define CH_TRUMP		0x0020
#define CH_ARCANE		0x0040
#define CH_TWO			0x8000
...
#define CAVE_XTRA		0x80 	/* xtra flag */
 ...
 *
 * Line 1 -- allow floors
 * Line 2 -- allow raised crushers
 */
#define cave_barren_bold(Y,X) \
	((cave_feat[Y][X] == FEAT_FLOOR) || \
	 (cave_feat[Y][X] == FEAT_CRUSHER_UP))
 ...
 *
 * Line 1 -- forbid doors, rubble, seams, walls
 * Line 2 -- forbid monsters and the player
 */
 ...
 * Line 1 -- forbid non-floors
 * Line 2 -- forbid normal objects
 * Line 3 -- forbid monsters and the player
 */
...
#define player_has_no_lite \
	(!player_can_see_bold(p_ptr->py, p_ptr->px))
