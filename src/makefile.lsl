...
SRCS = \
  ...
  object1.c object2.c traps.c monster1.c monster2.c \
  xtra1.c xtra2.c spells1.c spells2.c \
  melee1.c melee2.c save.c files.c notes.c \
  cmd1.c cmd2.c cmd3.c cmd4.c cmd5.c cmd6.c cmd7.c  \
  store.c birth.c load2.c ghost.o \
  wizard1.c wizard2.c wild.c \
  generate.c dungeon.c init1.c init2.c \
  bldg.c levels.c squeltch.c \
  main-ami.c main.c
...
OBJS = \
  ...
  store.o birth.o load1.o load2.o gost.c \
  wizard1.o wizard2.o wild.o \
