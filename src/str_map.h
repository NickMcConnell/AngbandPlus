...
extern void        str_map_add_int(str_map_ptr map, const char *key, int val);
extern int         str_map_delete(str_map_ptr map, const char *key);
extern void *      str_map_find(str_map_ptr map, const char *key);
extern int         str_map_find_int(str_map_ptr map, const char *key); /* 0 is ambiguous! */
...
extern int              str_map_iter_current_int(str_map_iter_ptr iter);
