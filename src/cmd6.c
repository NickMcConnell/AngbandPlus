...
void do_cmd_activate(int item)
{
	...
	else if (o_ptr->name1)
	{
		...
		case ART_GEM_SEEING:
			{
				msg_print("The gem shines brightly...");
				map_area();
				lite_area(damroll(2, 15), 3);
		...
		case ART_INSIGHT:
			{
				msg_print("The gem flashes bright red!");
				wiz_lite();
				msg_print("The gem drains your vitality...");
				take_hit(damroll(3,8), "the Gem of Insight'");
				(void)detect_traps();
				(void)detect_doors();
				(void)detect_stairs();
