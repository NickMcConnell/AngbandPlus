...
PF(POWER_STRIKE, "Power Strike", "Gives you a stronger unarmed attack.", PLAYER_FLAG_SPECIAL),
...
PF(UNARMED_COMBAT, "Unarmed Combat", "You are skilled in unarmed combat, and are somewhat talented with slings.", PLAYER_FLAG_CLASS),
...
PF(STEAL, "Pickpocketing", "You can rob money from living monsters.", PLAYER_FLAG_CLASS),
...
PF(WINGED, "Winged", "You can fly and gain increased speed as you level", PLAYER_FLAG_RACE),
PF(TELEKINESIS, "Telekinesis", "You can magically lift remote objects", PLAYER_FLAG_RACE),
PF(QUADRUPED, "Quadruped", "You have 4 hooves, but no hands. This allows you to wear 2 set of boots, but no gloves.",  PLAYER_FLAG_RACE),
PF(CUTIE_MARK, "Cutie Mark", "You have a Cutie Mark, denoting your special talent", PLAYER_FLAG_RACE),
PF(GRIFFON_WINGS, "Winged", "You can fly and gain increased speed as you level. You still need a free hand to run. Having both hands full removes your speed bonus.", PLAYER_FLAG_RACE),
PF(BR_FIRE, "Breathe Fire", "You are able to breathe a cone of fire. You also have a natural resistance to fire.", PLAYER_FLAG_RACE),
PF(TUNNELING, "Tunneling", "You are an expert at digging through rocks", PLAYER_FLAG_RACE),
