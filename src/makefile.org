...
OBJS = \
  ...
  melee1.o melee2.o loadsave.o files.o \
  cmd1.o cmd2.o cmd3.o cmd4.o cmd5.o cmd6.o cmd7.o \
  store.o birth.o notes.o help.o \
  status.o randart.o \
  wizard1.o wizard2.o levels.o ghost.o \
  generate.o dungeon.o init1.o init2.o \
  bldg.o squeltch.o wild.o powers.o plots.o \
...
#
#CFLAGS = -Wall -O1 -pipe -g -D"USE_X11" -D"USE_GCU" -DDEFAULT_PATH=\"$(LIBDIR)\"
...
##
#CFLAGS = -Wall -O1 -pipe -g -D"USE_X11" -DDEFAULT_PATH=\"$(LIBDIR)\"
...
##
CFLAGS = -Wall -O1 -pipe -g -D"USE_GCU" -DDEFAULT_PATH=\"$(LIBDIR)\"
LIBS = -lncurses 
...
##
#CFLAGS = -Wall -O1 -pipe -g -D"USE_XAW" -D"USE_GCU" -DDEFAULT_PATH=\"$(LIBDIR)\"
...
##
#CFLAGS = -Wall -O1 -pipe -g -D"USE_X11" -D"USE_CAP" -DDEFAULT_PATH=\"$(LIBDIR)\"
#LIBS = -lX11 -ltermcap
...
##
#CFLAGS = -Wall -O1 -pipe -g -D"USE_CAP" -D"USE_HARDCODE" -DDEFAULT_PATH=\"$(LIBDIR)\"
...
#         -D"USE_X11" -D"USE_GCU" -DDEFAULT_PATH=\"$(LIBDIR)\"
...
#         -D"USE_X11" -D"USE_GCU" \
#         -D"USE_TPOSIX" -D"USE_CURS_SET" -DDEFAULT_PATH=\"$(LIBDIR)\"
#LIBS = -lX11 -lncurses
#LDFLAGS = -s
...
##
#CFLAGS = -Wall -O1 -pipe -g -D"USE_X11" -D"USE_GCU" -D"SGI" -DDEFAULT_PATH=\"$(LIBDIR)\"
...
#CFLAGS = -std -g -D"USE_X11" -D"USE_GCU" -DDEFAULT_PATH=\"$(LIBDIR)\"
...
##
#CFLAGS = -Wall -O1 -pipe -g -D"USE_GCU" -arch m68k -arch i386 -DDEFAULT_PATH=\"$(LIBDIR)\"
...
install: default
	...
	mkdir -p $(BINDIR)
	cp -r ../lib/* $(LIBDIR)
	chown -R games $(LIBDIR)
	cp -f testing $(BINDIR)/ntang
	chown games $(BINDIR)/ntang
	chmod 4755 $(BINDIR)/ntang
