...
## and .endif for endif
## If your make doesn't seem to have such construct, then
...
IRCARGS = -DUSE_SOCK -DUSE_UNIXSOCK -DIRC_SERVER=\"irc.worldirc.org\" -DIRC_PORT=\"6667\" -DIRC_CHANNEL=\"\#conglomoband\"
...
DEFINES = -DUSE_X11 -DUSE_GCU -DSUPPORT_GAMMA
...
#DEFINES = -DUSE_GTK -DUSE_TRANSPARENCY -DSUPPORT_GAMMA
...
BASESRCS = \
  ...
  main-gtk.c main-cap.c main-gcu.c main-x11.c main-xaw.c main.c irc.c

BASEOBJS = \
  main-gtk.o main.o main-gcu.o main-x11.o main-xaw.o \
  ...
  z-term.o z-rand.o z-form.o z-virt.o z-util.o irc.o

LUASRCS = \
  script.c lua_bind.c \
  w_util.c w_player.c w_z_pack.c w_obj.c w_mnster.c w_spells.c w_quest.c w_play_c.c
...
CFLAGS = $(COPTS) $(INCLUDES) $(DEFINES) -DDEFAULT_PATH=\"$(LIBDIR)\" $(IRCARGS)
...
install: default
	...
	cp -f $(TARGET) $(BINDIR)/conglomoband
	chown $(OWNER) $(BINDIR)/conglomoband
	chmod 4755 $(BINDIR)/conglomoband
...
plots.o: q_rand.c q_main.c q_one.c \
	...
	q_betwen.c \
	q_narsil.c q_shroom.c q_thrain.c
