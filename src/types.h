...
/*
 * An array of MAX_WID byte's
 */
typedef byte byte_wid[MAX_WID];

/*
 * An array of MAX_WID s16b's
 */
typedef s16b s16b_wid[MAX_WID];
...
struct player_type
{
	s16b py;			/* Y coordinate */
	s16b px;			/* X coordinate */
	...
	s16b depth;			/* Dungeon level */
	s16b max_depth;	/* Max level explored */
	...
	byte sur_floor;	/* Surrounding floor tiles */
