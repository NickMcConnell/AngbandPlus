...
struct object_kind
{
	...
	s16b r_to_h;			/* Random bonus to hit */
	s16b r_to_d;			/* Random bonus to damage */
	s16b r_to_a;			/* Random bonus to armor */
	s16b r_pval;			/* Random pval */
...
struct player_type
{
	...
	bool old_icky_wield;
        bool old_inhibit_psi;
        bool old_inhibit_magic;
        bool old_inhibit_prayer;
	...
	bool drain_hp;          /* HP draining */

	bool inhibit_psi;	/* Inhibit psionics */
	bool inhibit_magic;	/* Inhibit magic */
	bool inhibit_prayer;	/* Inhibit prayers */
	...
	s16b pseudo_id;		/* Pseudo-ID bonus */
	...
	s16b meta_psi_lev;	/* Metapsionics level */
};
