...
#ifdef JP
if (flags6 & (RF6_DARKNESS))        {vp[vn] = ((p_ptr->pclass != CLASS_NINJA) || (flags3 & (RF3_UNDEAD | RF3_HURT_LITE))) ? "暗闇" : "閃光";color[vn++] = TERM_L_DARK;}
#else
...
#ifdef JP
if (flags1 & RF1_UNIQUE) {vp[vn] = "分解";color[vn++] = TERM_SLATE;}
#else
