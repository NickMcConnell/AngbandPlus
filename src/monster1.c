...
/* Fear Code: When evenly matched, fear will work about 50% of the time. We 
   roughly compare the monster's level versus (player's level + charisma).
*/
#define SPOIL_FEAR_ODDS 1

#if SPOIL_FEAR_ODDS
	/* Odds that 1dL1 <= 1dL2 */
	static double _save_fear_odds(int l1, int l2)
	{
...
#endif
	{
		double s = _save_fear_odds(ml, pl);
...
bool m_save_fear(monster_type *m_ptr)
{
	int           pl = p_ptr->lev;
...
#endif
	{
		double s = _save_fear_odds(pl, ml);
