...
int tolua_object_open (lua_State* tolua_S)
{
 ...
 tolua_constant(tolua_S,NULL,"TR1_AMMUNITION",TR1_AMMUNITION);
 ...
 tolua_constant(tolua_S,NULL,"TR3_CONFER_FIRE",TR3_CONFER_FIRE);
 tolua_constant(tolua_S,NULL,"TR3_CONFER_COLD",TR3_CONFER_COLD);
 tolua_constant(tolua_S,NULL,"TR3_CONFER_ELEC",TR3_CONFER_ELEC);
 tolua_constant(tolua_S,NULL,"TR3_CONFER_ACID",TR3_CONFER_ACID);
 ...
 tolua_constant(tolua_S,NULL,"TR3_CONFER_POIS",TR3_CONFER_POIS);
 tolua_constant(tolua_S,NULL,"TR3_CONFER_EVIL",TR3_CONFER_EVIL);
 ...
 tolua_constant(tolua_S,NULL,"TR3_CONFER_DRGN",TR3_CONFER_DRGN);
...
void tolua_object_close (lua_State* tolua_S)
{
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"TR1_AMMUNITION");
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"TR3_CONFER_FIRE"); /* ~ Confer */
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"TR3_CONFER_COLD"); /* ~ Confer */
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"TR3_CONFER_ACID"); /* ~ Confer */
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"TR3_CONFER_ELEC"); /* ~ Confer */
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"TR3_CONFER_POIS"); /* ~ Confer */
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"TR3_CONFER_EVIL"); /* ~ Confer */
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"TR3_CONFER_DRGN"); /* ~ Confer */
