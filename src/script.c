...
static int race_const[] =
{
	...
	RACE_HIGH_ELF, RACE_BARBARIAN, RACE_HALF_OGRE,
        RACE_HALF_GIANT, 
        RACE_KOBOLD,
        RACE_NIBELUNG, RACE_DARK_ELF, 
        RACE_VAMPIRE,
        RACE_SPECTRE, RACE_ENT,RACE_RKNIGHT,RACE_DRAGONRIDER
};
...
static SLang_Intrin_Var_Type angband_vars [] =
{
	...
	MAKE_VARIABLE("RACE_HALF_GIANT",  &race_const[12], INT_TYPE, 1),
        MAKE_VARIABLE("RACE_KOBOLD",      &race_const[13], INT_TYPE, 1),
        MAKE_VARIABLE("RACE_NIBELUNG",    &race_const[14], INT_TYPE, 1),
        MAKE_VARIABLE("RACE_DARK_ELF",    &race_const[15], INT_TYPE, 1),
        MAKE_VARIABLE("RACE_VAMPIRE",     &race_const[16], INT_TYPE, 1),
        MAKE_VARIABLE("RACE_SPECTRE",     &race_const[17], INT_TYPE, 1),
        MAKE_VARIABLE("RACE_ENT",         &race_const[18], INT_TYPE, 1),
        MAKE_VARIABLE("RACE_RKNIGHT",     &race_const[19], INT_TYPE, 1),
        MAKE_VARIABLE("RACE_DRAGONRIDER", &race_const[20], INT_TYPE, 1),
