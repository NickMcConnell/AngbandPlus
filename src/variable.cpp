...
bool turn_based;                // is game paused?
...
// Array of grids lit by player lite (see "map.cpp") [LITE_MAX]
...
// Array of grids viewable to the player (see "map.cpp") [VIEW_MAX]
...
// Array of grids for use by various functions (see "map.cpp") [TEMP_MAX]
