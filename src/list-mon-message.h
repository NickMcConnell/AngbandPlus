...
MON_MSG(COLLAPSES,			MSG_GENERIC,	false,	"collapse[s], dead.")
MON_MSG(DROWNS,				MSG_GENERIC,	false,	"drowns.")
MON_MSG(STRUGGLES,			MSG_GENERIC,	false,	"struggles.")
MON_MSG(FALL_ASLEEP,		MSG_GENERIC,	false,	"fall[s] asleep!")
MON_MSG(LOOKS_SICK,			MSG_GENERIC,	false,	"look[s] sick.")
