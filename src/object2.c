 ...
 */
void object_known_store(object_type *o_ptr)
{
 ...
 * Known is true when the "attributes" of an object are "known".
 *
 * We call this when we are learning everything about an item, not
 * just what we would expect to know if the item was generated in a store.
 */
void object_known(object_type *o_ptr)
{
	/* Learn the basic information */
	object_known_store(o_ptr);
