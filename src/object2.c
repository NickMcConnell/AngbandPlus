...
s16b charge_wand(object_type *o_ptr, int percent)
{
	...
	switch (o_ptr->sval)
	{
		...
		case SV_WAND_SLEEP_MONSTER:		pval = randint(10) + 8; break;
		case SV_WAND_SLOW_MONSTER:		pval = randint(8) + 6; break;
		case SV_WAND_CONFUSE_MONSTER:	pval = randint(12) + 4; break;
...
s16b charge_staff(object_type *o_ptr, int percent)
{
	...
	switch (o_ptr->sval)
	{
		...
		case SV_STAFF_MAPPING:			pval = randint(5)  + 3; break;
		case SV_STAFF_DETECT_GOLD:		pval = randint(20) + 8; break;
		case SV_STAFF_DETECT_ITEM:		pval = randint(10) + 4; break;
		...
		case SV_STAFF_DETECT_EVIL:		pval = randint(10) + 4; break;
		...
		case SV_STAFF_SLEEP_MONSTERS:	pval = randint(5)  + 3; break;
		case SV_STAFF_SLOW_MONSTERS:	pval = randint(5)  + 3; break;
...
void apply_magic(object_type *o_ptr, int lev, bool okay, bool good, bool great, bool interesting)
{
	...
	else if ((rand_int(100) < test_good/3) && (!interesting) &&
