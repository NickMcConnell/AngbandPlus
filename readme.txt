...
Unzipping:
     The Sangband installation includes this file, a manual, either an 
executable or a source code directory, and a "lib" directory, plus some 
miscellaneous files.  Check to make sure that the following directories are 
present in your "lib" directory:
apex, bones, data, edit, file, help, info, pref, user, xtra
     If any are missing, create them.

Playing:
     Use the executable, choose to start a new character, roll him 
...
Code and Text Contributors:
DarkGod, Charlie Ball, Clefs, Eric Bock, Andrew Doull, Steven Fuerst, 
Aram Harrow, Julian Lighton, Improv, Matthias Kurzke, Takeshi Mogami, Ross
Morgan-Linial, Bahman Rabii, Robert Ruehlmann, Paul Sexton, Topi Ylinen, 
Eytan Zwieg, and many others

Collegues:
Charlie Ball, Clefs, Werner Baer, Steven Fuerst, Adam Horowitz, Takeshi 
Mogami, Matthew Neumann, Bahman Rabii, Andrew Schoonmaker, Ethan Sicotte, 
Andrew Swift, William Tanksley, and others

Porters:
Takeshi Mogami, John I'anson-Holton, Ken Dubuc



====== Copyright - Traditional ======

Copyright (c) 2003 Ben Harrison, James E. Wilson, Robert A. Koeneke
