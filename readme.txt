...
●Windows
  ...
  後は展開したフォルダに移動し、xangbandをクリックすれば遊べます。


●UNIX
  ソースをダウンロードします。そして、
  tar -zxvf xangband-xxx-src.tar.gz
  cd xangband/src
  ./configure
  make
  でコンパイルできます。後はトップディレクトリに移動して
  ./xangband -- -n
  で遊べます。
...
●遊び方
  ...
  押すことでも実行できます。
  XAngband には街が4つあり、それぞれの街から洞窟へ入ることが出来ます。
...
●コマンドマクロ機能
  XAngband ではある一連の動作を1つのキーに割り当てることができます。
...
●アイテムの銘
  XAngband ではアイテムに対して'{'コマンドで「銘」をつけることができます。
