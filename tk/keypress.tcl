...
foreach mod1 {Control Shift Alt} {
	bind Term_KeyPress_BindTag <${mod1}_L> { ; }
	bind Term_KeyPress_BindTag <${mod1}_R> { ; }
	foreach mod2 {Control Shift Alt} {
		if {$mod1 eq $mod2} continue
		bind Term_KeyPress_BindTag <$mod1-${mod2}_L> { ; }
		bind Term_KeyPress_BindTag <$mod1-${mod2}_R> { ; }
		bind Term_KeyPress_BindTag <$mod2-${mod1}_L> { ; }
		bind Term_KeyPress_BindTag <$mod2-${mod1}_R> { ; }
	}
}
