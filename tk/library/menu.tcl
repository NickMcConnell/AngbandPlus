...
proc NSMenu::NSMenu {oop parent args} {
	...
	} elseif {[string index $parent 0] ne "."} {
...
proc NSMenu::_MenuSetupOne {oop} {
	...
	for {set i 0} {$i <= $last} {incr i} {
		...
		if {[$menu entrycget $i -state] ne $state} {
...
proc NSMenu::MenuEnable {oop identList} {
	...
	foreach ident $identList {
		...
		if {[$menu entrycget $index -state] ne "normal"} {
...
# dbwin "$menu index='$index' ident='$ident'\n"
...
# not needed anymore -- July 22 2004
