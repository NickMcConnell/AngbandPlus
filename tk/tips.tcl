...
proc NSTips::InitWindow {oop} {
	...
	bind $win <KeyPress-Left> "NSUtils::InvokeButton $win.buttons.back"
	bind $win <KeyPress-b> "NSUtils::InvokeButton $win.buttons.back"
	bind $win <KeyPress-less> "NSUtils::InvokeButton $win.buttons.back"

	bind $win <KeyPress-Right> "NSUtils::InvokeButton $win.buttons.next"
	bind $win <KeyPress-n> "NSUtils::InvokeButton $win.buttons.next"
	bind $win <KeyPress-greater> "NSUtils::InvokeButton $win.buttons.next"

	bind $win <KeyPress-Return> "NSUtils::InvokeDefaultButton $win"
	bind $win <KeyPress-Escape> "NSUtils::InvokeButton $win.buttons.close"
