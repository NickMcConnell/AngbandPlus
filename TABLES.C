...
{"Raistlin the Chicken   (Human)      General Store",
	  250,	175,  108,    4, 0, 12},
{"Wieland the Smith      (Dwarf)      Armoury"      ,
    32000,  200,  112,    4, 5,  5},
{"Arndal Beast-Slayer    (Half-Elf)   Weaponsmith"  ,
	10000,	185,  110,    5, 1,  8},
{"Sarastro the Priest    (Human)      Temple"       ,
     5000,  175,  109,    6, 0, 15},
{"Ga-nat the Greedy      (Gnome)      Alchemist"    ,
    20000,  220,  115,    4, 4,  9},
{"Kirokrilleus Starshine (Elf)        Magic Shop"   ,
	32000,	175,  110,    5, 2, 11},
{"Topi the Fair?         (Human)      Black Market" ,
...
{"Oglign Dragon-Slayer   (Dwarf)      Weaponsmith"  ,
    32000,  195,  112,    4, 5,  8},
{"Jochanaan the Pure     (Human)      Temple"       ,
     32000,  185,  110,    5, 0, 23},
...
{"Lyar-el the Comely     (Elf)        General Store",
      500,  165,  107,    6, 2, 18},
{"Arnold the Handsome    (Human)      Armoury",
	25000,  200,  112,    4, 5, 10},
{"Conan the Beastly      (Half-Troll) Weaponsmith"  ,
	 3000,	210,  115,    6, 7,  8},
{"Orni the Cunning       (Half-Elf)   Temple"       ,
    3500,  180,  107,    6, 1, 20},
{"Wizzle the Chaotic     (Hobbit)     Alchemist"    ,
	10000,	190,  110,    6, 3,  8},
{"The Wizard of Yendor   (Human?)     Magic Shop"   ,
    32000,  200,  110,    7, 0, 10},
{"Gary Gygaz             (Half-Orc)   Black Market" ,
...
/* Do not move the first three */
  ...
  "Azure","Blue","Blue Speckled","Black","Brown","Brown Speckled","Bubbly",
  "Chartreuse","Cloudy","Copper Speckled","Crimson","Sky Blue","Dark Blue",
  "Dark Green","Dark Red","Gold Speckled","Green","Green Speckled","Grey",
  "Grey Speckled","Hazy","Indigo","Brilliant Blue","Light Green","Magenta",
  "Metallic Blue","Metallic Red","Metallic Green","Metallic Purple","Misty",
  "Manly","Orange Speckled","Pink","Pink Speckled","Puce","Purple",
  "Purple Speckled","Red","Boiling Red","Silver Speckled","Smoky",
  "Tangerine","Violet","Vermilion","White","Yellow", "Stinking",
  "Pungent","Clotted Red","Viscous Pink","Glowing","Gloopy Green",
  "Shimmering","Coagulated Crimson", "Oily Black","Ivory White",
  "Ichor"
};
...
int8u tccolors[MAX_COLORS] = {
  ...
  LIGHTBLUE, LIGHTBLUE, LIGHTBLUE, DARKGRAY, BROWN, BROWN, LIGHTGREEN,
  LIGHTGREEN, LIGHTGRAY, BROWN, LIGHTRED, CYAN, BLUE,
  GREEN, RED, YELLOW, GREEN, LIGHTGREEN, LIGHTGRAY,
  DARKGRAY, LIGHTGRAY, BLUE, LIGHTCYAN, LIGHTGREEN, MAGENTA,
  LIGHTBLUE, RED, GREEN, MAGENTA, LIGHTGRAY,
  BROWN, LIGHTRED, LIGHTMAGENTA, LIGHTMAGENTA, MAGENTA, MAGENTA,
  LIGHTMAGENTA, RED, LIGHTRED, WHITE, LIGHTGRAY,
  LIGHTRED, MAGENTA, RED, WHITE, YELLOW, BROWN,
  GREEN, RED, LIGHTRED, WHITE, GREEN,
  YELLOW, RED, DARKGRAY, WHITE,
  GREEN,
};
#endif
...
char *mushrooms[MAX_MUSH] = {
  ...
  "Slimy","Tan","White","White Spotted","Wooden","Wrinkled",/*"Shaggy",
...
char *woods[MAX_WOODS] = {
  "Aspen","Balsa","Banyan","Gnarled","Cedar","Cottonwood","Cypress","Dogwood",
...
char *metals[MAX_METALS] = {
  ...
  "Iridium","Glass","Rusty","Silver","Steel","Tin","Titanium","Tungsten",
  "Zirconium","Zinc","Aluminum-Plated","Spiked","Gold-Plated",
  "Curved","Jeweled","Steel-Plated","Hexagonal","Zinc-Plated",
  "Long","Mithril","Short","Bronze","Brass","Platinum",
  "Lead"/*,"Lead-Plated","Ivory","Pewter"*/
};
#ifdef TC_COLOR
int8u tcmetals[MAX_METALS] = {
  LIGHTGRAY, DARKGRAY, WHITE, BROWN, YELLOW, DARKGRAY, LIGHTGRAY,
  LIGHTGRAY, LIGHTCYAN, RED, WHITE, LIGHTGRAY, LIGHTGRAY, DARKGRAY, DARKGRAY,
...
char *rocks[MAX_ROCKS] = {
  ...
  "Calcite","Wire","Corundum","Diamond","Emerald","Fluorite","Garnet",
  "Granite","Jade","Jasper","Lapis Lazuli","Malachite","Marble","Moonstone",
  "Onyx","Opal","Pearl","Quartz","Quartzite","Rhodonite","Ruby","Sapphire",
  "Tiger Eye","Topaz","Turquoise","Zircon","Ordinary","Bronze",
  "Gold","Obsidian","Engagement","Tortoise Shell","Mithril",
  "Serpent","Carnelian","Wedding","Double", "Plain", "Brass", "Scarab",
  "Spikard","Shining","Rusty","Transparent","Wooden"
};
#ifdef TC_COLOR
int8u tcrocks[MAX_ROCKS] = {
  ...
  BROWN, YELLOW, CYAN, LIGHTBLUE, YELLOW, BROWN,
  YELLOW, DARKGRAY, WHITE, GREEN, LIGHTCYAN,
  YELLOW, RED, YELLOW, YELLOW, YELLOW, YELLOW, DARKGRAY,
  BLUE, WHITE, RED, WHITE, BROWN
};
#endif

char *amulets[MAX_AMULETS] = {
  "Amber","Triangular","Coral","Swastika","Ivory","Obsidian",
  "Bone","Bronze","Silver","Skull-shaped","Pyramidal","Golden","Azure",
  "Crystal","Spherical","Oval"
};
#ifdef TC_COLOR
int8u tcamulets[MAX_AMULETS] = {
  YELLOW, BROWN, WHITE, DARKGRAY, WHITE, DARKGRAY,
  WHITE, YELLOW, LIGHTGRAY, LIGHTGRAY, GREEN, YELLOW, LIGHTBLUE,
  LIGHTCYAN, WHITE, BROWN
};
#endif

char *syllables[MAX_SYLLABLES] = {
  "a","ab","ag","aks","alt","an","ankh","awk",
  "arg","arze","ash","aus","ban","bar","bat","bek",
  "bie","bin","bit","borg","bletch","bot","blaat",
  "byt","comp","con","cos","cu","dalf","daiyen",
  "deh","der","doe","dok","eep","el","eng","ekeke","ere","erk",
  "esh","evs","fa","foobie","flit","for","foo","fun","fools",
  "gar","glen","gop","garven","ha","he","hackem","horre",
  "ing","ion","ip","ish","it","ite","iv","jo",
  "kernod","kirje","klis","la","lech","man","mer",
  "me","mi","muche","mik","mon","mung","mur","nag","nej",
  "nelg","nep","ner","neb","nis","nih","ni","o",
  "ok","ood","org","orn","yacc","nr9","pay","pet",
  "ple","plu","po","pot","prok","re","read","rhov",
  "ri","ro","rec","rok","rol","sa","san","sat",
  "see","sef","seh","shu","ski","sna","sux","snik",
  "sno","so","sol","sri","sta","sun","ta","tab",
  "tem","tharr","ti","tox","trol","twat","temov","u",
  "ulk","um","un","uni","ur","val","ve","velox",
  "verr","wah","wel","werg","wex","whon","wun","x",
  "yerg","yed","zelgo","tri","blaa"
};
#endif
