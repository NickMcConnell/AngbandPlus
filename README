              ...
              **************************************************
              **   Angband 2.8.3   **   The Pits of Angband   **
              **************************************************
...
Angband 2.8.3 is a stable official release incorporating all the changes
and improvements added since the last official release (Angband 2.7.8).
