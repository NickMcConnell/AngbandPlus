...
/*
 * Current version number of Cthangband: 3.0.1
 */
 ...
 */
#define MAX_F_IDX       101      /* Max size for "f_info[]" */
...
#define cave_floor_bold(Y,X) \
    ((!(cave[Y][X].feat & 0x20)) && (!(cave[Y][X].feat == FEAT_BUSH)))
