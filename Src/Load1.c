...
static byte convert_old_names[180] =
{
	...
	ART_WORLDS + 128,		/* 56 = SN_GROND */
	ART_STARLIGHT + 128,		/* 57 = SN_RINGIL */
	ART_ODIN + 128,		/* 58 = SN_AEGLOS */
	ART_XURA + 128,		/* 59 = SN_ARUNRUTH */
	ART_TWILIGHT + 128,		/* 60 = SN_MORMEGIL */
	EGO_MORGUL,				/* 61 = SN_MORGUL */
	ART_ASSASSIN + 128,		/* 62 = SN_ANGRIST */
	ART_DRAGONSLAYER + 128,		/* 63 = SN_GURTHANG */
	ART_SELFSLAYER + 128,		/* 64 = SN_CALRIS */
	EGO_ACCURACY,			/* 65 = SN_ACCURACY */
	ART_EVERFLAME + 128,		/* 66 = SN_ANDURIL */
	EGO_SLAY_ORC,			/* 67 = SN_SO */
	EGO_POWER,				/* 68 = SN_POWER */
	ART_YEEKS + 128,		/* 69 = SN_DURIN */
	ART_MJOLLNIR + 128,			/* 70 = SN_AULE */
	EGO_WEST,				/* 71 = SN_WEST */
	...
	ART_BLACKICE + 128,		/* 78 = SN_ORCRIST */
	ART_BRIGHTBLADE + 128,	/* 79 = SN_GLAMDRING */
	...
	0,						/* 90 = SN_VILYA */
	EGO_AMAN,				/* 91 = SN_AMAN */
	ART_VAMPLORD + 128,	/* 92 = SN_BELEGENNON */
	ART_ITHAQUA + 128,		/* 93 = SN_FEANOR */
	ART_STABILITY + 128,		/* 94 = SN_ANARION */
	ART_GODS + 128,		/* 95 = SN_ISILDUR */
	ART_COMBAT + 128,	/* 96 = SN_FINGOLFIN */
	EGO_ELVENKIND,			/* 97 = SN_ELVENKIND (XXX) */
	ART_SOULKEEPER + 128,	/* 98 = SN_SOULKEEPER */
	ART_POWER + 128,			/* 99 = SN_DOR_LOMIN */
	ART_UNIVERSE + 128,		/* 100 = SN_MORGOTH */
	ART_SURESHOT + 128,	/* 101 = SN_BELTHRONDING */
	ART_DANCING + 128,			/* 102 = SN_DAL */
	ART_IRONFIST + 128,		/* 103 = SN_PAURHACH */
	ART_GHOULS + 128,	/* 104 = SN_PAURNIMMEN */
	ART_WHITESPARK + 128,	/* 105 = SN_PAURAEGEN */
	ART_LIGHT + 128,	/* 106 = SN_CAMMITHRIM */
	ART_CALFSKIN + 128,		/* 107 = SN_CAMBELEG */
	ART_SKULLKEEPER + 128,	/* 108 = SN_HOLHENNETH */
	ART_DEAD + 128,		/* 109 = SN_PAURNEN */
	ART_LIGHTNING + 128,		/* 110 = SN_AEGLIN */
	ART_THANOS + 128,		/* 111 = SN_CAMLOST */
	ART_HAGEN + 128,		/* 112 = SN_NIMLOTH */
	ART_FIRESTAFF + 128,			/* 113 = SN_NAR */
	ART_MISERY + 128,	/* 114 = SN_BERUTHIEL */
	ART_MASK + 128,		/* 115 = SN_GORLIM */
	ART_FAITH + 128,		/* 116 = SN_NARTHANC */
	ART_HOPE + 128,		/* 117 = SN_NIMTHANC */
	ART_CHARITY + 128,		/* 118 = SN_DETHANC */
	ART_MERLIN + 128,		/* 119 = SN_GILETTAR */
	ART_THOTH + 128,		/* 120 = SN_RILIA */
	ART_ICICLE + 128,		/* 121 = SN_BELANGIL */
	ART_NKAI + 128,		/* 122 = SN_BALLI */
	ART_SPLEENSLICER + 128,	/* 123 = SN_LOTHARANG */
	ART_FIRESTAR + 128,		/* 124 = SN_FIRESTAR */
	ART_ERIRIL + 128,		/* 125 = SN_ERIRIL */
	ART_DEATH + 128,		/* 126 = SN_CUBRAGOL */
	ART_BOWSERPENTS + 128,			/* 127 = SN_BARD */
	ART_BARZAI + 128,		/* 128 = SN_COLLUIN */
	ART_DARKNESS + 128,	/* 129 = SN_HOLCOLLETH */
	ART_TOTILA + 128,		/* 130 = SN_TOTILA */
	ART_PAIN + 128,			/* 131 = SN_PAIN */
	ART_DEMONBLADE + 128,		/* 132 = SN_ELVAGIL */
	ART_GROO + 128,		/* 133 = SN_AGLARANG */
	ART_SERPENTS + 128,		/* 134 = SN_ROHIRRIM */
	ART_SKEWER + 128,	/* 135 = SN_EORLINGAS */
	ART_NODENS + 128,	/* 136 = SN_BARUKKHELED */
	ART_WRATH + 128,		/* 137 = SN_WRATH */
	ART_SOULSWORD + 128,	/* 138 = SN_HARADEKKET */
	ART_AXEDWARVES + 128,		/* 139 = SN_MUNDWINE */
	ART_BLACKBEARD + 128,	/* 140 = SN_GONDRICAM */
	ART_FIRETONGUE + 128,	/* 141 = SN_ZARCUTHRA */
	ART_BLUEBEARD + 128,		/* 142 = SN_CARETH */
	ART_MONTOYA + 128,		/* 143 = SN_FORASGIL */
	ART_GENOCIDE + 128,	/* 144 = SN_CRISDURIAN */
	ART_SHIFTER + 128,		/* 145 = SN_COLANNON */
	ART_KOBOLD + 128,	/* 146 = SN_HITHLOMIR */
	ART_WYVERNSCALE + 128,	/* 147 = SN_THALKETTOTH */
	ART_HEARTGUARD + 128,		/* 148 = SN_ARVEDUI */
	ART_MINDCRAFTER + 128,	/* 149 = SN_THRANDUIL */
	ART_HOLINESS + 128,		/* 150 = SN_THENGEL */
	ART_HAMMERHAND + 128,	/* 151 = SN_HAMMERHAND */
	ART_RAWHIDE + 128,		/* 152 = SN_CELEGORM */
	ART_BLACKREAVER + 128,		/* 153 = SN_THROR */
	ART_DEFENCE + 128,		/* 154 = SN_MAEDHROS */
	ART_ATAL + 128,		/* 155 = SN_OLORIN */
	ART_KARAKAL + 128,		/* 156 = SN_ANGUIREL */
	ART_VITRIOL + 128,		/* 157 = SN_THORIN */
	ART_ORCS + 128,		/* 158 = SN_CELEBORN */
	ART_DESTINY + 128,		/* 159 = SN_OROME */
	ART_TROLLS + 128,		/* 160 = SN_EONWE */
	ART_SUN + 128,		/* 161 = SN_GONDOR */
	ART_THEODEN + 128,		/* 162 = SN_THEODEN */
	ART_SWASHBUCKLER + 128,		/* 163 = SN_THINGOL */
	ART_SHADE + 128,	/* 164 = SN_THORONGIL */
	ART_NYOGTHA + 128,		/* 165 = SN_LUTHIEN */
	ART_SHOGGOTH + 128,			/* 166 = SN_TUOR */
	ART_GNORRI + 128,			/* 167 = SN_ULMO */
	ART_ARMOURBANE + 128,		/* 168 = SN_OSONDIR */
	ART_JUSTICE + 128,		/* 169 = SN_TURMIL */
	ART_OGRELORDS + 128,	/* 170 = SN_CASPANION */
	ART_TEPES + 128,			/* 171 = SN_TIL */
	ART_DEATHWREAKER + 128,	/* 172 = SN_DEATHWREAKER */
	ART_GHARNE + 128,		/* 173 = SN_AVAVIR */
	ART_THUNDER + 128,		/* 174 = SN_TARATOL */
...
{
	ART_ELEMFIRE,		/* Old 501 */
	ART_ELEMICE,		/* Old 502 */
	ART_ELEMSTORM,		/* Old 503 */
	ART_NYARLATHOTEP,		/* Old 504 */
	ART_POLARIS,	/* Old 505 */
	ART_ALHAZRED,		/* Old 506 */
	ART_LOBON,	/* Old 507 */
	ART_XOTH,	/* Old 508 */
	ART_TRAPEZOHEDRON,		/* Old 509 */
	ART_BAST,		/* Old 510 */
	ART_DWARVES,	/* Old 511 */
	ART_MAGIC		/* Old 512 */
};
