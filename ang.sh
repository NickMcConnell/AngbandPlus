...
#/usr/bin/angband64-beta-7-3 -x/usr/local/games/ang64/angband.log -qFLOW,EXTRA -t -g -u$name 2>angband.err
#but for hardcore developers, this is it:
echo "file /usr/bin/angband64-beta-7-3" > /tmp/gdbinput._$$
