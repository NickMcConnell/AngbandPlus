   ...
   if (arg_graphics && !(streq(ANGBAND_SYS, "ibm")))
   {
       ...
       else if (k_info[(o_ptr)->k_idx].tval == TV_RING)
       {
            ...
            switch (object_d_attr((o_ptr)->k_idx))
            {
                case TERM_VIOLET: 
                                   return 0x80;
                case TERM_RED: case TERM_L_RED:
                                   return 0x81;
                case TERM_UMBER: case TERM_L_UMBER:

                                   return 0x88;
                case TERM_GREEN: case TERM_L_GREEN:
                                   return 0x82;
                case TERM_YELLOW:
                case TERM_ORANGE:
                                   return 0x8A;
                case TERM_BLUE: case TERM_L_BLUE:
                                   return 0x83;
                case TERM_WHITE: case TERM_L_WHITE:
                                   return 0x8C;
                case TERM_DARK:
                                   return 0x8B;
                case TERM_L_DARK: case TERM_SLATE:
                                   return 0x89;
                default:           return 0x81;
            }
            if (o_ptr->sval == SV_RING_BARAHIR)
                return 0x86;
            if (o_ptr->sval == SV_RING_TULKAS)
                return 0x85;
            if (o_ptr->sval == SV_RING_NARYA)
                return 0x85;
            if (o_ptr->sval == SV_RING_NENYA)
                return 0x8D;
            if (o_ptr->sval == SV_RING_VILYA)
                return 0x84;
       ...
       else if (k_info[(o_ptr)->k_idx].tval == TV_AMULET)
       {
                ...
                (o_ptr->sval > SV_AMULET_DWARVES))
            {
                switch(object_d_attr((o_ptr)->k_idx))
                {
                    ...
                    case TERM_SLATE:
                        return 0x85;
                    case TERM_DARK: case TERM_L_DARK:
                        return 0x87;
                    case TERM_UMBER: case TERM_L_UMBER:
                        return 0x84;
                    case TERM_GREEN: case TERM_L_GREEN:
            ...
            else if (o_ptr->sval == SV_AMULET_CARLAMMAS)
                return 0x8A;
            else if (o_ptr->sval == SV_AMULET_INGWE)
                return 0x8B;
            else
                return 0x8C;
        }
            ...
            ((k_info[(o_ptr)->k_idx].tval == TV_WAND)
               ...
               && (o_ptr->sval < SV_FOOD_BISCUIT)))
        {
            switch (object_d_attr((o_ptr)->k_idx))
            {
                ...
                case TERM_WHITE: case TERM_L_WHITE:
                    return 0x85;
                case TERM_DARK: case TERM_L_DARK: case TERM_SLATE:
                    return 0x84;
                case TERM_UMBER: case TERM_L_UMBER:
                    return 0x87;
                case TERM_GREEN: case TERM_L_GREEN:
