...
void self_knowledge(void)
{
	...
	if (p_ptr->muta1)
	{
		...
		{
			info[i++] = "You can cast magic bolts (dam (3 + lvl / 5)d4).";
		}
		if (p_ptr->muta1 & MUT1_SHARD_BOLT)
		{
			info[i++] = "You can cast shards (dam (3 + lvl / 10)d5).";
		}
		if (p_ptr->muta1 & MUT1_SHARD_BLAST)
		{
			info[i++] = "You can cast volleys of shards (dam (2 + lvl / 10)d4).";
		}
		if (p_ptr->muta1 & MUT1_DSHARD_BLAST)
		{
			info[i++] = "You can cast large volleys of shards (dam (2 + lvl / 10)d4).";
		}
		if (p_ptr->muta1 & MUT1_CHAIN_SHARDS)
		{
			info[i++] = "You can cast shards rapidly (dam (3 + lvl / 10)d5).";
		}
