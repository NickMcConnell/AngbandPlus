...
void player_birth(void)
{
	...
	/* D11-Hack: Set Player Training ability to false */
	p_ptr->training = 0;
	/* D11-Hack: Set Special Abilities to 1 (Level 1, Cure Light Wounds) */
	p_ptr->abilities = 1;
	/* D11-Hack: Set Quick Spells to "No Spell memorized" */
	for (n = 0; n < 10; n++)
		p_ptr->quick_spells[n] = -1;
