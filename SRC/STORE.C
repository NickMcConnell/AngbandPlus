...
{
        "%s for such a fine item?  HA!  No less than %s.",
        "%s is an insult!  Try %s gold pieces.",
        ...
        "I paid more than %s for it myself, try %s.",
