...
static void process_world(void)
{
	...
	if (p_ptr->muta2)
	{
		if (p_ptr->muta2 & MUT2_BERS_RAGE)
		{
			...
			if (!rand_int(3000)) i = randint(p_ptr->lev) + 10;
			else if (!rand_int(1000)) i = randint(p_ptr->lev / 10) + 1;
...
static void process_command(void)
{
	...
	switch (command_cmd)
	{
		...
		case KTRL('T'):
		{
			...
			cptr desc = "It is a strange time.";
			...
			switch(hour)
			{
				...
				case 1:	case 2:	desc = "It is deep night."; break;

				case 3:	case 4:	desc = "It is early morning, but still dark."; break;

				case 5:
				{
					if (min < 30) desc = "It will be day soon.";
					else desc = "The sun is rising.";
					break;
				}

				case 6:	desc = "Morning has broken."; break;

				case 7:	case 8:	desc = "It is early morning."; break;

				case 9:	desc = "It is midmorning."; break;

				case 10:	case 11:	desc = "It is late morning."; break;
				...
				case 13: case 14:	desc = "It is early afternoon."; break;

				case 15:	desc = "It is midafternoon."; break;

				case 16:	desc = "It is late afternoon."; break;

				case 17:
				{
					if (min < 30) desc = "It will be night soon.";
					else desc = "The sun is setting.";
					break;
				}

				case 18:	desc = "The night has begun."; break;

				case 19: case 20:	desc = "It is early night."; break;

				case 21: case 22: case 23: desc = "It is late night."; break;
			}
