 ...
 */
s16b critical_shot(s32b weight, int plus, int dam)
{
	int i;
   s32b k;
 ...
 */
s16b critical_norm(s32b weight, int plus, int dam)
{
	int i;
   s32b k;
...
static int see_wall(int dir, int y, int x)
{
	...
	if (!is_wall(cave_feat[y][x])) return (FALSE);
