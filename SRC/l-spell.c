...
static int toluaI_spell_take_hit00(lua_State* tolua_S)
{
 ...
 else
 {
  ...
  int abil = ((int)  tolua_getnumber(tolua_S,3,0));
 {
  take_hit(dam,kb_str,abil);
 }
 }
 return 0;
tolua_lerror:
...
/* function: create_ego */
static int toluaI_spell_create_ego00(lua_State* tolua_S)
{
 if (
 !tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
 !tolua_istype(tolua_S,2,LUA_TNUMBER,0) ||
 ...
 else
 {
  ...
  int sacrifice_levels = ((int)  tolua_getnumber(tolua_S,2,0));
 {
  bool toluaI_ret = (bool)  create_ego(power,sacrifice_levels);
 tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 }
 return 1;
tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'create_ego'.");
 return 0;
}

/* function: create_artifact */
static int toluaI_spell_create_artifact00(lua_State* tolua_S)
{
 if (
 !tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
 !tolua_istype(tolua_S,2,LUA_TNUMBER,0) ||
 ...
 else
 {
  int power = ((int)  tolua_getnumber(tolua_S,1,0));
  int sacrifice_levels = ((int)  tolua_getnumber(tolua_S,2,0));
  bool player_choose = ((bool)  tolua_getbool(tolua_S,3,0));
  int choices = ((int)  tolua_getnumber(tolua_S,4,0));
  int tries = ((int)  tolua_getnumber(tolua_S,5,0));
 {
  bool toluaI_ret = (bool)  create_artifact(power,sacrifice_levels,player_choose,choices,tries);
 tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 }
 return 1;
...
/* function: get_levels_sacrifice */
static int toluaI_spell_get_levels_sacrifice00(lua_State* tolua_S)
{
 if (
 !tolua_isnoobj(tolua_S,1)
 )
 ...
 {
 {
  int toluaI_ret = (int)  get_levels_sacrifice();
 tolua_pushnumber(tolua_S,(long)toluaI_ret);
 }
 }
 return 1;
tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'get_levels_sacrifice'.");
 return 0;
}
...
int tolua_spell_open (lua_State* tolua_S)
{
 ...
 tolua_function(tolua_S,NULL,"create_ego",toluaI_spell_create_ego00);
 tolua_function(tolua_S,NULL,"create_artifact",toluaI_spell_create_artifact00);
 tolua_function(tolua_S,NULL,"get_levels_sacrifice",toluaI_spell_get_levels_sacrifice00);
 return 1;
}
/* Close function */
void tolua_spell_close (lua_State* tolua_S)
{
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"create_ego");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"create_artifact");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"get_levels_sacrifice");
}
