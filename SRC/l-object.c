...
static int toluaI_object_object_info_out00(lua_State* tolua_S)
{
 if (
 !tolua_istype(tolua_S,1,tolua_tag(tolua_S,"const object_type"),0) ||
 !tolua_isnoobj(tolua_S,2)
...
static int toluaI_object_object_info_screen00(lua_State* tolua_S)
{
 if (
 !tolua_istype(tolua_S,1,tolua_tag(tolua_S,"const object_type"),0) ||
 !tolua_isnoobj(tolua_S,2)
...
/* function: update_act_fail */
static int toluaI_object_update_act_fail00(lua_State* tolua_S)
{
 if (
 !tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
 !tolua_istype(tolua_S,2,LUA_TNUMBER,0) ||
 ...
 else
 {
  ...
  u16b p = ((u16b)  tolua_getnumber(tolua_S,2,0));
 {
  update_act_fail(a,p);
 }
 }
 return 0;
tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'update_act_fail'.");
 return 0;
}
...
int tolua_object_open (lua_State* tolua_S)
{
 ...
 tolua_constant(tolua_S,NULL,"SV_STAFF_BANISHMENT",SV_STAFF_BANISHMENT);
 ...
 tolua_constant(tolua_S,NULL,"SV_SCROLL_CREATE_MINOR_ARTIFACT",SV_SCROLL_CREATE_MINOR_ARTIFACT);
 ...
 tolua_constant(tolua_S,NULL,"SV_SCROLL_MASS_BANISHMENT",SV_SCROLL_MASS_BANISHMENT);
 ...
 tolua_constant(tolua_S,NULL,"ACT_MASS_BANISHMENT",ACT_MASS_BANISHMENT);
 ...
 tolua_function(tolua_S,NULL,"update_act_fail",toluaI_object_update_act_fail00);
 tolua_constant(tolua_S,NULL,"a_pval",a_pval);
 tolua_constant(tolua_S,NULL,"a_comm_act",a_comm_act);
 tolua_constant(tolua_S,NULL,"a_search",a_search);
 tolua_constant(tolua_S,NULL,"a_res_fear",a_res_fear);
 tolua_constant(tolua_S,NULL,"a_infra",a_infra);
 tolua_constant(tolua_S,NULL,"a_feather",a_feather);
 tolua_constant(tolua_S,NULL,"a_lite",a_lite);
 tolua_constant(tolua_S,NULL,"a_see_invis",a_see_invis);
 tolua_constant(tolua_S,NULL,"a_slow_digest",a_slow_digest);
 tolua_constant(tolua_S,NULL,"a_sust_str",a_sust_str);
 tolua_constant(tolua_S,NULL,"a_sust_int",a_sust_int);
 tolua_constant(tolua_S,NULL,"a_sust_wis",a_sust_wis);
 tolua_constant(tolua_S,NULL,"a_sust_dex",a_sust_dex);
 tolua_constant(tolua_S,NULL,"a_sust_con",a_sust_con);
 tolua_constant(tolua_S,NULL,"a_sust_chr",a_sust_chr);
 tolua_constant(tolua_S,NULL,"a_res_acid",a_res_acid);
 tolua_constant(tolua_S,NULL,"a_res_elec",a_res_elec);
 tolua_constant(tolua_S,NULL,"a_res_fire",a_res_fire);
 tolua_constant(tolua_S,NULL,"a_res_cold",a_res_cold);
 tolua_constant(tolua_S,NULL,"a_drain_exp",a_drain_exp);
 tolua_constant(tolua_S,NULL,"a_teleport",a_teleport);
 tolua_constant(tolua_S,NULL,"a_aggr",a_aggr);
 tolua_constant(tolua_S,NULL,"a_uncomm_act",a_uncomm_act);
 tolua_constant(tolua_S,NULL,"a_remove_drain_exp",a_remove_drain_exp);
 tolua_constant(tolua_S,NULL,"a_remove_teleport",a_remove_teleport);
 tolua_constant(tolua_S,NULL,"a_remove_aggr",a_remove_aggr);
 tolua_constant(tolua_S,NULL,"a_blessed",a_blessed);
 tolua_constant(tolua_S,NULL,"a_stealth",a_stealth);
 tolua_constant(tolua_S,NULL,"a_low_weight",a_low_weight);
 tolua_constant(tolua_S,NULL,"a_heavy_weight",a_heavy_weight);
 tolua_constant(tolua_S,NULL,"a_regen",a_regen);
 ...
 tolua_constant(tolua_S,NULL,"a_res_lite",a_res_lite);
 tolua_constant(tolua_S,NULL,"a_res_dark",a_res_dark);
 tolua_constant(tolua_S,NULL,"a_res_blind",a_res_blind);
 tolua_constant(tolua_S,NULL,"a_res_pois",a_res_pois);
 tolua_constant(tolua_S,NULL,"a_sust_all",a_sust_all);
 tolua_constant(tolua_S,NULL,"a_rare_act",a_rare_act);
 tolua_constant(tolua_S,NULL,"a_speed",a_speed);
 tolua_constant(tolua_S,NULL,"a_free_act",a_free_act);
 tolua_constant(tolua_S,NULL,"a_hold_life",a_hold_life);
 tolua_constant(tolua_S,NULL,"a_res_conf",a_res_conf);
 tolua_constant(tolua_S,NULL,"a_res_sound",a_res_sound);
 tolua_constant(tolua_S,NULL,"a_res_shard",a_res_shard);
 tolua_constant(tolua_S,NULL,"a_res_nexus",a_res_nexus);
 tolua_constant(tolua_S,NULL,"a_res_chaos",a_res_chaos);
 tolua_constant(tolua_S,NULL,"a_resistance",a_resistance);
 tolua_constant(tolua_S,NULL,"a_vrare_act",a_vrare_act);
 tolua_constant(tolua_S,NULL,"a_im_acid",a_im_acid);
 tolua_constant(tolua_S,NULL,"a_im_elec",a_im_elec);
 tolua_constant(tolua_S,NULL,"a_im_fire",a_im_fire);
 tolua_constant(tolua_S,NULL,"a_im_cold",a_im_cold);
 tolua_constant(tolua_S,NULL,"a_res_nether",a_res_nether);
 tolua_constant(tolua_S,NULL,"a_res_disen",a_res_disen);
 tolua_constant(tolua_S,NULL,"a_telepathy",a_telepathy);
 tolua_constant(tolua_S,NULL,"a_blow",a_blow);
 tolua_constant(tolua_S,NULL,"a_to_h_to_d",a_to_h_to_d);
 tolua_constant(tolua_S,NULL,"a_all_stats",a_all_stats);
 tolua_constant(tolua_S,NULL,"a_to_h",a_to_h);
 tolua_constant(tolua_S,NULL,"a_to_d",a_to_d);
 tolua_constant(tolua_S,NULL,"a_to_a",a_to_a);
 tolua_constant(tolua_S,NULL,"a_slay_orc",a_slay_orc);
 tolua_constant(tolua_S,NULL,"a_slay_troll",a_slay_troll);
 tolua_constant(tolua_S,NULL,"a_slay_giant",a_slay_giant);
 tolua_constant(tolua_S,NULL,"a_tunnel",a_tunnel);
 tolua_constant(tolua_S,NULL,"a_might",a_might);
 tolua_constant(tolua_S,NULL,"a_acid",a_acid);
 tolua_constant(tolua_S,NULL,"a_elec",a_elec);
 tolua_constant(tolua_S,NULL,"a_fire",a_fire);
 tolua_constant(tolua_S,NULL,"a_cold",a_cold);
 tolua_constant(tolua_S,NULL,"a_pois",a_pois);
 tolua_constant(tolua_S,NULL,"a_slay_dragon",a_slay_dragon);
 tolua_constant(tolua_S,NULL,"a_slay_evil",a_slay_evil);
 tolua_constant(tolua_S,NULL,"a_slay_animal",a_slay_animal);
 tolua_constant(tolua_S,NULL,"a_slay_undead",a_slay_undead);
 tolua_constant(tolua_S,NULL,"a_slay_demon",a_slay_demon);
 tolua_constant(tolua_S,NULL,"a_shots",a_shots);
 tolua_constant(tolua_S,NULL,"a_dd",a_dd);
 tolua_constant(tolua_S,NULL,"a_ac",a_ac);
 tolua_constant(tolua_S,NULL,"a_kill_dragon",a_kill_dragon);
 tolua_constant(tolua_S,NULL,"a_kill_undead",a_kill_undead);
 tolua_constant(tolua_S,NULL,"a_kill_demon",a_kill_demon);
 tolua_constant(tolua_S,NULL,"a_might_shots",a_might_shots);
 tolua_constant(tolua_S,NULL,"a_impact",a_impact);
 tolua_constant(tolua_S,NULL,"a_kill_all",a_kill_all);
 tolua_constant(tolua_S,NULL,"a_remove_to_h_pen",a_remove_to_h_pen);
 tolua_constant(tolua_S,NULL,"a_last",a_last);
 return 1;
}
/* Close function */
void tolua_object_close (lua_State* tolua_S)
{
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"SV_STAFF_BANISHMENT");
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"SV_SCROLL_CREATE_MINOR_ARTIFACT");
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"SV_SCROLL_MASS_BANISHMENT");
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"IDENT_STORE");
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"ACT_BANISHMENT");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"ACT_MASS_BANISHMENT");
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"update_act_fail");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_pval");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_comm_act");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_search");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_fear");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_infra");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_feather");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_lite");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_see_invis");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_slow_digest");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_sust_str");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_sust_int");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_sust_wis");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_sust_dex");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_sust_con");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_sust_chr");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_acid");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_elec");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_fire");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_cold");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_drain_exp");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_teleport");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_aggr");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_uncomm_act");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_remove_drain_exp");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_remove_teleport");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_remove_aggr");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_blessed");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_stealth");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_low_weight");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_heavy_weight");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_regen");
 ...
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_lite");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_dark");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_blind");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_pois");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_sust_all");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_rare_act");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_speed");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_free_act");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_hold_life");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_conf");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_sound");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_shard");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_nexus");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_chaos");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_resistance");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_vrare_act");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_im_acid");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_im_elec");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_im_fire");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_im_cold");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_nether");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_res_disen");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_telepathy");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_blow");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_to_h_to_d");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_all_stats");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_to_h");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_to_d");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_to_a");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_slay_orc");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_slay_troll");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_slay_giant");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_tunnel");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_might");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_acid");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_elec");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_fire");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_cold");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_pois");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_slay_dragon");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_slay_evil");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_slay_animal");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_slay_undead");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_slay_demon");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_shots");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_dd");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_ac");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_kill_dragon");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_kill_undead");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_kill_demon");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_might_shots");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_impact");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_kill_all");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_remove_to_h_pen");
 lua_pushnil(tolua_S); lua_setglobal(tolua_S,"a_last");
}
