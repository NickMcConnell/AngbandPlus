 ...
 * feelings, screen dumps/loading, and the do_cmd_knowledge routines
 * accesed via the ~ key.
 *
...
void do_cmd_options(void)
{
        ...
        while (1)
        {
                ...
                switch (k)
                {
                        ...
                        {
                                do_cmd_options_aux(5, "GSNband Options");
                                break;
                        }
...
#else
    msg_format("You are playing GSNband, based on Zangband %d.%d.%d.",
...
void plural_aux(char * Name)
{
        ...
        else if (strstr(Name, "Giant headless"))
        {
                strcpy(Name, "Giant headless ones");
        }
        ...
        else if (streq(&(Name[NameLen-2]), "rf"))
        {
 ...
 * TODO: Spill out status when not a simple kill n monsters.
 */
