...
extern int get_spell(int *sn, cptr prompt, int sval, bool known); /* D11-Hack externify for D11-Angband */
...
/* D11-Hack: special additions for D11-Angband */
/* d11adds1.c */
extern char attribs1[7][30];
extern char attribs2[7][13];
extern char train_no_success[4][70];
extern char train_min_success[4][70];
extern char train_norm_success[4][70];
extern char train_max_success[4][70];
extern char abilities[7][70];
extern s16b ab_fail[7];
extern s16b ab_turn[7];
extern s16b ab_turn_count[7];
extern s16b level_backup;
extern int train_attribute(void);
extern int input_recall_depth(void);
extern void do_cmd_use_drowpower(void);
extern void modify_drowpowers(void);
extern void update_abilities(void);
extern void check_abilities(void);

/* D11-Hack: special additions for D11-Angband */
/* d11adds2.c */
extern char *user_commands_menu[7];
extern void configure_quick_spells(void);
extern void use_quick_spells(int qsnr);
extern void user_commands(void);

/* D11-Hack: special additions for D11-Angband */
/* d11adds3.c */
extern object_type *backpack;
extern void extend_genocide(void);
extern void act_backpack(void);
