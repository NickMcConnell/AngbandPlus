...
extern byte undead_type[];
extern cptr player_title[MAX_CLASS][PY_MAX_LEVEL/5];
extern cptr color_names[16];
extern cptr stat_names[6];
extern cptr stat_names_reduced[6];
extern cptr term_flag_desc[MAX_TERM_FLAGS];
extern cptr opt_text[OPT_PAGE_MAX][OPT_PAGE_LEN];
extern cptr opt_desc[OPT_PAGE_MAX][OPT_PAGE_LEN];
extern bool opt_norm[OPT_PAGE_MAX][OPT_PAGE_LEN];
...
extern monster_xtra *x_info;
extern header *l_head;
extern monster_lore *l_info;
extern header *g_head;
extern ghost_type *g_info;
extern char *g_name;
extern char *g_text;
...
extern bool is_floor(int feat);
extern bool is_bloody(int feat);
extern bool is_soft_wall(int feat);
extern bool is_hard_wall(int feat);
extern bool is_wall(int feat);
extern bool is_vein(int feat);
extern bool is_treasure(int feat);
extern bool is_granite(int feat);
extern bool is_liquid(int feat);
extern bool is_shop(int feat);
extern bool is_trap(int feat);
extern bool is_door(int feat);
extern bool is_locked(int feat);
extern bool is_jammed(int feat);
...
extern s16b critical_shot(s32b weight, int plus, int dam);
extern s16b critical_norm(s32b weight, int plus, int dam);
...
extern bool curse_armor(int i);
extern bool curse_weapon(int i);
...
extern bool do_cmd_save_game(void);
extern long total_points(void);
extern void display_scores(int from, int to);
extern bool close_game(void);
extern void kill_ghost(int g_idx);
...
/* inven.c */
extern char show_inven(cptr caption, int *line);
extern char show_equip(cptr caption, int *line);
extern char show_floor(cptr caption, int *line);
extern char show_store(store_type *st_ptr, owner_type *ot_ptr, bool home, cptr caption, int *line);

/* load.c */
extern errr rd_savefile_new(void);
extern errr rd_bones(char *name);
...
extern bool hates_dam(object_type *o_ptr, int *typ, int *dam, int *rad);
extern s16b object_force(object_type *o_ptr);
extern bool decays(object_type *o_ptr);
...
extern bool item_edible(object_type *o_ptr);
...
extern void compact_artifacts(void);
extern void compact_objects(int size);
extern void wipe_o_list(void);
extern s16b a_pop(void);
extern s16b o_pop(void);
extern errr get_obj_num_prep(int layer);
...
extern void artifact_wipe(artifact_type *a_ptr);
extern void object_wipe(object_type *o_ptr);
extern void object_copy(object_type *o_ptr, object_type *j_ptr);
extern void artifact_prep(artifact_type *o_ptr, int k_idx);
...
extern void place_corpse(monster_type *m_ptr);
...
extern bool pack_heavy(object_type *o_ptr);
extern bool pack_bulky(object_type *o_ptr);
...
/* random.c */
extern void gibber(char *buf, int mode);
extern bool make_artifact_random(object_type *o_ptr);
extern bool make_ghost(int g_idx);

/* save.c */
extern bool save_player(void);
extern bool load_player(void);
extern bool save_bones(int g_idx);
extern bool load_bones(void);
...
extern bool dec_stat(int stat, int amount, bool perm);
...
extern bool do_dec_stat(int stat, int amount, bool perm);
...
extern bool fire_ball(int typ, int dir, int dam, int rad, bool breath);
extern bool shower(int typ, int dir, int dam, int rad);
...
extern bool sanctuary(void);
extern bool trap_creation(void);
extern bool destroy_doors_touch(void);
extern bool sleep_monsters_touch(void);

/* store.c */
extern s16b store_bulk(object_type *o_ptr);
extern s32b price_item(object_type *o_ptr, int greed, bool flip);
extern bool noneedtobargain(s32b minprice);
...
extern char attr_to_color_char(int a);
...
extern u32b get_number(u32b def, u32b max, int y, int x, char *cmd); 
...
extern void bleed(int m_idx, int dam);
extern void check_quest(monster_race *r_ptr, monster_type *m_ptr, bool drop);
