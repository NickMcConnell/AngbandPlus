...
struct player_type
{
	...
	s16b recall_depth;	/* D11-Hack: Recall-Depth for the better WOR */
	s16b training;		/* D11-Hack: Can Player train an attribute? */
	s16b abilities;		/* D11-Hack: Special Drow Abilities */
	s16b ab_turn_count[7]; /* D11-Hack: Counter for the Drow Power activision */
	...
	byte quick_spells[10];	/* D11-Hack: Storage for Quick Spells */
	...
	s16b backpack_count;	/* D11-Hack: Number of items in Backpack (if worn) */
