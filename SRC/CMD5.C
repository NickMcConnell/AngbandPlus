		...
		switch (spell)
		{
			case 0:
			{
				...
				fire_bolt_or_beam(beam-10, GF_MISSILE, dir,
										damroll(3 + ((plevdam - 1) / 5), 4 + pbasis));
				break;
			}
			...
			case 16:
			{
				...
				fire_bolt_or_beam(beam-10, GF_COLD, dir,
										damroll(5 + ((plevdam - 5) / 4), 8 + pbasis));
				break;
			}
			...
			case 24:
			{
				...
				fire_bolt_or_beam(beam, GF_FIRE, dir,
										damroll(8 + ((plevdam - 5) / 4), 8 + pbasis));
				break;
			}
			...
			case 38:
			{
				...
				fire_bolt_or_beam(beam, GF_ACID, dir,
										damroll(6 + ((plevdam - 5)/4), 8 + pbasis));
				break;
			}
			...
			case 55:
			{
				/* Collapse ceiling (Heino Vander Sanden) */
				if (!get_aim_dir(&dir)) return;
				(void)collapse(dir);
				break;
			}
			...
			case 56:
			{
				if (!p_ptr->fast)
				{
					(void)set_fast(randint(25) + 30 + plev);
				}
				else
				{
			...
			case 57:
			{
				...
				fire_bolt_or_beam(0, GF_FIRE, dir,
										damroll(3 + ((plevdam - 5) / 4), 8 + pbasis));
				fire_bolt_or_beam(0, GF_COLD, dir,
										damroll(3 + ((plevdam - 5) / 4), 8 + pbasis));
				fire_bolt_or_beam(0, GF_ACID, dir,
										damroll(3 + ((plevdam - 5) / 4), 8 + pbasis));
				break;
			}
			...
			case 58:
			{
				...
				(void)set_oppose_acid(p_ptr->oppose_acid + randint(10) + 10);
				(void)set_oppose_elec(p_ptr->oppose_elec + randint(10) + 10);
				(void)set_oppose_fire(p_ptr->oppose_fire + randint(10) + 10);
				(void)set_oppose_cold(p_ptr->oppose_cold + randint(10) + 10);
				(void)set_oppose_pois(p_ptr->oppose_pois + randint(10) + 10);
				break;
			}
		}
