 ...
 */
#define VERSION_STRING	"3.0.3 New Artifacts patch"

/* Alex: patches information */
enum
{
	PATCH_NEW_ART = 1,	/* New Artifact patch flag  */
	VERSION_NEW_ART = 2
};
 ...
 * Alex: it was 64. New spells are Create Artifact end Create Ego Item
 */
...
#define SV_SCROLL_CREATE_MINOR_ARTIFACT			23	/* Alex */
 ...
 * Alex: note that update_act_xxx called from script and some functions, e.g. lite_area() etc.
 */
#define ACT_ILLUMINATION        0	/* lite_area() */
#define ACT_MAGIC_MAP           1	/* map_area() */
#define ACT_CLAIRVOYANCE        2	/* wiz_lite() */
#define ACT_PROT_EVIL           3	/* set_protevil(), make_attack_normal() */
#define ACT_DISP_EVIL           4	/* project_m() */
#define ACT_HEAL1               5	/* hp_player() */
#define ACT_HEAL2               6	/* hp_player() */
#define ACT_CURE_WOUNDS         7	/* hp_player() */
#define ACT_HASTE1              8	/* set_fast() */
#define ACT_HASTE2              9	/* set_fast() */
#define ACT_FIRE1               10	/* project_m() */
#define ACT_FIRE2               11	/* project_m() */
#define ACT_FIRE3               12	/* project_m() */
#define ACT_FROST1              13	/* project_m() */
#define ACT_FROST2              14	/* project_m() */
#define ACT_FROST3              15	/* project_m() */
#define ACT_FROST4              16	/* project_m() */
#define ACT_FROST5              17	/* project_m() */
#define ACT_ACID1               18	/* project_m() */
#define ACT_RECHARGE1           19	/* recharge() */
#define ACT_SLEEP               20	/* project_m() */
#define ACT_LIGHTNING_BOLT      21	/* project_m() */
#define ACT_ELEC2               22	/* project_m() */
#define ACT_BANISHMENT          23	/* banishment() */
#define ACT_MASS_BANISHMENT     24	/* mass_banishment(), destroy_area() */
#define ACT_IDENTIFY            25	/* ident_spell() */
#define ACT_DRAIN_LIFE1         26	/* project_m() */
#define ACT_DRAIN_LIFE2         27	/* project_m() */
#define ACT_BIZZARE             28	/* ring_of_power() */
#define ACT_STAR_BALL           29	/* project_m() */
#define ACT_RAGE_BLESS_RESIST   30	/* set_blessed(), set_shero(), set_oppose_XXX() */
#define ACT_PHASE               31	/* teleport_player() */
#define ACT_TRAP_DOOR_DEST      32	/* project_f(), project_o() */
#define ACT_DETECT              33	/* detect_all() */
#define ACT_RESIST              34	/* set_oppose_XXX() */
#define ACT_TELEPORT            35	/* teleport_player() */
#define ACT_RESTORE_LIFE        36	/* restore_level() */
#define ACT_MISSILE             37	/* project_m() */
#define ACT_ARROW               38	/* project_m() */
#define ACT_REM_FEAR_POIS       39	/* set_afraid(), set_poisoned() */
#define ACT_STINKING_CLOUD      40	/* project_m() */
#define ACT_STONE_TO_MUD        41	/* project_f(), project_m() */
#define ACT_TELE_AWAY           42	/* project_m() */
#define ACT_WOR                 43	/* set_recall() */
#define ACT_CONFUSE             44	/* project_m() */
#define ACT_PROBE               45	/* probing() */
#define ACT_FIREBRAND           46	/* brand_bolts() */
#define ACT_STARLIGHT           47	/* project_m() */
#define ACT_MANA_BOLT           48	/* project_m() */
#define ACT_BERSERKER           49	/* set_shero() */
...
/* Alex: chance of random artifact appearing is 1/64/64 - see make_rnd_art()  */
enum {RANDOM_ART_CHANCE = 64};
/* Alex: fail == unity_prob means 100% fail. */
enum {unity_prob = 1000};

/* Alex: Artifact abilities */
/* In comments: where abil_fail[] modified.
 * Generally, abilities that are resists/defends modified when player suffer from lack of resist etc.
 * Abilities that are bonuses modified when player successfully use them.
 * XXX: too many changes in code, possible double modifications, errors etc. */
enum Art_Abil
{
/* General abilities */
	/* Common */
	a_pval,		/* check_experiense() - depends only on p_ptr->lev */
	a_comm_act,
	a_search,	/* search() */
	a_res_fear,	/* set_afraid() */
	a_infra,	/* set_tim_infra(), make_attack_normal(), project_p() (if monster is invisible and not cold blood) */
	a_feather,	/* hit_trap() */
	a_lite,		/* process_world() - if no lite source, make_attack_spell() - RF6_DARKNESS */
	a_see_invis,	/* set_tim_invis(), do_cmd_fire(), do_cmd_throw(),  py_attack() (if monster is invisible) */
	a_slow_digest,	/* set_food() */
	/* Sustain fails updated in dec_stat() */
	/* All sustains must go on succession - see update_abil_fail() */
	a_sust_str,	a_sust_int,	a_sust_wis,	a_sust_dex,	a_sust_con,	a_sust_chr,
	/* Resist_XXXX fails updated in acid_dam(), elec_dam(), fire_dam(), cold_dam() */
	/* All elemental resists must go on succession - see update_abil_fail() */
	a_res_acid,	a_res_elec,	a_res_fire,	a_res_cold,
	/* These fails are always 0 */
	a_drain_exp,	a_teleport,	a_aggr,
	/* Uncommon */
	a_uncomm_act,
	a_remove_drain_exp,/* process_world() */
	a_remove_teleport,/* process_world(), project_p() - GF_GRAVITY, apply_nexus() */
	a_remove_aggr,	/* process_monster() - if aggravate and player see waking up monster */
	a_blessed,	/* process_world() - if icky weapon */
	a_stealth,	/* process_monster() - if player see waking up monster */
	a_low_weight,	/* process_world() - if heavy load, heavy weapon, heavy shooter */
	a_heavy_weight,	/* This fail always 0 */
	a_regen,	/* regenhp(), regenmana() */
	/* All stats must go on succession - see update_abil_fail() */
	a_str,		/* do_cmd_tunnel_aux(), do_cmd_bash_aux(), py_attack(), process_world() - if heavy load, heavy weapon, heavy shooter */
	a_int,		/* do_cmd_open_chest(), do_cmd_disarm_chest, do_cmd_open_aux(), do_cmd_disarm_aux(), do_cmd_use_staff(), do_cmd_activate, ubject.lua (aim wand, zap rod) */
	a_wis,		/* make_attack_normal(), make_attack_spell() - when successfully roll the saving throw */
	a_dex,		/* do_cmd_open_chest(), do_cmd_disarm_chest, do_cmd_open_aux(), do_cmd_disarm_aux(), do_cmd_fire(), do_cmd_throw(), py_attack(), make_attack_normal() */
	a_con,		/* take_hit() */
	a_chr,		/* store_purchase(), store_sell() */
	a_res_lite,	/* project_p() */
	a_res_dark,	/* project_p() */
	a_res_blind,	/* set_blind() */
	a_res_pois,	/* process_world() */
	a_sust_all,	/* dec_stat() */
	/* Rare */
	a_rare_act,
	a_speed,	/* set_fast(), make_attack_spell() - if see RF6_HASTE, process_world() - if slow */
	a_free_act,	/* set_paralyzed() */
	a_hold_life,	/* lose_exp() */
	a_res_conf,	/* set_confused(), project_p() */
	a_res_sound,	/* project_p() */
	a_res_shard,	/* set_cut(), project_p() */
	a_res_nexus,	/* apply_disenchant(), project_p(), make_attack_spell() */
	a_res_chaos,	/* apply_nexus(), project_p() */
	a_resistance,	/* acid_, elec_, fire_, cold_dam() */
	/* V. Rare */
	a_vrare_act,
	/* Immunity fails updated in acid_dam(), elec_dam(), fire_dam(), cold_dam() */
	a_im_acid,	a_im_elec,	a_im_fire,	a_im_cold,
	a_res_nether,	/* project_p() */
	a_res_disen,	/* project_p() */
	a_telepathy,	/* make_attack_normal(), project_p() (if monster is invisible and not empty mind) */
	a_blow,		/* py_attack() */
	a_to_h_to_d,	/* py_attack() */
	a_all_stats,	/* update_abil_fail() */
/* Specific abilities: weapon */
	/* Common */
	a_to_h,		/* do_cmd_fire(), do_cmd_throw(), py_attack() */
	a_to_d,		/* do_cmd_fire(), do_cmd_throw(), py_attack() */
	a_to_a,/*Armour*/ /* make_attack_normal() - when player IS hit (?)*/
	a_slay_orc,	/* py_attack() */
	a_slay_troll,	/* py_attack() */
	a_slay_giant,	/* py_attack() */
	a_tunnel,	/* do_cmd_tunnel_aux() */
	/* Uncommon */
	a_might,	/* do_cmd_fire() */
	a_acid,		/* py_attack() */
	a_elec,		/* py_attack() */
	...
	a_cold,		/* py_attack() */
	a_pois,		/* py_attack() */
	a_slay_dragon,	/* py_attack() */
	a_slay_evil,	/* py_attack() */
	a_slay_animal,	/* py_attack() */
	a_slay_undead,	/* py_attack() */
	a_slay_demon,	/* py_attack() */
	/* Rare */
	a_shots,	/* do_cmd_fire() */
	a_dd,		/* py_attack() */
	a_ac,/*Armour*/	/* make_attack_normal() - when player IS hit (?) */
	a_kill_dragon,	/* py_attack() */
	a_kill_undead,	/* py_attack() */
	a_kill_demon,	/* py_attack() */
	/* V. Rare */
	a_might_shots,	/* do_cmd_fire() */
	a_impact,	/* do_cmd_tunnel_aux(), destroy_area(), earthquake() */
	a_kill_all,	/* py_attack() */
/* Specific abilities: heavy armour with (-x) */
	/* Uncommon */
	a_remove_to_h_pen,/* py_attack() */
