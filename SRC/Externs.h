...
extern byte ironman_shops;
extern byte ironman_small_levels;
extern byte ironman_downward;
extern byte ironman_autoscum;
...
extern void create_monster_name(int type, char *name);
...
extern void mutation_power_aux(int power);
...
extern storage_type script_storage;

extern errr storage_init(storage_type *storage);
extern u16b script_add(storage_type *storage, cptr key, cptr data, s16b priority);
extern void script_free(storage_type *storage, u16b idx);
extern cptr script_str(storage_type *storage, u16b idx);
extern errr script_execute(char *name);
extern errr init_script(void);

extern u16b set_event(u16b event, char *key, char *data, s16b priority);
extern u16b get_event(u16b event);
extern u16b get_next_event(u16b index);
extern void remove_event(u16b event, u16b index);
extern void event_execute(u16b event);
...
extern storage_type player_class_storage;
