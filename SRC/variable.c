...
/*
 * Bonefile information
 */
byte cur_bones = 0;			/* Number of bones files in "bone" directory */
...
s16b a_max = ART_MAX_NORMAL;		/* Number of allocated artifacts */
s16b a_cnt = ART_MAX_NORMAL;		/* Number of live artifacts */

s16b o_max = 1;			/* Number of allocated objects */
s16b o_cnt = 0;			/* Number of live objects */

s16b r_max = RACE_MAX_NORMAL;		/* Number of allocated monster races */
s16b r_cnt = RACE_MAX_NORMAL;		/* Number of live races */
...
bool ghost_flag;			/* True if "Ghost" on this level */
 ...
 */
bool (*get_obj_num_hook)(int k_idx, int layer);
