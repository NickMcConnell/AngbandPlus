...
struct player_class
{
	...
	cptr flags_hook;
	cptr beam_chance_hook;
	cptr sense_inventory_hook;
...
{
#ifdef PLUG_IN_PLAYER_CLASS
	player_class        pl_class;     /* Player class */
#endif /* PLUG_IN_PLAYER_CLASS */
 ...
 */
typedef struct script_type script_type;
...
typedef struct storage_type storage_type;
