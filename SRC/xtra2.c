...
void check_experience(void)
{
	                      ...
	                      p_ptr->expfact / 100L)))
	{
		...
		/* Update some stuff , D11-Hack: Added Train and Abilities */
	                       ...
	                       p_ptr->expfact / 100L)))
	{
		...
		/* D11-Hack: ... and set Training Ability */
		p_ptr->training++;
		/* D11-Hack: ... and modify Drow Powers */
		modify_drowpowers();
		...
		/* Update some stuff (D11-Hack: added PR_TRAIN and Abilities) */
		p_ptr->update |= (PU_BONUS | PU_HP | PU_MANA | PU_SPELLS | PU_TRAIN | PU_ABILITIES);

		/* Redraw some stuff (D11-Hack: added PR_STUDY and PR_TRAIN) */
		p_ptr->redraw |= (PR_LEV | PR_TITLE | PR_STUDY | PR_TRAIN);
