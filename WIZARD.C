...
void artifact_check()
{
msg_print ("Attempt to use an obsolete function: artifact_check()");
#if 0 /* This is not used anymore - TY */
  FILE *file1;
  vtype filename;
  {
...
"[R]ing, [P]otion, [W]and/staff, [S]croll, [M]agicbook, [A]mulet, [T]ool.",
 ...
 again:
  ...
  if (get_com("Sharpness? [yn]: ", &ch)) {
    if (ch=='y'||ch=='Y') i_ptr->flags2 |= TR_VORPAL;
      } else if (ch=='\033') goto end;
   }
  ...
  if (get_com("Extra Attacks? [yn]: ", &ch)) {
    if (ch=='y'||ch=='Y') i_ptr->flags2 |= TR_ATTACK_SPD;
  } else if (ch=='\033') goto end;
  ...
  if (get_com("Resist Fear? [yn]: ", &ch)) {
    if (ch=='y'||ch=='Y') i_ptr->flags2 |= TR_RES_FEAR;
  } else if (ch=='\033') goto end;
  ...
  if (get_com("The Random Curse? [yn]: ", &ch)) {
    if (ch=='y'||ch=='Y') i_ptr->flags2 |= TR_TY_CURSE;
  } else if (ch=='\033') goto end;
...
/* weapons */
    ...
    if (AEGLIN) {
    prt("The Broadsword 'Nothung'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (AEGLOS) {
    prt("The Spear 'Runespear'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (AGLARANG) {
    prt("The Katana of Groo", i++, j);
	artifact_screen_full(&i, j);
    }
    if (ANDURIL) {
    prt("The Longsword Werewindle", i++, j);
	artifact_screen_full(&i, j);
    }
    if (ANGRIST) {
    prt("The Dagger of Caine", i++, j);
	artifact_screen_full(&i, j);
    }
    if (ANGUIREL) {
    prt("The Longsword of Bleys", i++, j);
	artifact_screen_full(&i, j);
    }
    if (ARUNRUTH) {
    prt("The Broadsword 'Diamond Blade'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (AULE) {
    prt("The War Hammer 'Mjollnir'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (AVAVIR) {
    ...
    if (BARUKKHELED) {
    prt("The Broad Axe 'Executioner'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (BELANGIL) {
    prt("The Dagger of Fiona", i++, j);
	artifact_screen_full(&i, j);
    }
    if (BLOODSPIKE) {
    ...
    if (CARETH) {
    prt("The Saber of Eric", i++, j);
	artifact_screen_full(&i, j);
    }
    if (CRISDURIAN) {
    prt("The Executioner's Sword of Finndo", i++, j);
	artifact_screen_full(&i, j);
    }
    if (DEATHWREAKER) {
    ...
    if (ELVAGIL) {
    prt("The Broadsword 'Chainsword'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (EONWE) {
    ...
    if (FORASGIL) {
    prt("The Rapier of Dara", i++, j);
	artifact_screen_full(&i, j);
    }
    if (GILETTAR) {
    prt("The Short Sword of Merlin", i++, j);
	artifact_screen_full(&i, j);
    }
    if (GLAMDRING) {
    prt("The Broadsword 'Grayswandir'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (GONDRICAM) {
    prt("The Cutlass 'Delta'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (GURTHANG) {
    prt("The Two-Handed Sword of Gerard", i++, j);
	artifact_screen_full(&i, j);
    }
    if (HARADEKKET) {
    prt("The Scimitar 'Soulsword'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (LOTHARANG) {
    ...
    if (MAEDHROS) {
    prt("The Falchion 'Hildeleoma'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (MORMEGIL) {
    prt("The Two-Handed Sword 'Twilight'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (MUNDWINE) {
    prt("The Lochaber Axe of the Dwarves", i++, j);
	artifact_screen_full(&i, j);
    }
    if (NAR) {
    ...
    if (ORCRIST) {
    prt("The Longsword 'Vorpal Blade'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (OROME) {
    prt("The Spear of Destiny", i++, j);
	artifact_screen_full(&i, j);
    }
    if (OSONDIR) {
    ...
    if (TARATOL) {
    prt("The Mace of Osric", i++, j);
	artifact_screen_full(&i, j);
    }
    if (THEODEN) {
    prt("The Beaked Axe of Deirdre", i++, j);
	artifact_screen_full(&i, j);
    }
    if (THUNDERFIST) {
    ...
    if (ZARCUTHRA) {
    prt("The Two-Handed Sword 'Inquisitor'", i++, j);
	artifact_screen_full(&i, j);
    }
/* missle weapons */
    ...
    if (BELEG) {
    prt("The Longbow of Parsifal", i++, j);
	artifact_screen_full(&i, j);
    }
    if (CUBRAGOL) {
    prt("The Light Crossbow of Brand", i++, j);
	artifact_screen_full(&i, j);
    }
...
/* cloaks */
    ...
    if (TUOR) {
    prt("The Shadow Cloak 'Tarncloak'", i++, j);
	artifact_screen_full(&i, j);
    }
...
/* armor */
    ...
    if (ANARION) {
    prt("The Large Metal Shield of Bruennhilde", i++, j);
	artifact_screen_full(&i, j);
    }
    if (ARVEDUI) {
    ...
    if (BELEGENNON) {
    prt("The Mithril Chain Mail of Lohengrin", i++, j);
	artifact_screen_full(&i, j);
    }
    if (BERUTHIEL) {
    prt("The Iron Crown of Macbeth", i++, j);
	artifact_screen_full(&i, j);
    }
    if (BLADETURNER) {
    ...
    if (CAMBELEG) {
    prt("The Leather Gloves of Random", i++, j);
	artifact_screen_full(&i, j);
    }
    if (CAMLOST) {
    prt("The Gauntlets of Thanos", i++, j);
	artifact_screen_full(&i, j);
    }
    if (CAMMITHRIM) {
    prt("The Leather Gloves of Llewella", i++, j);
	artifact_screen_full(&i, j);
    }
    if (CASPANION) {
    prt("The Augmented Chain Mail of Martin", i++, j);
	artifact_screen_full(&i, j);
    }
    if (CELEBORN) {
    prt("The Mithril Plate Mail of Julian", i++, j);
	artifact_screen_full(&i, j);
    }
    if (CELEFARN) {
    prt("The Large Leather Shield of Celefarn", i++, j);
	artifact_screen_full(&i, j);
    }
    if (DAL) {
    prt("The Soft Leather Boots of Flora", i++, j);
	artifact_screen_full(&i, j);
    }
    if (DOR_LOMIN) {
    ...
    if (FINGOLFIN) {
    prt("The Set of Cesti of 'Frakir'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (GONDOR) {
    prt("The Golden Crown of Amber", i++, j);
	artifact_screen_full(&i, j);
    }
    if (GORLIM) {
    prt("The Iron Helm 'Terror Mask'", i++, j);
	artifact_screen_full(&i, j);
    }
    if (HAMMERHAND) {
    ...
    if (HITHLOMIR) {
    prt("The Soft Leather Armour of Tannhaeuser", i++, j);
	artifact_screen_full(&i, j);
    }
    if (HOLHENNETH) {
    prt("The Iron Helm of Gurnemanz", i++, j);
	artifact_screen_full(&i, j);
    }
    if (ISILDUR) {
    prt("The Full Plate Armour of Deirdre", i++, j);
	artifact_screen_full(&i, j);
    }
    if (PAURAEGEN) {
    ...
    if (PAURNIMMEN) {
    prt("The Gauntlets of Corwin", i++, j);
	artifact_screen_full(&i, j);
    }
    if (RAZORBACK) {
    ...
    if (ROHAN) {
    prt("The Metal Brigandine Armor of Tristan", i++, j);
	artifact_screen_full(&i, j);
    }
    if (SOULKEEPER) {
    ...
    if (THENGEL) {
    prt("The Metal Cap of Coral", i++, j);
	artifact_screen_full(&i, j);
    }
    if (THORIN) {
...
/* light sources */
    ...
    if (THRAIN) {
    prt("The Jewel of Judgement", i++, j);
	artifact_screen_full(&i, j);
    }
...
/* morgoth's stuff */
    ...
    if (GROND) {
    prt("The Lead-Filled Mace 'Heart of the Serpent'", i++, j);
	artifact_screen_full(&i, j);
    }
    pause_line(i);
    restore_screen();
