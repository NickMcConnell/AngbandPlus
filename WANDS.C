		  ...
		  switch(i)
           ...
           case WD_TR_DEST:
		    ...
		    case WD_WONDER:
		      i = randint(23);
		      break;
            case WD_ROCKET: /* Rocket launcher? Hmm... TY */
              msg_print("You shoot a rocket!");
              fire_ball(GF_ROCKET,dir,k,l,(75+randint(100)),3); /* Let's keep this
                                        out of WoW range... death rays
